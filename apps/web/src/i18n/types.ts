...
export interface Dict {
  ...
  'common.save': string;
  'common.close': string;
  'pluginEditor.title': string;
  'pluginEditor.openButton': string;
  'pluginEditor.aiTitle': string;
  'pluginEditor.aiPlaceholder': string;
  'pluginEditor.aiButton': string;
  'pluginEditor.aiWorking': string;
  'pluginEditor.aiDone': string;
  'pluginEditor.aiUndo': string;
  'pluginEditor.aiFailed': string;
  'pluginEditor.queryLabel': string;
  'pluginEditor.queryHint': string;
  'pluginEditor.skillLabel': string;
  'pluginEditor.skillHint': string;
  'pluginEditor.publish': string;
  'pluginEditor.publishing': string;
  'pluginEditor.published': string;
  'pluginEditor.configHeading': string;
  'pluginEditor.configHint': string;
  'pluginEditor.configSet': string;
  'pluginEditor.configNone': string;
  'pluginEditor.configClear': string;
  'pluginEditor.failed': string;
  'pluginEditor.readOnly': string;
  'pluginEditor.unsaved': string;
  'pluginEditor.back': string;
  'pluginEditor.displayHeading': string;
  'pluginEditor.chatEmpty': string;
  'pluginEditor.youLabel': string;
  'pluginEditor.aiLabel': string;
  'pluginEditor.stepsLabel': string;
  'pluginEditor.stepsHint': string;
  'pluginEditor.stepIdPlaceholder': string;
  'pluginEditor.stepTitlePlaceholder': string;
  'pluginEditor.stepAdd': string;
  'pluginEditor.stepRemove': string;
  'pluginEditor.stepUp': string;
  'pluginEditor.stepDown': string;
  'pluginEditor.stepLeft': string;
  'pluginEditor.stepRight': string;
  'pluginEditor.nodeQuery': string;
  'pluginEditor.nodeSkill': string;
  'pluginEditor.gateConfirm': string;
  'pluginEditor.gateChoice': string;
  'pluginEditor.gateNone': string;
  'pluginEditor.stepPromptPlaceholder': string;
  'pluginEditor.modeLabelPlaceholder': string;
  'pluginEditor.modePromptPlaceholder': string;
  'pluginEditor.modeAdd': string;
  'pluginEditor.modeRemove': string;
  'pluginEditor.modeAiEdit': string;
  'pluginEditor.modeUntitled': string;
  'pluginEditor.branchLabel': string;
  'pluginEditor.branchHint': string;
  'pluginEditor.branchSelectLabel': string;
  'pluginEditor.branchPickLabel': string;
  'pluginEditor.branchSingle': string;
  'pluginEditor.branchMulti': string;
  'pluginEditor.branchPickAsk': string;
  'pluginEditor.branchPickInput': string;
  'pluginEditor.branchGroupSingle': string;
  'pluginEditor.branchGroupMulti': string;
  'pluginEditor.branchGroupInput': string;
  'pluginEditor.submodeAdd': string;
  'pluginEditor.submodeRemove': string;
  'pluginEditor.submodeUntitled': string;
  'pluginEditor.submodeLabelPlaceholder': string;
  'pluginEditor.submodePromptPlaceholder': string;
  'pluginEditor.accountsHeading': string;
  'pluginEditor.accountsHint': string;
  'pluginEditor.accountAdd': string;
  'pluginEditor.accountEdit': string;
  'pluginEditor.accountDelete': string;
  'pluginEditor.accountSave': string;
  'pluginEditor.accountEmpty': string;
  'pluginEditor.accountName': string;
  'pluginEditor.accountNamePlaceholder': string;
  'pluginEditor.accountPersona': string;
  'pluginEditor.accountPersonaHint': string;
  'pluginEditor.accountSamples': string;
  'pluginEditor.accountSamplesHint': string;
  'pluginEditor.accountCredentials': string;
  'pluginEditor.accountCredsHint': string;
  'pluginEditor.accountSaved': string;
  'pluginEditor.accountSaveFailed': string;
  'pluginEditor.stepAiEdit': string;
  'pluginEditor.stageSkillsLabel': string;
  'pluginEditor.skillBindPlaceholder': string;
  'pluginEditor.skillUnbind': string;
  'pluginEditor.skillMissing': string;
  'pluginEditor.history': string;
  'pluginEditor.historyEmpty': string;
  'pluginEditor.restore': string;
  'pluginEditor.restored': string;
  'skillsLibrary.title': string;
  'skillsLibrary.lede': string;
  'skillsLibrary.searchPlaceholder': string;
  'skillsLibrary.sourceUser': string;
  'skillsLibrary.sourceClaude': string;
  'skillsLibrary.sourceBuiltIn': string;
  'skillsLibrary.usedBy': string;
  'skillsLibrary.delete': string;
  'skillsLibrary.deleted': string;
  'skillsLibrary.empty': string;
  'creator.eyebrow': string;
  'creator.pluginTitle': string;
  'creator.skillTitle': string;
  'creator.pluginLede': string;
  'creator.skillLede': string;
  'creator.pluginPlaceholder': string;
  'creator.skillPlaceholder': string;
  'creator.targetPlugin': string;
  'creator.targetSkill': string;
  'creator.draftButton': string;
  'creator.drafting': string;
  'creator.redraft': string;
  'creator.draftFailed': string;
  'creator.save': string;
  'creator.saving': string;
  'creator.saveFailed': string;
  'creator.skillSaved': string;
  'creator.nameLabel': string;
  'creator.titleLabel': string;
  'creator.descriptionLabel': string;
  'creator.stagesHint': string;
  'creator.triggersLabel': string;
  'creator.bodyLabel': string;
  'creator.evalsLabel': string;
  'creator.evalsHint': string;
  'tune.open': string;
  'tune.title': string;
  'tune.notePlaceholder': string;
  'tune.good': string;
  'tune.applyPreference': string;
  'tune.saveSample': string;
  'tune.saveSampleHint': string;
  'tune.savedPreference': string;
  'tune.savedSample': string;
  'tune.failed': string;
  ...
  'accountsView.platformEmpty': string;
  'accountsView.sauNamePlaceholder': string;
  'accountsView.sauHint': string;
  ...
  'pluginsHome.showBuiltins': string;
  'pluginsHome.ownedBadge': string;
  'pluginsHome.showBuiltinsHint': string;
  ...
  'integrations.apiKeys.title': string;
  'integrations.apiKeys.desc': string;
  'integrations.apiKeys.empty': string;
  'integrations.apiKeys.tikhubHint': string;
  'integrations.apiKeys.keyPlaceholder': string;
  'integrations.apiKeys.valuePlaceholder': string;
  'integrations.apiKeys.add': string;
  'integrations.apiKeys.save': string;
  'integrations.apiKeys.saving': string;
  'integrations.apiKeys.saved': string;
  'integrations.apiKeys.remove': string;
  'integrations.apiKeys.invalidKey': string;
  'integrations.apiKeys.saveFailed': string;
  ...
  // Automations view (TasksView). The view was rewritten without i18n;
  // these keys cover every user-facing string it renders.
  'automations.hero.eyebrow': string;
  'automations.hero.title': string;
  'automations.hero.lede': string;
  ...
  'automations.savedAria': string;
  'automations.savedTitle': string;
  ...
  'automations.rejectReason': string;
  'automations.target.memory': string;
  'automations.target.designSystem': string;
  'automations.target.skill': string;
  'automations.target.template': string;
  'automations.action.create': string;
  'automations.action.update': string;
  'automations.action.merge': string;
  'automations.action.move': string;
  'automations.action.delete': string;
  'automations.action.promote': string;
  ...
  'automations.filter.all': string;
  'automations.filter.orbit': string;
  'automations.filter.liveArtifact': string;
  'automations.filter.memory': string;
  'automations.filter.designSystem': string;
  'automations.filter.skills': string;
  'automations.filter.connectors': string;
  'automations.filter.compression': string;
  'automations.filter.release': string;
  'automations.filter.quality': string;
  ...
  'tool.askQuestionNotePlaceholder': string;
