...
export const fa: Dict = {
  ...
  'chat.amrCard.switchBody': 'به سرویس رسمی مدل AMR از social-auto سوئیچ کنید — بدون نیاز به تنظیم کلید API. پس از ورود، اعطای دسترسی و شارژ، این اجرا به‌طور خودکار دوباره انجام می‌شود.',
  ...
  'creator.eyebrow': "ساخت",
  'creator.pluginTitle': "ساخت افزونه",
  'creator.skillTitle': "ساخت مهارت",
  'creator.pluginLede': "گردش کار را با کلمات خودتان توصیف کنید — چه چیزی باید انجام دهد، مراحل کلی و کجا می‌خواهید پیش از ادامه تأیید کنید. هوش مصنوعی پیش‌نویس کامل افزونه (روش‌شناسی، بریف شروع، مراحل گردش کار) را برای بازبینی شما آماده می‌کند؛ تا تأیید نکنید چیزی ذخیره نمی‌شود.",
  'creator.skillLede': "توصیف کنید مهارت چه کاری انجام دهد و چه زمانی استفاده شود. هوش مصنوعی یک SKILL.md کامل — توضیح آماده فعال‌سازی، روش‌شناسی و چند prompt آزمایشی — برای بازبینی شما آماده می‌کند؛ تا تأیید نکنید چیزی ذخیره نمی‌شود.",
  'creator.pluginPlaceholder': "مثلاً یک خط تولید هفتگی ویدیوی کوتاه برای حساب والدگری من: انتخاب موضوع‌های پرطرفدار (من تأیید می‌کنم)، نوشتن فیلم‌نامه (من تأیید می‌کنم)، سپس تولید ویدیو و پایان با یک جمع‌بندی.",
  'creator.skillPlaceholder': "مثلاً نوشتن قلاب‌های شروع ۳ ثانیه‌ای برای ویدیوهای کوتاه. هر وقت از قلاب، شروع یا نگه‌داشتن مخاطب حرف زدم استفاده شود. ۵ گزینه مرتب‌شده بر اساس قدرت تأثیر خروجی بده.",
  'creator.targetPlugin': "افزونه",
  'creator.targetSkill': "مهارت",
  'creator.draftButton': "پیش‌نویس با هوش مصنوعی",
  'creator.drafting': "در حال پیش‌نویس…",
  'creator.redraft': "پیش‌نویس دوباره",
  'creator.draftFailed': "پیش‌نویس ناموفق بود. تنظیمات مدل را بررسی کنید و دوباره تلاش کنید.",
  'creator.save': "ذخیره و انتشار",
  'creator.saving': "در حال ذخیره…",
  'creator.saveFailed': "ذخیره ناموفق بود.",
  'creator.skillSaved': "مهارت در کتابخانه شما ذخیره شد.",
  'creator.nameLabel': "شناسه",
  'creator.titleLabel': "عنوان",
  'creator.descriptionLabel': "توضیح",
  'creator.stagesHint': "promptهای گام‌به‌گام با نقاط تأیید انسانی. پس از ذخیره در ویرایشگر کامل ریزتنظیمشان کنید.",
  'creator.triggersLabel': "محرک‌ها (جداشده با ویرگول)",
  'creator.bodyLabel': "متن SKILL.md",
  'creator.evalsLabel': "promptهای آزمایشی",
  'creator.evalsHint': "به‌صورت evals/evals.json ذخیره می‌شود — بعداً برای آزمایش و بهبود مهارت استفاده می‌شود.",
  ...
  'settings.agentInstall.stepAuth':
    'قبل از بازگشت به social-auto، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'social-auto را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'entry.githubStarAria': 'به social-auto در GitHub ستاره بدهید',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید social-auto در حال اجراست و دوباره تلاش کنید.',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه social-auto — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه social-auto ارائه می‌شود — نیازی به دانلود نیست.',
  ...
  'updater.availableBody': 'social-auto {version} موجود است. پیش از باز شدن نصب‌کننده دانلود می‌شود.',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. social-auto در حال بسته شدن است تا بتوانید به‌روزرسانی را کامل کنید.',
  ...
  'updater.quitButton': 'بستن social-auto',
  'updater.quitFailedBody': 'نصب‌کننده باز است، اما social-auto بسته نشد. پیش از جایگزینی برنامه، social-auto را ببندید.',
  'updater.quitFailedTitle': 'امکان بستن نیست',
  'updater.quitting': 'در حال بستن...',
  'updater.ready': 'به‌روزرسانی آماده است',
  'updater.readyGeneric': 'نسخه جدید آماده است. social-auto بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.readyVersion': 'social-auto {version} آماده است. social-auto بسته می‌شود و نصب‌کننده را باز می‌کند.',
