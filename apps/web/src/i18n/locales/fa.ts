...
export const fa: Dict = {
  ...
  'chat.amrCard.switchBody': 'به سرویس رسمی مدل AMR از WorkBuild سوئیچ کنید — بدون نیاز به تنظیم کلید API. پس از ورود، اعطای دسترسی و شارژ، این اجرا به‌طور خودکار دوباره انجام می‌شود.',
  ...
  'settings.agentInstall.stepAuth':
    'قبل از بازگشت به WorkBuild، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'WorkBuild را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'entry.githubStarAria': 'به WorkBuild در GitHub ستاره بدهید',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید WorkBuild در حال اجراست و دوباره تلاش کنید.',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه WorkBuild — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه WorkBuild ارائه می‌شود — نیازی به دانلود نیست.',
  ...
  'updater.availableBody': 'WorkBuild {version} موجود است. پیش از باز شدن نصب‌کننده دانلود می‌شود.',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. WorkBuild در حال بسته شدن است تا بتوانید به‌روزرسانی را کامل کنید.',
  ...
  'updater.quitButton': 'بستن WorkBuild',
  'updater.quitFailedBody': 'نصب‌کننده باز است، اما WorkBuild بسته نشد. پیش از جایگزینی برنامه، WorkBuild را ببندید.',
  'updater.quitFailedTitle': 'امکان بستن نیست',
  'updater.quitting': 'در حال بستن...',
  'updater.ready': 'به‌روزرسانی آماده است',
  'updater.readyGeneric': 'نسخه جدید آماده است. WorkBuild بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.readyVersion': 'WorkBuild {version} آماده است. WorkBuild بسته می‌شود و نصب‌کننده را باز می‌کند.',
