...
export const fr: Dict = {
  ...
  'chat.amrCard.switchBody': 'Passez au service de modèles AMR officiel d\'WorkBuild — aucune clé API à configurer. Après connexion, autorisation et recharge, cette exécution sera relancée automatiquement.',
  ...
  'settings.onboardingCreateBody': 'Décrivez le site, l’app, le deck, l’image ou la vidéo que vous voulez. WorkBuild créera un projet et gardera le travail modifiable.',
  ...
  'settings.agentInstall.pathHint': 'Si vous avez installé une CLI avec npm ou Homebrew et qu\'elle apparaît toujours comme non installée, vérifiez que le dossier bin de l\'outil est dans le PATH hérité par le daemon WorkBuild (le Terminal et les applications graphiques peuvent différer sur macOS). Voir QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Ouvrez Installer ou Documentation pour l\'agent souhaité.',
  'settings.agentInstall.stepAuth': 'Authentifiez-vous avec la CLI du fournisseur (connexion ou ajout des identifiants API) avant de revenir dans WorkBuild.',
  ...
  'settings.mcpServerHint': 'Exposez WorkBuild comme serveur MCP pour votre agent de code.',
  ...
  'settings.privacyHint': 'Données partagées avec l’équipe WorkBuild',
  'settings.privacyConsentKicker': 'Aidez-nous à améliorer WorkBuild',
  'settings.privacyConsentLead': 'WorkBuild peut partager des données d’utilisation avec notre équipe pour nous aider à améliorer le produit. Cela inclut :',
  ...
  'settings.mcpHint': 'Permet à un agent de code dans un autre dépôt (Claude Code, Cursor, VS Code, Antigravity, Zed, Windsurf) de lire vos projets WorkBuild. Utilisez-le pour intégrer un design dans votre app sans exporter d’abord un zip.',
  'settings.mcpDaemonError': 'Impossible de joindre le daemon local pour résoudre les chemins d’installation ({error}). Vérifiez qu’WorkBuild fonctionne, puis rouvrez ce panneau.',
  ...
  'settings.mcpCapabilityDefault': 'Utiliser par défaut le projet et le fichier ouverts dans WorkBuild, afin que vous puissiez dire « intègre ce design dans mon application » sans repréciser quel design.',
  'settings.mcpRunningNote': 'WorkBuild doit être lancé pour que les appels d’outils MCP réussissent. Si vous avez démarré votre agent de code avant d’ouvrir WorkBuild, redémarrez l’agent pour qu’il puisse joindre le daemon actif.',
  ...
  'homeHero.chip.createPluginHint': 'Créer un plugin WorkBuild réutilisable et l’ajouter à Mes plugins.',
  ...
  'pluginsHome.subtitle': 'Workflows WorkBuild prêts à l’emploi, intégrés à ce runtime. Choisissez-en un pour charger un prompt de départ, ou parcourez le registre pour en trouver d’autres.',
  ...
  'pluginsHome.emptyCatalog': 'Le catalogue est vide. Les plugins intégrés sont fournis avec WorkBuild et devraient apparaître ici automatiquement — essayez de redémarrer le daemon si cela persiste.',
  ...
  'pluginCard.contributeAria': 'Soumettre {title} à WorkBuild',
  'pluginCard.contributeTitle': 'Soumettre le plugin à WorkBuild via une pull request',
  ...
  'integrations.lede': 'Connectez des systèmes externes, ajoutez des outils MCP à votre boucle agent et utilisez WorkBuild depuis d’autres IDE, scripts et automatisations.',
  ...
  'mcpClient.daemonError': 'Impossible de joindre le daemon local. Vérifiez qu’WorkBuild est lancé, puis rouvrez ce panneau.',
  'mcpClient.saveFailed': 'Échec de l’enregistrement. Vérifiez que le daemon est lancé, puis réessayez.',
  'useEverywhere.modalAria': 'Utiliser WorkBuild partout',
  'useEverywhere.modalTitle': 'Utiliser WorkBuild partout',
  'useEverywhere.modalSubtitle': 'Ajoutez WorkBuild à n’importe quel IDE, agent ou script — CLI, HTTP, MCP et compétences. Utilisez « Copier le guide pour un agent » puis collez-le dans Claude Code, Codex, Cursor, openclaw ou hermes pour tout configurer.',
  ...
  'useEverywhere.section.overview.heading': 'WorkBuild fonctionne partout où votre agent fonctionne',
  'useEverywhere.section.overview.intro': 'WorkBuild est plus qu’une fenêtre : c’est un daemon local privilégié (`od`) plus un registre de compétences, systèmes de design et Atoms. Une fois lancé sur votre machine, tout agent de code (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes ou votre propre script) peut piloter des générations, inspecter les projets et produire des artefacts de design via quatre surfaces interchangeables.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` pour scripts sans interface, CI et automatisation shell.',
  'useEverywhere.section.overview.bullet2': 'Serveur MCP — expose WorkBuild comme serveur Model Context Protocol afin que tout agent compatible MCP puisse lister les compétences, lancer des scénarios et lire les artefacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Compétences — packs `SKILL.md` prêts à déposer (compatibles Claude) que tout agent déjà dans votre PATH peut invoquer même sans WorkBuild.',
  ...
  'useEverywhere.section.cli.heading': 'Piloter WorkBuild depuis n’importe quel shell',
  ...
  'useEverywhere.section.mcp.heading': 'Exposer WorkBuild comme serveur MCP à tout agent de code',
  'useEverywhere.section.mcp.intro': 'WorkBuild fournit un serveur Model Context Protocol (`od mcp`) qui permet à tout client compatible MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — de découvrir les outils WorkBuild (lister les compétences, rendre les aperçus, générer des médias, lancer des plugins) sans exécuter manuellement de commandes shell. Le daemon publie un extrait d’installation prêt à coller via `GET /api/mcp/install-info` pour chaque grand client.',
  ...
  'useEverywhere.section.mcp.footer': 'Dans l’app WorkBuild, ouvrez Paramètres → Intégrations pour copier une commande d’installation propre au client (Cursor, Claude Code, Antigravity, VS Code) au lieu d’éditer du JSON à la main.',
  ...
  'useEverywhere.section.skills.heading': 'Compétences prêtes à déposer pour tout agent — même sans WorkBuild lancé',
  'useEverywhere.section.skills.intro': 'Une compétence est un dossier avec un `SKILL.md` compatible Claude (front matter YAML + corps). WorkBuild étend ce format avec l’espace de noms `od:` (`mode`, `preview`, `design_system`, `inputs`, …) afin que le même artefact puisse être utilisé dans WorkBuild et par un agent vanilla comme Claude Code, Codex, openclaw ou hermes. La découverte suit une chaîne de priorité pour que les projets puissent remplacer leurs propres compétences.',
  ...
  'useEverywhere.section.skills.snippet1': 'SKILL.md minimal (front matter compatible Claude + extras WorkBuild)',
  ...
  'entry.githubStarAria': 'Mettre une étoile à WorkBuild sur GitHub',
  ...
  'preview.shareTextDefault': 'Modèle WorkBuild : {title}',
  ...
  'preview.errorBody': 'Le chargement du HTML de l\'exemple a échoué. Vérifiez qu\'WorkBuild est en cours d\'exécution et réessayez.',
  ...
  'pet.tabBuiltInHint': 'Compagnons fournis avec WorkBuild — choisissez-en un et adoptez-le.',
  ...
  'pet.codexBundledTitle': 'Livré avec WorkBuild — aucun téléchargement nécessaire.',
  ...
  'settings.memoryStarterProjectDesc': 'WorkBuild v0.5 — éditeur de design piloté par chat',
  ...
  'updater.availableBody': 'WorkBuild {version} est disponible. Elle sera téléchargée avant l’ouverture du programme d’installation.',
  ...
  'updater.installerOpenBody': 'Le programme d’installation est ouvert. WorkBuild est en train de quitter pour vous permettre de terminer la mise à jour.',
  ...
  'updater.quitButton': 'Quitter WorkBuild',
  'updater.quitFailedBody': 'Le programme d’installation est ouvert, mais WorkBuild n’a pas pu quitter. Quittez WorkBuild avant de remplacer l’application.',
  'updater.quitFailedTitle': 'Impossible de quitter',
  'updater.quitting': 'Fermeture...',
  'updater.ready': 'Mise à jour prête',
  'updater.readyGeneric': 'Une nouvelle version est prête. WorkBuild va se fermer et ouvrir le programme d’installation.',
  'updater.readyVersion': 'WorkBuild {version} est prêt. WorkBuild va se fermer et ouvrir le programme d’installation.',
