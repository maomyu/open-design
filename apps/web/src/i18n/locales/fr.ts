...
export const fr: Dict = {
  ...
  'chat.amrCard.switchBody': 'Passez au service de modèles AMR officiel d\'social-auto — aucune clé API à configurer. Après connexion, autorisation et recharge, cette exécution sera relancée automatiquement.',
  ...
  'creator.eyebrow': "Créer",
  'creator.pluginTitle': "Créer un plugin",
  'creator.skillTitle': "Créer une compétence",
  'creator.pluginLede': "Décrivez le flux de travail avec vos propres mots — ce qu'il doit accomplir, les grandes étapes et les points où vous voulez valider avant de continuer. L'IA rédige le plugin complet (méthodologie, brief de lancement, étapes du workflow) pour votre relecture ; rien n'est enregistré sans votre accord.",
  'creator.skillLede': "Décrivez ce que la compétence doit faire et quand l'utiliser. L'IA rédige un SKILL.md complet — description déclenchable, méthodologie et quelques prompts de test — pour votre relecture ; rien n'est enregistré sans votre accord.",
  'creator.pluginPlaceholder': "ex. Une chaîne hebdomadaire de vidéos courtes pour mon compte parental : choisir des sujets tendance (je valide), écrire le script (je valide), puis générer la vidéo et conclure par un récap.",
  'creator.skillPlaceholder': "ex. Écrire des accroches d'ouverture de 3 secondes pour vidéos courtes. À utiliser dès que je parle d'accroches, d'ouvertures ou de rétention. Proposer 5 options classées par impact.",
  'creator.targetPlugin': "Plugin",
  'creator.targetSkill': "Compétence",
  'creator.draftButton': "Rédiger avec l'IA",
  'creator.drafting': "Rédaction…",
  'creator.redraft': "Rédiger à nouveau",
  'creator.draftFailed': "Échec de la rédaction. Vérifiez vos réglages de modèle et réessayez.",
  'creator.save': "Enregistrer et publier",
  'creator.saving': "Enregistrement…",
  'creator.saveFailed': "Échec de l'enregistrement.",
  'creator.skillSaved': "Compétence enregistrée dans votre bibliothèque.",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "Titre",
  'creator.descriptionLabel': "Description",
  'creator.stagesHint': "Prompts étape par étape avec validations humaines. Affinez-les dans l'éditeur complet après l'enregistrement.",
  'creator.triggersLabel': "Déclencheurs (séparés par des virgules)",
  'creator.bodyLabel': "Corps du SKILL.md",
  'creator.evalsLabel': "Prompts de test",
  'creator.evalsHint': "Enregistré sous evals/evals.json — servira ensuite à tester et améliorer la compétence.",
  ...
  'settings.onboardingCreateBody': 'Décrivez le site, l’app, le deck, l’image ou la vidéo que vous voulez. social-auto créera un projet et gardera le travail modifiable.',
  ...
  'settings.agentInstall.oneClick': 'Installation en un clic',
  'settings.agentInstall.running': 'Installation…',
  'settings.agentInstall.failedRetry': 'Échec — réessayer',
  'settings.agentInstall.autoKimi': 'Aucune CLI locale détectée — installation automatique de la CLI Kimi par défaut…',
  'settings.agentInstall.docs': 'Documentation',
  'settings.agentInstall.pathHint': 'Si vous avez installé une CLI avec npm ou Homebrew et qu\'elle apparaît toujours comme non installée, vérifiez que le dossier bin de l\'outil est dans le PATH hérité par le daemon social-auto (le Terminal et les applications graphiques peuvent différer sur macOS). Voir QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Ouvrez Installer ou Documentation pour l\'agent souhaité.',
  'settings.agentInstall.stepAuth': 'Authentifiez-vous avec la CLI du fournisseur (connexion ou ajout des identifiants API) avant de revenir dans social-auto.',
  ...
  'settings.mcpServerHint': 'Exposez social-auto comme serveur MCP pour votre agent de code.',
  ...
  'settings.privacyHint': 'Données partagées avec l’équipe social-auto',
  'settings.privacyConsentKicker': 'Aidez-nous à améliorer social-auto',
  'settings.privacyConsentLead': 'social-auto peut partager des données d’utilisation avec notre équipe pour nous aider à améliorer le produit. Cela inclut :',
  ...
  'settings.mcpHint': 'Permet à un agent de code dans un autre dépôt (Claude Code, Cursor, VS Code, Antigravity, Zed, Windsurf) de lire vos projets social-auto. Utilisez-le pour intégrer un design dans votre app sans exporter d’abord un zip.',
  'settings.mcpDaemonError': 'Impossible de joindre le daemon local pour résoudre les chemins d’installation ({error}). Vérifiez qu’social-auto fonctionne, puis rouvrez ce panneau.',
  ...
  'settings.mcpCapabilityDefault': 'Utiliser par défaut le projet et le fichier ouverts dans social-auto, afin que vous puissiez dire « intègre ce design dans mon application » sans repréciser quel design.',
  'settings.mcpRunningNote': 'social-auto doit être lancé pour que les appels d’outils MCP réussissent. Si vous avez démarré votre agent de code avant d’ouvrir social-auto, redémarrez l’agent pour qu’il puisse joindre le daemon actif.',
  ...
  'homeHero.title': 'Que voulez-vous construire ?',
  'homeHero.subtitlePrefix': 'L’agent IA open source qui construit tout — d’une phrase à la mise en ligne.',
  ...
  'homeHero.chip.createPluginHint': 'Créer un plugin social-auto réutilisable et l’ajouter à Mes plugins.',
  ...
  'pluginsHome.subtitle': 'Workflows social-auto prêts à l’emploi, intégrés à ce runtime. Choisissez-en un pour charger un prompt de départ, ou parcourez le registre pour en trouver d’autres.',
  ...
  'pluginsHome.emptyCatalog': 'Le catalogue est vide. Les plugins intégrés sont fournis avec social-auto et devraient apparaître ici automatiquement — essayez de redémarrer le daemon si cela persiste.',
  ...
  'pluginsHome.showBuiltins': "Officiels",
  'pluginsHome.ownedBadge': "Intégré",
  'pluginsHome.showBuiltinsHint': "Afficher les plugins officiels du dépôt amont (masqués par défaut)",
  ...
  'pluginCard.contributeAria': 'Soumettre {title} à social-auto',
  'pluginCard.contributeTitle': 'Soumettre le plugin à social-auto via une pull request',
  ...
  'integrations.lede': 'Connectez des systèmes externes, ajoutez des outils MCP à votre boucle agent et utilisez social-auto depuis d’autres IDE, scripts et automatisations.',
  ...
  'mcpClient.daemonError': 'Impossible de joindre le daemon local. Vérifiez qu’social-auto est lancé, puis rouvrez ce panneau.',
  'mcpClient.saveFailed': 'Échec de l’enregistrement. Vérifiez que le daemon est lancé, puis réessayez.',
  'useEverywhere.modalAria': 'Utiliser social-auto partout',
  'useEverywhere.modalTitle': 'Utiliser social-auto partout',
  'useEverywhere.modalSubtitle': 'Ajoutez social-auto à n’importe quel IDE, agent ou script — CLI, HTTP, MCP et compétences. Utilisez « Copier le guide pour un agent » puis collez-le dans Claude Code, Codex, Cursor, openclaw ou hermes pour tout configurer.',
  ...
  'useEverywhere.section.overview.heading': 'social-auto fonctionne partout où votre agent fonctionne',
  'useEverywhere.section.overview.intro': 'social-auto est plus qu’une fenêtre : c’est un daemon local privilégié (`od`) plus un registre de compétences, systèmes de design et Atoms. Une fois lancé sur votre machine, tout agent de code (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes ou votre propre script) peut piloter des générations, inspecter les projets et produire des artefacts de design via quatre surfaces interchangeables.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` pour scripts sans interface, CI et automatisation shell.',
  'useEverywhere.section.overview.bullet2': 'Serveur MCP — expose social-auto comme serveur Model Context Protocol afin que tout agent compatible MCP puisse lister les compétences, lancer des scénarios et lire les artefacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Compétences — packs `SKILL.md` prêts à déposer (compatibles Claude) que tout agent déjà dans votre PATH peut invoquer même sans social-auto.',
  ...
  'useEverywhere.section.cli.heading': 'Piloter social-auto depuis n’importe quel shell',
  ...
  'useEverywhere.section.mcp.heading': 'Exposer social-auto comme serveur MCP à tout agent de code',
  'useEverywhere.section.mcp.intro': 'social-auto fournit un serveur Model Context Protocol (`od mcp`) qui permet à tout client compatible MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — de découvrir les outils social-auto (lister les compétences, rendre les aperçus, générer des médias, lancer des plugins) sans exécuter manuellement de commandes shell. Le daemon publie un extrait d’installation prêt à coller via `GET /api/mcp/install-info` pour chaque grand client.',
  ...
  'useEverywhere.section.mcp.footer': 'Dans l’app social-auto, ouvrez Paramètres → Intégrations pour copier une commande d’installation propre au client (Cursor, Claude Code, Antigravity, VS Code) au lieu d’éditer du JSON à la main.',
  ...
  'useEverywhere.section.skills.heading': 'Compétences prêtes à déposer pour tout agent — même sans social-auto lancé',
  'useEverywhere.section.skills.intro': 'Une compétence est un dossier avec un `SKILL.md` compatible Claude (front matter YAML + corps). social-auto étend ce format avec l’espace de noms `od:` (`mode`, `preview`, `design_system`, `inputs`, …) afin que le même artefact puisse être utilisé dans social-auto et par un agent vanilla comme Claude Code, Codex, openclaw ou hermes. La découverte suit une chaîne de priorité pour que les projets puissent remplacer leurs propres compétences.',
  ...
  'useEverywhere.section.skills.snippet1': 'SKILL.md minimal (front matter compatible Claude + extras social-auto)',
  ...
  'entry.githubStarAria': 'Mettre une étoile à social-auto sur GitHub',
  ...
  'preview.shareTextDefault': 'Modèle social-auto : {title}',
  ...
  'preview.errorBody': 'Le chargement du HTML de l\'exemple a échoué. Vérifiez qu\'social-auto est en cours d\'exécution et réessayez.',
  ...
  'tool.askQuestionNotePlaceholder': "Ajouter une note (facultatif)…",
  ...
  'pet.tabBuiltInHint': 'Compagnons fournis avec social-auto — choisissez-en un et adoptez-le.',
  ...
  'pet.codexBundledTitle': 'Livré avec social-auto — aucun téléchargement nécessaire.',
  ...
  'settings.memoryStarterProjectDesc': 'social-auto v0.5 — éditeur de design piloté par chat',
  ...
  'updater.availableBody': 'social-auto {version} est disponible. Elle sera téléchargée avant l’ouverture du programme d’installation.',
  ...
  'updater.installerOpenBody': 'Le programme d’installation est ouvert. social-auto est en train de quitter pour vous permettre de terminer la mise à jour.',
  ...
  'updater.quitButton': 'Quitter social-auto',
  'updater.quitFailedBody': 'Le programme d’installation est ouvert, mais social-auto n’a pas pu quitter. Quittez social-auto avant de remplacer l’application.',
  'updater.quitFailedTitle': 'Impossible de quitter',
  'updater.quitting': 'Fermeture...',
  'updater.ready': 'Mise à jour prête',
  'updater.readyGeneric': 'Une nouvelle version est prête. social-auto va se fermer et ouvrir le programme d’installation.',
  'updater.readyVersion': 'social-auto {version} est prêt. social-auto va se fermer et ouvrir le programme d’installation.',
