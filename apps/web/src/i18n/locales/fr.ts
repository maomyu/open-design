...
export const fr: Dict = {
  ...
  'chat.amrCard.switchBody': 'Passez au service de modèles AMR officiel d\'爆创 — aucune clé API à configurer. Après connexion, autorisation et recharge, cette exécution sera relancée automatiquement.',
  ...
  'settings.onboardingCreateBody': 'Décrivez le site, l’app, le deck, l’image ou la vidéo que vous voulez. 爆创 créera un projet et gardera le travail modifiable.',
  ...
  'settings.agentInstall.pathHint': 'Si vous avez installé une CLI avec npm ou Homebrew et qu\'elle apparaît toujours comme non installée, vérifiez que le dossier bin de l\'outil est dans le PATH hérité par le daemon 爆创 (le Terminal et les applications graphiques peuvent différer sur macOS). Voir QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Ouvrez Installer ou Documentation pour l\'agent souhaité.',
  'settings.agentInstall.stepAuth': 'Authentifiez-vous avec la CLI du fournisseur (connexion ou ajout des identifiants API) avant de revenir dans 爆创.',
  ...
  'settings.mcpServerHint': 'Exposez 爆创 comme serveur MCP pour votre agent de code.',
  ...
  'settings.privacyHint': 'Données partagées avec l’équipe 爆创',
  'settings.privacyConsentKicker': 'Aidez-nous à améliorer 爆创',
  'settings.privacyConsentLead': '爆创 peut partager des données d’utilisation avec notre équipe pour nous aider à améliorer le produit. Cela inclut :',
  ...
  'settings.mcpHint': 'Permet à un agent de code dans un autre dépôt (Claude Code, Cursor, VS Code, Antigravity, Zed, Windsurf) de lire vos projets 爆创. Utilisez-le pour intégrer un design dans votre app sans exporter d’abord un zip.',
  'settings.mcpDaemonError': 'Impossible de joindre le daemon local pour résoudre les chemins d’installation ({error}). Vérifiez qu’爆创 fonctionne, puis rouvrez ce panneau.',
  ...
  'settings.mcpCapabilityDefault': 'Utiliser par défaut le projet et le fichier ouverts dans 爆创, afin que vous puissiez dire « intègre ce design dans mon application » sans repréciser quel design.',
  'settings.mcpRunningNote': '爆创 doit être lancé pour que les appels d’outils MCP réussissent. Si vous avez démarré votre agent de code avant d’ouvrir 爆创, redémarrez l’agent pour qu’il puisse joindre le daemon actif.',
  ...
  'homeHero.chip.createPluginHint': 'Créer un plugin 爆创 réutilisable et l’ajouter à Mes plugins.',
  ...
  'pluginsHome.subtitle': 'Workflows 爆创 prêts à l’emploi, intégrés à ce runtime. Choisissez-en un pour charger un prompt de départ, ou parcourez le registre pour en trouver d’autres.',
  ...
  'pluginsHome.emptyCatalog': 'Le catalogue est vide. Les plugins intégrés sont fournis avec 爆创 et devraient apparaître ici automatiquement — essayez de redémarrer le daemon si cela persiste.',
  ...
  'pluginCard.contributeAria': 'Soumettre {title} à 爆创',
  'pluginCard.contributeTitle': 'Soumettre le plugin à 爆创 via une pull request',
  ...
  'integrations.lede': 'Connectez des systèmes externes, ajoutez des outils MCP à votre boucle agent et utilisez 爆创 depuis d’autres IDE, scripts et automatisations.',
  ...
  'mcpClient.daemonError': 'Impossible de joindre le daemon local. Vérifiez qu’爆创 est lancé, puis rouvrez ce panneau.',
  'mcpClient.saveFailed': 'Échec de l’enregistrement. Vérifiez que le daemon est lancé, puis réessayez.',
  'useEverywhere.modalAria': 'Utiliser 爆创 partout',
  'useEverywhere.modalTitle': 'Utiliser 爆创 partout',
  'useEverywhere.modalSubtitle': 'Ajoutez 爆创 à n’importe quel IDE, agent ou script — CLI, HTTP, MCP et compétences. Utilisez « Copier le guide pour un agent » puis collez-le dans Claude Code, Codex, Cursor, openclaw ou hermes pour tout configurer.',
  ...
  'useEverywhere.section.overview.heading': '爆创 fonctionne partout où votre agent fonctionne',
  'useEverywhere.section.overview.intro': '爆创 est plus qu’une fenêtre : c’est un daemon local privilégié (`od`) plus un registre de compétences, systèmes de design et Atoms. Une fois lancé sur votre machine, tout agent de code (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes ou votre propre script) peut piloter des générations, inspecter les projets et produire des artefacts de design via quatre surfaces interchangeables.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` pour scripts sans interface, CI et automatisation shell.',
  'useEverywhere.section.overview.bullet2': 'Serveur MCP — expose 爆创 comme serveur Model Context Protocol afin que tout agent compatible MCP puisse lister les compétences, lancer des scénarios et lire les artefacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Compétences — packs `SKILL.md` prêts à déposer (compatibles Claude) que tout agent déjà dans votre PATH peut invoquer même sans 爆创.',
  ...
  'useEverywhere.section.cli.heading': 'Piloter 爆创 depuis n’importe quel shell',
  ...
  'useEverywhere.section.mcp.heading': 'Exposer 爆创 comme serveur MCP à tout agent de code',
  'useEverywhere.section.mcp.intro': '爆创 fournit un serveur Model Context Protocol (`od mcp`) qui permet à tout client compatible MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — de découvrir les outils 爆创 (lister les compétences, rendre les aperçus, générer des médias, lancer des plugins) sans exécuter manuellement de commandes shell. Le daemon publie un extrait d’installation prêt à coller via `GET /api/mcp/install-info` pour chaque grand client.',
  ...
  'useEverywhere.section.mcp.footer': 'Dans l’app 爆创, ouvrez Paramètres → Intégrations pour copier une commande d’installation propre au client (Cursor, Claude Code, Antigravity, VS Code) au lieu d’éditer du JSON à la main.',
  ...
  'useEverywhere.section.skills.heading': 'Compétences prêtes à déposer pour tout agent — même sans 爆创 lancé',
  'useEverywhere.section.skills.intro': 'Une compétence est un dossier avec un `SKILL.md` compatible Claude (front matter YAML + corps). 爆创 étend ce format avec l’espace de noms `od:` (`mode`, `preview`, `design_system`, `inputs`, …) afin que le même artefact puisse être utilisé dans 爆创 et par un agent vanilla comme Claude Code, Codex, openclaw ou hermes. La découverte suit une chaîne de priorité pour que les projets puissent remplacer leurs propres compétences.',
  ...
  'useEverywhere.section.skills.snippet1': 'SKILL.md minimal (front matter compatible Claude + extras 爆创)',
  ...
  'entry.githubStarAria': 'Mettre une étoile à 爆创 sur GitHub',
  ...
  'preview.shareTextDefault': 'Modèle 爆创 : {title}',
  ...
  'preview.errorBody': 'Le chargement du HTML de l\'exemple a échoué. Vérifiez qu\'爆创 est en cours d\'exécution et réessayez.',
  ...
  'pet.tabBuiltInHint': 'Compagnons fournis avec 爆创 — choisissez-en un et adoptez-le.',
  ...
  'pet.codexBundledTitle': 'Livré avec 爆创 — aucun téléchargement nécessaire.',
  ...
  'settings.memoryStarterProjectDesc': '爆创 v0.5 — éditeur de design piloté par chat',
  ...
  'updater.availableBody': '爆创 {version} est disponible. Elle sera téléchargée avant l’ouverture du programme d’installation.',
  ...
  'updater.installerOpenBody': 'Le programme d’installation est ouvert. 爆创 est en train de quitter pour vous permettre de terminer la mise à jour.',
  ...
  'updater.quitButton': 'Quitter 爆创',
  'updater.quitFailedBody': 'Le programme d’installation est ouvert, mais 爆创 n’a pas pu quitter. Quittez 爆创 avant de remplacer l’application.',
  'updater.quitFailedTitle': 'Impossible de quitter',
  'updater.quitting': 'Fermeture...',
  'updater.ready': 'Mise à jour prête',
  'updater.readyGeneric': 'Une nouvelle version est prête. 爆创 va se fermer et ouvrir le programme d’installation.',
  'updater.readyVersion': '爆创 {version} est prêt. 爆创 va se fermer et ouvrir le programme d’installation.',
