...
export const zhCN: Dict = {
  ...
  'chat.amrCard.switchBody': "可切换到 WorkBuild 官方 AMR 模型服务，无需配置 API Key。完成登录、授权和充值后，将自动重试当前任务。",
  ...
  'common.save': '保存',
  'common.close': '关闭',
  'pluginEditor.title': "编辑提示词",
  'pluginEditor.openButton': "编辑提示词",
  'pluginEditor.aiTitle': "AI 帮我改",
  'pluginEditor.aiPlaceholder': "想怎么改？一句话说（例：选题步只给 3 个但每个更狠 / 文案多出一版）",
  'pluginEditor.aiButton': "让 AI 改",
  'pluginEditor.aiWorking': "正在改…",
  'pluginEditor.aiDone': "AI 已改好，下面审一下，满意就保存并发布",
  'pluginEditor.aiUndo': "撤销",
  'pluginEditor.aiFailed': "AI 改写失败",
  'pluginEditor.queryLabel': "开场指令",
  'pluginEditor.queryHint': "用户选用插件时自动填进对话框的那段。{{...}} 是输入占位，别动。",
  'pluginEditor.skillLabel': "行为与方法（SKILL.md）",
  'pluginEditor.skillHint': "agent 每一步怎么做的方法论，改这里就改了它的行为。",
  'pluginEditor.publish': "保存并发布",
  'pluginEditor.publishing': "发布中…",
  'pluginEditor.published': "已保存并发布，下次运行生效",
  'pluginEditor.configHeading': "插件配置 · API Key",
  'pluginEditor.configHint': "这些密钥按本插件单独保存,只注入到本插件的运行中(不写进任何文件、不上传)。",
  'pluginEditor.configSet': "已配置",
  'pluginEditor.configNone': "此插件无需额外配置。",
  'pluginEditor.configClear': "清除",
  'pluginEditor.failed': "保存失败",
  'pluginEditor.readOnly': "此插件来源只读，不可编辑。",
  'pluginEditor.unsaved': "有未保存修改",
  'pluginEditor.back': "返回",
  'pluginEditor.displayHeading': "提示词",
  'pluginEditor.chatEmpty': "用一句话说想怎么改——例如「选题步只给 3 个但每个更狠」。AI 会改左边的提示词，你审一眼，满意再「保存并发布」。",
  'pluginEditor.youLabel': "你",
  'pluginEditor.aiLabel': "AI",
  'pluginEditor.stepsLabel': "步骤",
  'pluginEditor.stepsHint': "顶部步骤条 + 看板用它渲染，必须和上面提示词里写的步骤对齐。",
  'pluginEditor.stepIdPlaceholder': "id",
  'pluginEditor.stepTitlePlaceholder': "步骤名",
  'pluginEditor.stepAdd': "加一步",
  'pluginEditor.stepRemove': "删除此步",
  'pluginEditor.stepUp': "上移",
  'pluginEditor.stepDown': "下移",
  'pluginEditor.stepLeft': "左移",
  'pluginEditor.stepRight': "右移",
  'pluginEditor.nodeQuery': "开场",
  'pluginEditor.nodeSkill': "方法论",
  'pluginEditor.gateConfirm': "确认",
  'pluginEditor.gateChoice': "选择",
  'pluginEditor.gateNone': "不卡",
  'pluginEditor.stepPromptPlaceholder': "这一步的提示词——决定该步产出的效果和风格",
  'pluginEditor.modeLabelPlaceholder': "模式名（如 AI 建议）",
  'pluginEditor.modePromptPlaceholder': "该模式的提示词",
  'pluginEditor.modeAdd': "加模式",
  'pluginEditor.modeRemove': "删除模式",
  'pluginEditor.modeAiEdit': "AI 改这模式",
  'pluginEditor.modeUntitled': "未命名模式",
  'pluginEditor.branchLabel': "子节点选择方式（岔路）",
  'pluginEditor.branchHint': "这些子节点是并列的选择项，不是顺序步骤。单选=选一个；多选=选中的每个都各跑一遍。",
  'pluginEditor.branchSelectLabel': "选择",
  'pluginEditor.branchPickLabel': "由谁选",
  'pluginEditor.branchSingle': "单选（选一个）",
  'pluginEditor.branchMulti': "多选（每个都跑一遍）",
  'pluginEditor.branchPickAsk': "运行时问用户",
  'pluginEditor.branchPickInput': "按输入值",
  'pluginEditor.branchGroupSingle': "单选",
  'pluginEditor.branchGroupMulti': "多选",
  'pluginEditor.branchGroupInput': "按输入",
  'pluginEditor.submodeAdd': "加子选项",
  'pluginEditor.submodeRemove': "删除子选项",
  'pluginEditor.submodeUntitled': "未命名子选项",
  'pluginEditor.submodeLabelPlaceholder': "子选项名，如 bb-browser",
  'pluginEditor.submodePromptPlaceholder': "这个子选项自己的提示词…",
  'pluginEditor.accountsHeading': "账号",
  'pluginEditor.accountsHint': "每个账号有自己的凭证和自己的写作风格。工作流第 0 步先选账号，写稿严格按该账号的风格来。",
  'pluginEditor.accountAdd': "加账号",
  'pluginEditor.accountEdit': "编辑",
  'pluginEditor.accountDelete': "删除",
  'pluginEditor.accountSave': "保存账号",
  'pluginEditor.accountEmpty': "还没有账号。先加一个，工作流开工时就能选它。",
  'pluginEditor.accountName': "账号名",
  'pluginEditor.accountNamePlaceholder': "账号名，如 报考日记",
  'pluginEditor.accountPersona': "写作风格 / 人设",
  'pluginEditor.accountPersonaHint': "这个号怎么写——语气、受众、禁忌。会注入写稿步。",
  'pluginEditor.accountSamples': "风格范文样本（可选）",
  'pluginEditor.accountSamplesHint': "贴 1–3 篇历史文章，用空行分隔。智能体写稿前先学它们的腔调。",
  'pluginEditor.accountCredentials': "凭证",
  'pluginEditor.accountCredsHint': "这个账号自己的密钥——发布时只用这里的值,不会回落任何插件级默认。",
  'pluginEditor.accountSaved': "账号已保存",
  'pluginEditor.accountSaveFailed': "保存失败",
  'pluginEditor.stepAiEdit': "AI 改这步",
  'pluginEditor.stageSkillsLabel': "本步技能",
  'pluginEditor.skillBindPlaceholder': "+ 绑定技能",
  'pluginEditor.skillUnbind': "解绑技能",
  'pluginEditor.skillMissing': "该技能已不存在——重新绑定,或到技能库创建它。",
  'pluginEditor.history': "历史",
  'pluginEditor.historyEmpty': "还没有历史版本——每次保存会自动留档。",
  'pluginEditor.restore': "恢复",
  'pluginEditor.restored': "已恢复。恢复前的状态也已留档,可再次回滚。",
  'skillsLibrary.title': "技能库",
  'skillsLibrary.lede': "你的 agent 能用到的所有技能——内置的和你自己创建的。把技能绑定到插件的工作流步骤上,编排每一步用什么方法。",
  'skillsLibrary.searchPlaceholder': "搜索技能…",
  'skillsLibrary.sourceUser': "我的",
  'skillsLibrary.sourceClaude': "Claude",
  'skillsLibrary.sourceBuiltIn': "内置",
  'skillsLibrary.usedBy': "被引用:",
  'skillsLibrary.delete': "删除技能",
  'skillsLibrary.deleted': "技能已删除。",
  'skillsLibrary.empty': "没有匹配的技能。",
  'creator.eyebrow': "创建",
  'creator.pluginTitle': "创建插件",
  'creator.skillTitle': "创建技能",
  'creator.pluginLede': "用自己的话描述这个业务流程——要完成什么、大致分几步、哪里需要你确认后再继续。AI 会起草完整插件（方法论、开场指令、工作流步骤）供你审阅；确认保存前不会落盘。",
  'creator.skillLede': "描述这个技能要做什么、什么时候用。AI 会起草完整的 SKILL.md——可触发的描述、方法论、以及几个测试 prompt——供你审阅；确认保存前不会落盘。",
  'creator.pluginPlaceholder': "例：给我的母婴账号做一条短视频周更流水线：先选热门选题（我确认）、再写脚本（我确认）、然后生成视频并做复盘。",
  'creator.skillPlaceholder': "例：为短视频写开头 3 秒钩子。只要我提到钩子、开场、留人率就用它。输出 5 个备选，按冲击力排序。",
  'creator.targetPlugin': "插件",
  'creator.targetSkill': "技能",
  'creator.draftButton': "AI 起草",
  'creator.drafting': "起草中…",
  'creator.redraft': "重新起草",
  'creator.draftFailed': "起草失败，请检查模型设置后重试。",
  'creator.save': "保存并发布",
  'creator.saving': "保存中…",
  'creator.saveFailed': "保存失败。",
  'creator.skillSaved': "技能已保存到你的技能库。",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "显示名",
  'creator.descriptionLabel': "描述",
  'creator.stagesHint': "带人工闸门的分步提示词，保存后可在完整编辑器里细调。",
  'creator.triggersLabel': "触发词（逗号分隔）",
  'creator.bodyLabel': "SKILL.md 正文",
  'creator.evalsLabel': "测试 prompt",
  'creator.evalsHint': "会存为 evals/evals.json，之后用于测试和改进这个技能。",
  'tune.open': "调教这个 agent",
  'tune.title': "对产物点评，教它变好",
  'tune.notePlaceholder': "还想怎么改？可选，例：钩子再狠、去掉广告腔",
  'tune.good': "很好，延续",
  'tune.applyPreference': "记住偏好",
  'tune.saveSample': "采纳为样板",
  'tune.saveSampleHint': "把这条产物记成下次的风格样板",
  'tune.savedPreference': "记住了，下次照这个来",
  'tune.savedSample': "已采纳为风格样板",
  'tune.failed': "保存失败",
  'common.delete': '删除',
  'common.rename': '重命名',
  'common.edit': '编辑',
  ...
  'settings.onboardingCreateBody':
    '描述你想做的网站、应用、Deck、图片或视频，WorkBuild 会创建项目，并保留可继续编辑的产物。',
  ...
  'settings.agentInstall.pathHint':
    '如果你通过 npm 或 Homebrew 安装了 CLI，但仍显示为未安装，请确认该工具的 bin 目录已加入 WorkBuild daemon 继承的 PATH（在 macOS 上，Terminal 与 GUI 应用的 PATH 可能不同）。请参阅 QUICKSTART.md（“Local agent CLI and PATH” 章节）。',
  'settings.agentInstall.stepOpenLinks': '在目标代理卡片上打开“安装”或“文档”链接。',
  'settings.agentInstall.stepAuth':
    '返回 WorkBuild 之前，请先在对应 CLI 中完成认证（登录或添加 API 凭据）。',
  ...
  'settings.mcpServerHint': '将 WorkBuild 作为 MCP 服务器暴露给你的编码代理。',
  ...
  'settings.privacy': '隐私',
  'settings.privacyHint': '与 WorkBuild 团队共享哪些数据',
  'settings.privacyConsentKicker': '帮助我们改进 WorkBuild',
  'settings.privacyConsentLead': 'WorkBuild 可以将使用数据共享给我们的团队以协助改进。包括:',
  ...
  'settings.mcpHint':
    '让其他仓库中的编码助手（Claude Code、Cursor、VS Code、Antigravity、Zed、Windsurf）读取你的 WorkBuild 项目。无需先导出 zip，即可将设计拉取到你的应用中。',
  'settings.mcpDaemonError':
    '无法连接到本地守护进程以解析安装路径（{error}）。请确保 WorkBuild 正在运行，然后重新打开此面板。',
  ...
  'settings.mcpCapabilityDefault':
    '默认使用你在 WorkBuild 中打开的项目和文件，因此你可以直接说"在我的应用中构建这个"，无需重复说明是哪个设计。',
  'settings.mcpRunningNote':
    'WorkBuild 必须处于运行状态，MCP 工具调用才能成功。如果你在打开 WorkBuild 之前启动了编码助手，请重启助手以便它能连接到正在运行的守护进程。',
  ...
  'entry.navMedia': '自媒体',
  'entry.navAccounts': '账号',
  'mediaHub.title': '自媒体',
  'mediaHub.lede': '每个平台一个入口——选账号、备内容、发出去。账号在「账号」页统一管理。',
  'mediaHub.manageAccounts': '管理账号',
  'mediaHub.publishSuffix': '发布',
  'mediaHub.start': '开始',
  'mediaHub.matrixTitle': '矩阵(一条内容 → 全平台)',
  'mediaHub.matrixFallback': '短视频工作流',
  'mediaHub.entryMissing': '入口插件未注册——重启 daemon 加载内置插件。',
  'accountsView.title': '自媒体账号',
  'accountsView.lede': '账号属于平台:同一个号,所有对应平台的插件共用——配一次,处处能选。',
  'accountsView.kindApi': 'API 凭证',
  'accountsView.kindSau': '扫码登录(sau)',
  'accountsView.platformEmpty': '还没有账号。',
  'accountsView.sauNamePlaceholder': '账号名 = 本机 sau 的 --account 档案名,如 main',
  'accountsView.sauHint': '该平台运行时扫码登录(工作流会自动弹窗)。账号名同时就是本机 sau 的 cookie 档案名。',
  'workspaceTabs.project': '项目',
  'workspaceTabs.pluginDetails': '插件详情',
  'workspaceTabs.marketplace': '插件市场',
  'homeHero.title': '你想构建什么？',
  'homeHero.subtitlePrefix': '开源全流程 AI 构建智能体 · 从一句话到上线。',
  ...
  'homeHero.chip.createPluginHint': '创作可复用的 WorkBuild 插件，并添加到我的插件。',
  ...
  'pluginsHome.subtitle': '当前运行环境内置的 WorkBuild 工作流。选择一个加载 starter prompt，或浏览插件市场查看更多。',
  'pluginsHome.browseRegistry': '浏览插件市场',
  'pluginsHome.count': '{filtered} / {total}',
  'pluginsHome.loadingCatalog': '正在加载目录…',
  'pluginsHome.emptyCatalog': '目录为空。WorkBuild 会随附内置插件，如果这里一直为空，请尝试重启 daemon。',
  'pluginsHome.emptyFiltered': '没有插件匹配当前筛选条件。',
  'pluginsHome.clearFilters': '清除筛选',
  'pluginsHome.modeAria': '插件模式',
  'pluginsHome.featured': 'Saved',
  'pluginsHome.showBuiltins': "官方插件",
  'pluginsHome.ownedBadge': "内置插件",
  'pluginsHome.showBuiltinsHint': "显示官方仓库的官方插件（默认隐藏）",
  ...
  'pluginCard.contributeAria': '将 {title} 贡献到 WorkBuild',
  'pluginCard.contributeTitle': '通过 pull request 将插件贡献到 WorkBuild',
  ...
  'integrations.lede': '连接外部系统，把 MCP 工具带入智能体循环，并在其它 IDE、脚本和自动化中使用 WorkBuild。',
  ...
  'integrations.apiKeys.title': '第三方 API Key',
  'integrations.apiKeys.desc': '密钥只保存在本机，并在运行智能体时作为环境变量注入，不会离开这台设备。',
  'integrations.apiKeys.empty': '还没有配置任何密钥。',
  'integrations.apiKeys.tikhubHint': '例如 TIKHUB_API_KEY——用于短视频热榜抓取，密钥获取地址：',
  'integrations.apiKeys.keyPlaceholder': '密钥名（如 TIKHUB_API_KEY）',
  'integrations.apiKeys.valuePlaceholder': '密钥值',
  'integrations.apiKeys.add': '新增密钥',
  'integrations.apiKeys.save': '保存',
  'integrations.apiKeys.saving': '保存中…',
  'integrations.apiKeys.saved': '已保存',
  'integrations.apiKeys.remove': '删除',
  'integrations.apiKeys.invalidKey': '密钥名需符合环境变量格式：大写字母、数字、下划线，且以字母开头。',
  'integrations.apiKeys.saveFailed': '保存失败，请确认本地守护进程在运行后重试。',
  ...
  'mcpClient.daemonError': '无法连接本地 daemon。请确认 WorkBuild 正在运行，然后重新打开此面板。',
  'mcpClient.saveFailed': '保存失败。请检查 daemon 是否正在运行后重试。',
  'useEverywhere.modalAria': '随处使用 WorkBuild',
  'useEverywhere.modalTitle': '随处使用 WorkBuild',
  'useEverywhere.modalSubtitle': '把 WorkBuild 接入任何 IDE、智能体或脚本：CLI、HTTP、MCP 和 Skills。使用“复制智能体指南”，粘贴到 Claude Code、Codex、Cursor、openclaw 或 hermes 中即可完成配置。',
  ...
  'useEverywhere.section.overview.heading': 'WorkBuild 可在智能体工作的任何地方运行',
  'useEverywhere.section.overview.intro': 'WorkBuild 不只是一个窗口；它包含本地特权 daemon（`od`），以及 Skills + Design Systems + Atoms registry。它在你的机器上运行后，任何代码智能体（Claude Code、Codex、Cursor、OpenCode/openclaw、Hermes 或你自己的脚本）都可以通过四种可互换入口驱动生成、检查项目并产出设计制品。',
  'useEverywhere.section.overview.bullet1': 'CLI — 使用 `od <command>` 支持无头脚本、CI 和 shell 自动化。',
  'useEverywhere.section.overview.bullet2': 'MCP 服务器 — 将 WorkBuild 作为 Model Context Protocol 服务器接入，使任何支持 MCP 的智能体都能列出技能、运行场景并读取制品。',
  'useEverywhere.section.overview.bullet3': 'HTTP API — `http://127.0.0.1:7456/api/*` REST + SSE 端点；与 Web UI 使用同一套接口。',
  'useEverywhere.section.overview.bullet4': 'Skills — 可直接放入的 `SKILL.md` 包（兼容 Claude），任何已在 PATH 中的智能体都能调用，甚至不需要打开 WorkBuild。',
  ...
  'useEverywhere.section.cli.heading': '从任意 shell 驱动 WorkBuild',
  ...
  'useEverywhere.section.mcp.heading': '把 WorkBuild 暴露为任意代码智能体可用的 MCP 服务器',
  'useEverywhere.section.mcp.intro': 'WorkBuild 内置 Model Context Protocol 服务器（`od mcp`），让任何支持 MCP 的客户端（Cursor、Claude Code、Antigravity、VS Code Copilot Chat、openclaw、hermes）都能发现 WorkBuild 工具（列出技能、渲染预览、生成媒体、运行插件），无需手动 shell 调用。daemon 会通过 `GET /api/mcp/install-info` 为主流客户端发布可直接粘贴的安装片段。',
  ...
  'useEverywhere.section.mcp.footer': '在 WorkBuild 应用中，打开“设置 → 集成”即可复制特定客户端的安装命令（Cursor、Claude Code、Antigravity、VS Code），无需手写 JSON。',
  ...
  'useEverywhere.section.skills.heading': '任意智能体可直接使用的 Skills，即使 WorkBuild 未运行',
  'useEverywhere.section.skills.intro': 'Skill 是一个包含 Claude 兼容 `SKILL.md`（YAML front matter + 正文）的目录。WorkBuild 通过 `od:` 命名空间（`mode`、`preview`、`design_system`、`inputs` 等）扩展该格式，使同一个制品既能在 WorkBuild 内使用，也能被 Claude Code、Codex、openclaw 或 hermes 这类普通智能体使用。发现逻辑遵循优先级链，因此项目可以覆盖自己的 skills。',
  ...
  'useEverywhere.section.skills.snippet1': '最小 SKILL.md（Claude 兼容 front matter + WorkBuild 扩展）',
  ...
  'automations.hero.eyebrow': '定时智能体会话',
  'automations.hero.title': '自动化',
  'automations.hero.lede': '为项目工作、Orbit 摘要和实时制品安排周期性对话。',
  'automations.summaryAria': '自动化概览',
  'automations.metric.active': '已启用',
  'automations.metric.paused': '已暂停',
  'automations.metric.templates': '模板',
  'automations.new': '新建自动化',
  'automations.savedAria': '你的自动化',
  'automations.savedTitle': '你的自动化',
  ...
  'automations.run': '运行',
  'automations.runTitle': '立即运行并打开对话',
  ...
  'automations.proposalsAria': '自动化演进提案',
  'automations.proposalsTitle': '演进提案',
  'automations.proposalsSub': '在自动化产出改动记忆、技能或设计体系之前先审核。',
  'automations.proposalsPending': '{count} 项待处理',
  'automations.apply': '应用',
  'automations.reject': '拒绝',
  'automations.rejectReason': '在自动化中已忽略',
  'automations.target.memory': '记忆',
  'automations.target.designSystem': '设计体系',
  'automations.target.skill': '技能',
  'automations.target.template': '自动化模板',
  'automations.action.create': '创建',
  'automations.action.update': '更新',
  'automations.action.merge': '合并',
  'automations.action.move': '移动',
  'automations.action.delete': '删除',
  'automations.action.promote': '提升',
  'automations.templatesAria': '自动化模板',
  'automations.templatesTitle': '模板',
  'automations.templatesSub': 'Orbit 和实时制品都是同一套自动化流程里的模板。',
  ...
  'automations.filter.liveArtifact': '实时制品',
  'automations.filter.memory': '记忆',
  'automations.filter.designSystem': '设计体系',
  'automations.filter.skills': '技能',
  'automations.filter.connectors': '连接器',
  'automations.filter.compression': '压缩',
  'automations.filter.release': '发布',
  'automations.filter.quality': '质量',
  'automations.templatesEmptyTitle': '该分类下暂无模板。',
  'automations.templatesEmptyBody': '换个筛选，或从空白自动化开始。',
  ...
  'automations.history.latest': '最近 10 条',
  'automations.history.aria': '自动化运行历史',
  'automations.openConversation': '打开对话',
  'automations.crystallize': '萃取',
  'automations.crystallizing': '萃取中',
  'automations.crystallizeTitle': '从此次运行草拟技能与记忆提案',
  'routines.title': '自动化',
  ...
  'entry.githubStarAria': '在 GitHub 上为 WorkBuild 点亮 Star',
  ...
  'code.agentMode.label': '模式',
  'code.agentMode.code': '代码',
  'code.agentMode.plan': '规划',
  'code.agentMode.ask': '询问',
  'code.agentMode.codeHint': '代码：读写文件并执行命令（完全访问）。',
  'code.agentMode.planHint': '规划：分析并给出方案，不执行任何操作。',
  'code.agentMode.askHint': '询问：只读回答问题，不改动你的项目。',
  'newproj.tabCode': '通用',
  ...
  'preview.shareTextDefault': 'WorkBuild 模板：{title}',
  ...
  'preview.errorBody': '示例 HTML 加载失败。请确认 WorkBuild 正在运行后重试。',
  'preview.retry': '重试',
  ...
  'designFiles.emptyCode': '生成的文件会出现在这里',
  ...
  'tool.askQuestionNotePlaceholder': "补充你的想法或修改建议（可选）…",
  ...
  'pet.title': '宠物',
  'pet.tabBuiltIn': '内置',
  'pet.tabBuiltInHint': 'WorkBuild 内置的精选宠物 — 一键领养。',
  ...
  'pet.codexBundled': '内置',
  'pet.codexBundledTitle': 'WorkBuild 内置宠物，无需下载。',
  ...
  'settings.memoryStarterProjectDesc': 'WorkBuild v0.5 — 聊天驱动的设计编辑器',
  ...
  'updater.availableBody': 'WorkBuild {version} 可用。下载安装完成后即可打开安装器。',
  ...
  'updater.done': '完成',
  'updater.failed': '更新失败',
  'updater.installerOpenBody': '安装器已打开。WorkBuild 正在退出，以便你完成更新。',
  'updater.installerOpened': '安装器已打开',
  'updater.later': '稍后',
  'updater.openFailedFallback': '无法打开安装器。',
  'updater.openInstaller': '安装更新',
  'updater.opening': '正在打开安装器…',
  'updater.quitButton': '退出 WorkBuild',
  'updater.quitFailedBody': '安装器已打开，但 WorkBuild 无法退出。替换应用前请先退出 WorkBuild。',
  'updater.quitFailedTitle': '无法退出',
  'updater.quitting': '正在退出…',
  'updater.ready': '更新已就绪',
  'updater.readyGeneric': '新版本已就绪。WorkBuild 会关闭并打开安装器。',
  'updater.readyVersion': 'WorkBuild {version} 已就绪。WorkBuild 会关闭并打开安装器。',
