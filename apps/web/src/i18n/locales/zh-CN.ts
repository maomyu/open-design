...
export const zhCN: Dict = {
  ...
  'homeHero.runModeAsk': '询问',
  'homeHero.runModeAuto': '自动',
  'homeHero.runModeAskHint': '询问模式:每个关卡停下来等你确认。',
  'homeHero.runModeAutoHint': '自动模式:全程不问一口气跑完(真正对外发布前仍会确认一次)。缺配置/API Key 会停下来——配好后回复「继续」接着跑。',
