...
export const id: Dict = {
  ...
  'chat.amrCard.switchBody': 'Beralih ke layanan model AMR resmi social-auto — tanpa perlu mengatur API Key. Setelah masuk, otorisasi, dan isi ulang, proses ini akan dicoba ulang otomatis.',
  ...
  'settings.agentInstall.stepAuth':
    'Lakukan autentikasi di CLI vendor (masuk atau tambahkan kredensial API) sebelum kembali ke social-auto.',
  ...
  'settings.mcpServerHint': 'Ekspos social-auto sebagai server MCP untuk agen koding Anda.',
  ...
  'entry.githubStarAria': 'Beri star social-auto di GitHub',
  ...
  'preview.errorBody': 'Pengambilan HTML contoh gagal. Pastika social-auto berjalan, lalu coba lagi.',
  ...
  'pet.tabBuiltInHint': 'Pet pilihan yang disertakan denga social-auto - pilih satu lalu adopsi.',
  ...
  'pet.codexBundledTitle': 'Disertakan denga social-auto - tidak perlu diunduh.',
  ...
  'updater.availableBody': 'social-auto {version} tersedia. Update akan diunduh sebelum installer dapat dibuka.',
  ...
  'updater.installerOpenBody': 'Installer sudah terbuka. social-auto sedang ditutup agar Anda dapat menyelesaikan pembaruan.',
  ...
  'updater.quitButton': 'Tutup social-auto',
  'updater.quitFailedBody': 'Installer sudah terbuka, tetapi social-auto tidak dapat ditutup. Tutup social-auto sebelum mengganti aplikasi.',
  'updater.quitFailedTitle': 'Tidak dapat menutup',
  'updater.quitting': 'Menutup...',
  'updater.ready': 'Update siap',
  'updater.readyGeneric': 'Versi baru siap. social-auto akan ditutup dan membuka installer.',
  'updater.readyVersion': 'social-auto {version} siap. social-auto akan ditutup dan membuka installer.',
