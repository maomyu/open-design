...
export const id: Dict = {
  ...
  'chat.amrCard.switchBody': 'Beralih ke layanan model AMR resmi 爆创 — tanpa perlu mengatur API Key. Setelah masuk, otorisasi, dan isi ulang, proses ini akan dicoba ulang otomatis.',
  ...
  'creator.eyebrow': "Buat",
  'creator.pluginTitle': "Buat plugin",
  'creator.skillTitle': "Buat skill",
  'creator.pluginLede': "Jelaskan alur kerja dengan kata-kata Anda sendiri — apa yang harus dicapai, langkah garis besarnya, dan di mana Anda ingin mengonfirmasi sebelum lanjut. AI menyusun draf plugin lengkap (metodologi, brief awal, langkah workflow) untuk Anda tinjau; tidak ada yang disimpan sampai Anda setuju.",
  'creator.skillLede': "Jelaskan apa yang harus dilakukan skill dan kapan digunakan. AI menyusun draf SKILL.md lengkap — deskripsi siap-trigger, metodologi, dan beberapa prompt uji — untuk Anda tinjau; tidak ada yang disimpan sampai Anda setuju.",
  'creator.pluginPlaceholder': "mis. Pipeline video pendek mingguan untuk akun parenting saya: pilih topik yang sedang tren (saya konfirmasi), tulis naskah (saya konfirmasi), lalu buat videonya dan tutup dengan rekap.",
  'creator.skillPlaceholder': "mis. Tulis hook pembuka 3 detik untuk video pendek. Gunakan setiap kali saya menyebut hook, pembuka, atau retensi. Keluarkan 5 opsi diurutkan berdasarkan daya pukul.",
  'creator.targetPlugin': "Plugin",
  'creator.targetSkill': "Skill",
  'creator.draftButton': "Draf dengan AI",
  'creator.drafting': "Menyusun draf…",
  'creator.redraft': "Draf ulang",
  'creator.draftFailed': "Gagal menyusun draf. Periksa pengaturan model lalu coba lagi.",
  'creator.save': "Simpan & terbitkan",
  'creator.saving': "Menyimpan…",
  'creator.saveFailed': "Gagal menyimpan.",
  'creator.skillSaved': "Skill tersimpan di pustaka Anda.",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "Judul",
  'creator.descriptionLabel': "Deskripsi",
  'creator.stagesHint': "Prompt langkah demi langkah dengan titik konfirmasi manusia. Sesuaikan di editor lengkap setelah disimpan.",
  'creator.triggersLabel': "Pemicu (dipisahkan koma)",
  'creator.bodyLabel': "Isi SKILL.md",
  'creator.evalsLabel': "Prompt uji",
  'creator.evalsHint': "Disimpan sebagai evals/evals.json — dipakai nanti untuk menguji dan menyempurnakan skill.",
  ...
  'settings.agentInstall.pathHint':
    'Jika Anda memasang CLI dengan npm atau Homebrew tetapi masih tampil sebagai belum terpasang, pastikan direktori bin alat ada di PATH yang diwarisi daemon 爆创 (PATH Terminal dan aplikasi GUI bisa berbeda di macOS). Lihat QUICKSTART.md (bagian "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Buka Instal atau Dokumentasi untuk agen pilihan Anda.',
  'settings.agentInstall.stepAuth':
    'Lakukan autentikasi di CLI vendor (masuk atau tambahkan kredensial API) sebelum kembali ke 爆创.',
  ...
  'settings.mcpServerHint': 'Ekspos 爆创 sebagai server MCP untuk agen koding Anda.',
  ...
  'entry.githubStarAria': 'Beri star 爆创 di GitHub',
  ...
  'preview.errorBody': 'Pengambilan HTML contoh gagal. Pastika 爆创 berjalan, lalu coba lagi.',
  ...
  'pet.tabBuiltInHint': 'Pet pilihan yang disertakan denga 爆创 - pilih satu lalu adopsi.',
  ...
  'pet.codexBundledTitle': 'Disertakan denga 爆创 - tidak perlu diunduh.',
  ...
  'updater.availableBody': '爆创 {version} tersedia. Update akan diunduh sebelum installer dapat dibuka.',
  ...
  'updater.installerOpenBody': 'Installer sudah terbuka. 爆创 sedang ditutup agar Anda dapat menyelesaikan pembaruan.',
  ...
  'updater.quitButton': 'Tutup 爆创',
  'updater.quitFailedBody': 'Installer sudah terbuka, tetapi 爆创 tidak dapat ditutup. Tutup 爆创 sebelum mengganti aplikasi.',
  'updater.quitFailedTitle': 'Tidak dapat menutup',
  'updater.quitting': 'Menutup...',
  'updater.ready': 'Update siap',
  'updater.readyGeneric': 'Versi baru siap. 爆创 akan ditutup dan membuka installer.',
  'updater.readyVersion': '爆创 {version} siap. 爆创 akan ditutup dan membuka installer.',
