...
export const id: Dict = {
  ...
  'chat.amrCard.switchBody': 'Beralih ke layanan model AMR resmi WorkBuild — tanpa perlu mengatur API Key. Setelah masuk, otorisasi, dan isi ulang, proses ini akan dicoba ulang otomatis.',
  ...
  'settings.agentInstall.pathHint':
    'Jika Anda memasang CLI dengan npm atau Homebrew tetapi masih tampil sebagai belum terpasang, pastikan direktori bin alat ada di PATH yang diwarisi daemon WorkBuild (PATH Terminal dan aplikasi GUI bisa berbeda di macOS). Lihat QUICKSTART.md (bagian "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Buka Instal atau Dokumentasi untuk agen pilihan Anda.',
  'settings.agentInstall.stepAuth':
    'Lakukan autentikasi di CLI vendor (masuk atau tambahkan kredensial API) sebelum kembali ke WorkBuild.',
  ...
  'settings.mcpServerHint': 'Ekspos WorkBuild sebagai server MCP untuk agen koding Anda.',
  ...
  'entry.githubStarAria': 'Beri star WorkBuild di GitHub',
  ...
  'updater.availableBody': 'WorkBuild {version} tersedia. Update akan diunduh sebelum installer dapat dibuka.',
  ...
  'updater.installerOpenBody': 'Installer sudah terbuka. WorkBuild sedang ditutup agar Anda dapat menyelesaikan pembaruan.',
  ...
  'updater.quitButton': 'Tutup WorkBuild',
  'updater.quitFailedBody': 'Installer sudah terbuka, tetapi WorkBuild tidak dapat ditutup. Tutup WorkBuild sebelum mengganti aplikasi.',
  'updater.quitFailedTitle': 'Tidak dapat menutup',
  'updater.quitting': 'Menutup...',
  'updater.ready': 'Update siap',
  'updater.readyGeneric': 'Versi baru siap. WorkBuild akan ditutup dan membuka installer.',
  'updater.readyVersion': 'WorkBuild {version} siap. WorkBuild akan ditutup dan membuka installer.',
