...
export const ptBR: Dict = {
  ...
  'chat.amrCard.switchBody': 'Mude para o serviço oficial de modelos AMR do 爆创 — sem precisar configurar API Key. Após entrar, autorizar e recarregar, esta execução será repetida automaticamente.',
  ...
  'settings.agentInstall.pathHint':
    'Se você instalou uma CLI com npm ou Homebrew e ela ainda aparece como não instalada, garanta que o diretório bin da ferramenta esteja no PATH herdado pelo daemon do 爆创 (Terminal e apps GUI podem diferir no macOS). Veja QUICKSTART.md (seção "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abra Instalar ou Docs para o agente desejado.',
  'settings.agentInstall.stepAuth':
    'Autentique-se na CLI do fornecedor (faça login ou adicione credenciais de API) antes de voltar ao 爆创.',
  ...
  'settings.mcpServerHint': 'Exponha o 爆创 como servidor MCP para o seu agente de código.',
  ...
  'entry.githubStarAria': 'Dar uma estrela ao 爆创 no GitHub',
  ...
  'preview.errorBody': 'A obtenção do HTML do exemplo falhou. Verifique se o 爆创 está em execução e tente novamente.',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no 爆创 — escolha um e adote.',
  ...
  'pet.codexBundledTitle': 'Já vem com o 爆创 — sem download.',
  ...
  'updater.availableBody': '爆创 {version} está disponível. Ela será baixada antes que o instalador possa abrir.',
  ...
  'updater.installerOpenBody': 'O instalador está aberto. O 爆创 está saindo para que você conclua a atualização.',
  ...
  'updater.quitButton': 'Sair do 爆创',
  'updater.quitFailedBody': 'O instalador está aberto, mas não foi possível sair do 爆创. Saia do 爆创 antes de substituir o app.',
  'updater.quitFailedTitle': 'Não foi possível sair',
  'updater.quitting': 'Saindo...',
  'updater.ready': 'Atualização pronta',
  'updater.readyGeneric': 'Uma nova versão está pronta. O 爆创 será fechado e abrirá o instalador.',
  'updater.readyVersion': '爆创 {version} está pronto. O 爆创 será fechado e abrirá o instalador.',
