...
export const ptBR: Dict = {
  ...
  'chat.amrCard.switchBody': 'Mude para o serviço oficial de modelos AMR do social-auto — sem precisar configurar API Key. Após entrar, autorizar e recarregar, esta execução será repetida automaticamente.',
  ...
  'settings.agentInstall.stepAuth':
    'Autentique-se na CLI do fornecedor (faça login ou adicione credenciais de API) antes de voltar ao social-auto.',
  ...
  'settings.mcpServerHint': 'Exponha o social-auto como servidor MCP para o seu agente de código.',
  ...
  'entry.githubStarAria': 'Dar uma estrela ao social-auto no GitHub',
  ...
  'preview.errorBody': 'A obtenção do HTML do exemplo falhou. Verifique se o social-auto está em execução e tente novamente.',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no social-auto — escolha um e adote.',
  ...
  'pet.codexBundledTitle': 'Já vem com o social-auto — sem download.',
  ...
  'updater.availableBody': 'social-auto {version} está disponível. Ela será baixada antes que o instalador possa abrir.',
  ...
  'updater.installerOpenBody': 'O instalador está aberto. O social-auto está saindo para que você conclua a atualização.',
  ...
  'updater.quitButton': 'Sair do social-auto',
  'updater.quitFailedBody': 'O instalador está aberto, mas não foi possível sair do social-auto. Saia do social-auto antes de substituir o app.',
  'updater.quitFailedTitle': 'Não foi possível sair',
  'updater.quitting': 'Saindo...',
  'updater.ready': 'Atualização pronta',
  'updater.readyGeneric': 'Uma nova versão está pronta. O social-auto será fechado e abrirá o instalador.',
  'updater.readyVersion': 'social-auto {version} está pronto. O social-auto será fechado e abrirá o instalador.',
