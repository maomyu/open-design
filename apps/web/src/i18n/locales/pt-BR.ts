...
export const ptBR: Dict = {
  ...
  'chat.amrCard.switchBody': 'Mude para o serviço oficial de modelos AMR do WorkBuild — sem precisar configurar API Key. Após entrar, autorizar e recarregar, esta execução será repetida automaticamente.',
  ...
  'creator.eyebrow': "Criar",
  'creator.pluginTitle': "Criar um plugin",
  'creator.skillTitle': "Criar uma skill",
  'creator.pluginLede': "Descreva o fluxo de trabalho com suas próprias palavras — o que ele deve realizar, as etapas gerais e onde você quer confirmar antes de continuar. A IA rascunha o plugin completo (metodologia, briefing inicial, etapas do workflow) para sua revisão; nada é salvo até você confirmar.",
  'creator.skillLede': "Descreva o que a skill deve fazer e quando deve ser usada. A IA rascunha um SKILL.md completo — descrição acionável, metodologia e alguns prompts de teste — para sua revisão; nada é salvo até você confirmar.",
  'creator.pluginPlaceholder': "ex.: Uma esteira semanal de vídeos curtos para minha conta de maternidade: escolher temas em alta (eu confirmo), escrever o roteiro (eu confirmo) e depois gerar o vídeo e fechar com um resumo.",
  'creator.skillPlaceholder': "ex.: Escrever ganchos de abertura de 3 segundos para vídeos curtos. Use sempre que eu mencionar ganchos, aberturas ou retenção. Gere 5 opções ordenadas por impacto.",
  'creator.targetPlugin': "Plugin",
  'creator.targetSkill': "Skill",
  'creator.draftButton': "Rascunhar com IA",
  'creator.drafting': "Rascunhando…",
  'creator.redraft': "Rascunhar de novo",
  'creator.draftFailed': "Falha ao rascunhar. Verifique as configurações do modelo e tente novamente.",
  'creator.save': "Salvar e publicar",
  'creator.saving': "Salvando…",
  'creator.saveFailed': "Falha ao salvar.",
  'creator.skillSaved': "Skill salva na sua biblioteca.",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "Título",
  'creator.descriptionLabel': "Descrição",
  'creator.stagesHint': "Prompts passo a passo com pontos de confirmação humana. Refine-os no editor completo depois de salvar.",
  'creator.triggersLabel': "Gatilhos (separados por vírgula)",
  'creator.bodyLabel': "Corpo do SKILL.md",
  'creator.evalsLabel': "Prompts de teste",
  'creator.evalsHint': "Salvo como evals/evals.json — usado depois para testar e melhorar a skill.",
  ...
  'settings.agentInstall.pathHint':
    'Se você instalou uma CLI com npm ou Homebrew e ela ainda aparece como não instalada, garanta que o diretório bin da ferramenta esteja no PATH herdado pelo daemon do WorkBuild (Terminal e apps GUI podem diferir no macOS). Veja QUICKSTART.md (seção "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abra Instalar ou Docs para o agente desejado.',
  'settings.agentInstall.stepAuth':
    'Autentique-se na CLI do fornecedor (faça login ou adicione credenciais de API) antes de voltar ao WorkBuild.',
  ...
  'settings.mcpServerHint': 'Exponha o WorkBuild como servidor MCP para o seu agente de código.',
  ...
  'entry.githubStarAria': 'Dar uma estrela ao WorkBuild no GitHub',
  ...
  'preview.errorBody': 'A obtenção do HTML do exemplo falhou. Verifique se o WorkBuild está em execução e tente novamente.',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no WorkBuild — escolha um e adote.',
  ...
  'pet.codexBundledTitle': 'Já vem com o WorkBuild — sem download.',
  ...
  'updater.availableBody': 'WorkBuild {version} está disponível. Ela será baixada antes que o instalador possa abrir.',
  ...
  'updater.installerOpenBody': 'O instalador está aberto. O WorkBuild está saindo para que você conclua a atualização.',
  ...
  'updater.quitButton': 'Sair do WorkBuild',
  'updater.quitFailedBody': 'O instalador está aberto, mas não foi possível sair do WorkBuild. Saia do WorkBuild antes de substituir o app.',
  'updater.quitFailedTitle': 'Não foi possível sair',
  'updater.quitting': 'Saindo...',
  'updater.ready': 'Atualização pronta',
  'updater.readyGeneric': 'Uma nova versão está pronta. O WorkBuild será fechado e abrirá o instalador.',
  'updater.readyVersion': 'WorkBuild {version} está pronto. O WorkBuild será fechado e abrirá o instalador.',
