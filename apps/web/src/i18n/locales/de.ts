...
export const de: Dict = {
  ...
  'chat.amrCard.switchBody': 'Wechsle zum offiziellen AMR-Modelldienst von WorkBuild — kein API-Key-Setup nötig. Nach Anmeldung, Autorisierung und Aufladung wird dieser Lauf automatisch wiederholt.',
  ...
  'settings.agentInstall.stepAuth':
    'Authentifizieren Sie sich mit der Anbieter-CLI (anmelden oder API-Zugangsdaten setzen), bevor Sie zu WorkBuild zurueckkehren.',
  ...
  'settings.mcpServerHint': 'Stelle WorkBuild als MCP-Server für deinen Coding-Agent bereit.',
  ...
  'entry.githubStarAria': 'WorkBuild auf GitHub einen Stern geben',
  ...
  'preview.errorBody': 'Das Beispiel-HTML konnte nicht abgerufen werden. Stelle sicher, dass WorkBuild läuft, und versuche es erneut.',
  ...
  'pet.tabBuiltInHint': 'Mit WorkBuild gebündelte Begleiter — auswählen und adoptieren.',
  ...
  'pet.codexBundledTitle': 'Wird mit WorkBuild ausgeliefert — kein Download nötig.',
  ...
  'updater.availableBody': 'WorkBuild {version} ist verfügbar. Es wird heruntergeladen, bevor der Installer geöffnet werden kann.',
  ...
  'updater.installerOpenBody': 'Der Installer ist geöffnet. WorkBuild wird beendet, damit Sie das Update abschließen können.',
  ...
  'updater.quitButton': 'WorkBuild beenden',
  'updater.quitFailedBody': 'Der Installer ist geöffnet, aber WorkBuild konnte nicht beendet werden. Beenden Sie WorkBuild, bevor Sie die App ersetzen.',
  'updater.quitFailedTitle': 'Beenden fehlgeschlagen',
  'updater.quitting': 'Wird beendet...',
  'updater.ready': 'Update bereit',
  'updater.readyGeneric': 'Eine neue Version ist bereit. WorkBuild wird geschlossen und der Installer geöffnet.',
  'updater.readyVersion': 'WorkBuild {version} ist bereit. WorkBuild wird geschlossen und der Installer geöffnet.',
