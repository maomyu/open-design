...
export const de: Dict = {
  ...
  'chat.amrCard.switchBody': 'Wechsle zum offiziellen AMR-Modelldienst von social-auto — kein API-Key-Setup nötig. Nach Anmeldung, Autorisierung und Aufladung wird dieser Lauf automatisch wiederholt.',
  ...
  'creator.eyebrow': "Erstellen",
  'creator.pluginTitle': "Plugin erstellen",
  'creator.skillTitle': "Skill erstellen",
  'creator.pluginLede': "Beschreibe den Arbeitsablauf in deinen eigenen Worten — was er erreichen soll, die groben Schritte und wo du bestätigen willst, bevor es weitergeht. Die KI entwirft das komplette Plugin (Methodik, Kickoff-Briefing, Workflow-Schritte) zur Durchsicht; gespeichert wird erst, wenn du zustimmst.",
  'creator.skillLede': "Beschreibe, was der Skill tun soll und wann er verwendet werden soll. Die KI entwirft eine vollständige SKILL.md — auslösbare Beschreibung, Methodik und ein paar Test-Prompts — zur Durchsicht; gespeichert wird erst, wenn du zustimmst.",
  'creator.pluginPlaceholder': "z. B. Eine wöchentliche Kurzvideo-Pipeline für meinen Eltern-Account: Trendthemen auswählen (ich bestätige), Skript schreiben (ich bestätige), dann das Video generieren und mit einem Fazit abschließen.",
  'creator.skillPlaceholder': "z. B. 3-Sekunden-Eröffnungshooks für Kurzvideos schreiben. Verwende ihn, wenn ich Hooks, Eröffnungen oder Retention erwähne. Gib 5 Optionen aus, nach Schlagkraft sortiert.",
  'creator.targetPlugin': "Plugin",
  'creator.targetSkill': "Skill",
  'creator.draftButton': "Mit KI entwerfen",
  'creator.drafting': "Entwurf läuft…",
  'creator.redraft': "Erneut entwerfen",
  'creator.draftFailed': "Entwurf fehlgeschlagen. Prüfe deine Modelleinstellungen und versuche es erneut.",
  'creator.save': "Speichern & veröffentlichen",
  'creator.saving': "Wird gespeichert…",
  'creator.saveFailed': "Speichern fehlgeschlagen.",
  'creator.skillSaved': "Skill in deiner Bibliothek gespeichert.",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "Titel",
  'creator.descriptionLabel': "Beschreibung",
  'creator.stagesHint': "Schritt-für-Schritt-Prompts mit manuellen Freigaben. Nach dem Speichern im vollständigen Editor feinjustieren.",
  'creator.triggersLabel': "Auslöser (kommagetrennt)",
  'creator.bodyLabel': "SKILL.md-Inhalt",
  'creator.evalsLabel': "Test-Prompts",
  'creator.evalsHint': "Wird als evals/evals.json gespeichert — dient später zum Testen und Verbessern des Skills.",
  ...
  'settings.agentInstall.stepAuth':
    'Authentifizieren Sie sich mit der Anbieter-CLI (anmelden oder API-Zugangsdaten setzen), bevor Sie zu social-auto zurueckkehren.',
  ...
  'settings.mcpServerHint': 'Stelle social-auto als MCP-Server für deinen Coding-Agent bereit.',
  ...
  'entry.githubStarAria': 'social-auto auf GitHub einen Stern geben',
  ...
  'preview.errorBody': 'Das Beispiel-HTML konnte nicht abgerufen werden. Stelle sicher, dass social-auto läuft, und versuche es erneut.',
  ...
  'pet.tabBuiltInHint': 'Mit social-auto gebündelte Begleiter — auswählen und adoptieren.',
  ...
  'pet.codexBundledTitle': 'Wird mit social-auto ausgeliefert — kein Download nötig.',
  ...
  'updater.availableBody': 'social-auto {version} ist verfügbar. Es wird heruntergeladen, bevor der Installer geöffnet werden kann.',
  ...
  'updater.installerOpenBody': 'Der Installer ist geöffnet. social-auto wird beendet, damit Sie das Update abschließen können.',
  ...
  'updater.quitButton': 'social-auto beenden',
  'updater.quitFailedBody': 'Der Installer ist geöffnet, aber social-auto konnte nicht beendet werden. Beenden Sie social-auto, bevor Sie die App ersetzen.',
  'updater.quitFailedTitle': 'Beenden fehlgeschlagen',
  'updater.quitting': 'Wird beendet...',
  'updater.ready': 'Update bereit',
  'updater.readyGeneric': 'Eine neue Version ist bereit. social-auto wird geschlossen und der Installer geöffnet.',
  'updater.readyVersion': 'social-auto {version} ist bereit. social-auto wird geschlossen und der Installer geöffnet.',
