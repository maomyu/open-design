...
export const de: Dict = {
  ...
  'chat.amrCard.switchBody': 'Wechsle zum offiziellen AMR-Modelldienst von 爆创 — kein API-Key-Setup nötig. Nach Anmeldung, Autorisierung und Aufladung wird dieser Lauf automatisch wiederholt.',
  ...
  'settings.agentInstall.stepAuth':
    'Authentifizieren Sie sich mit der Anbieter-CLI (anmelden oder API-Zugangsdaten setzen), bevor Sie zu 爆创 zurueckkehren.',
  ...
  'settings.mcpServerHint': 'Stelle 爆创 als MCP-Server für deinen Coding-Agent bereit.',
  ...
  'entry.githubStarAria': '爆创 auf GitHub einen Stern geben',
  ...
  'preview.errorBody': 'Das Beispiel-HTML konnte nicht abgerufen werden. Stelle sicher, dass 爆创 läuft, und versuche es erneut.',
  ...
  'pet.tabBuiltInHint': 'Mit 爆创 gebündelte Begleiter — auswählen und adoptieren.',
  ...
  'pet.codexBundledTitle': 'Wird mit 爆创 ausgeliefert — kein Download nötig.',
  ...
  'updater.availableBody': '爆创 {version} ist verfügbar. Es wird heruntergeladen, bevor der Installer geöffnet werden kann.',
  ...
  'updater.installerOpenBody': 'Der Installer ist geöffnet. 爆创 wird beendet, damit Sie das Update abschließen können.',
  ...
  'updater.quitButton': '爆创 beenden',
  'updater.quitFailedBody': 'Der Installer ist geöffnet, aber 爆创 konnte nicht beendet werden. Beenden Sie 爆创, bevor Sie die App ersetzen.',
  'updater.quitFailedTitle': 'Beenden fehlgeschlagen',
  'updater.quitting': 'Wird beendet...',
  'updater.ready': 'Update bereit',
  'updater.readyGeneric': 'Eine neue Version ist bereit. 爆创 wird geschlossen und der Installer geöffnet.',
  'updater.readyVersion': '爆创 {version} ist bereit. 爆创 wird geschlossen und der Installer geöffnet.',
