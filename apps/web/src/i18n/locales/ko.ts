...
export const ko: Dict = {
  ...
  'chat.amrCard.switchBody': 'WorkBuild 공식 AMR 모델 서비스로 전환하세요 — API 키 설정이 필요 없습니다. 로그인・인증・충전이 완료되면 이 작업이 자동으로 재시도됩니다.',
  ...
  'creator.eyebrow': "만들기",
  'creator.pluginTitle': "플러그인 만들기",
  'creator.skillTitle': "스킬 만들기",
  'creator.pluginLede': "업무 흐름을 자신의 말로 설명하세요 — 무엇을 달성해야 하는지, 대략적인 단계, 계속하기 전에 확인하고 싶은 지점. AI가 전체 플러그인(방법론, 킥오프 브리프, 워크플로 단계)의 초안을 작성해 검토를 요청합니다. 확인하기 전에는 저장되지 않습니다.",
  'creator.skillLede': "스킬이 무엇을 해야 하고 언제 사용되는지 설명하세요. AI가 완전한 SKILL.md — 트리거 가능한 설명, 방법론, 몇 가지 테스트 prompt — 초안을 작성해 검토를 요청합니다. 확인하기 전에는 저장되지 않습니다.",
  'creator.pluginPlaceholder': "예: 육아 계정용 주간 숏폼 영상 파이프라인. 인기 주제 선택(내가 확인), 대본 작성(내가 확인), 그다음 영상 생성 후 회고로 마무리.",
  'creator.skillPlaceholder': "예: 숏폼 영상의 첫 3초 훅 작성. 훅, 오프닝, 시청 유지를 언급할 때마다 사용. 임팩트 순으로 5개 옵션 출력.",
  'creator.targetPlugin': "플러그인",
  'creator.targetSkill': "스킬",
  'creator.draftButton': "AI로 초안 작성",
  'creator.drafting': "초안 작성 중…",
  'creator.redraft': "다시 초안 작성",
  'creator.draftFailed': "초안 작성에 실패했습니다. 모델 설정을 확인하고 다시 시도하세요.",
  'creator.save': "저장 및 게시",
  'creator.saving': "저장 중…",
  'creator.saveFailed': "저장에 실패했습니다.",
  'creator.skillSaved': "스킬이 라이브러리에 저장되었습니다.",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "제목",
  'creator.descriptionLabel': "설명",
  'creator.stagesHint': "사람의 확인 지점이 있는 단계별 prompt. 저장 후 전체 편집기에서 세부 조정하세요.",
  'creator.triggersLabel': "트리거(쉼표로 구분)",
  'creator.bodyLabel': "SKILL.md 본문",
  'creator.evalsLabel': "테스트 prompt",
  'creator.evalsHint': "evals/evals.json으로 저장되며 나중에 스킬을 테스트하고 개선하는 데 사용됩니다.",
  ...
  'settings.agentInstall.pathHint':
    'npm 또는 Homebrew로 CLI를 설치했는데도 아직 미설치로 표시된다면, WorkBuild daemon이 상속받는 PATH에 도구의 bin 디렉터리가 포함되어 있는지 확인하세요(macOS에서는 Terminal과 GUI 앱의 PATH가 다를 수 있습니다). QUICKSTART.md("Local agent CLI and PATH" 섹션)를 참고하세요.',
  'settings.agentInstall.stepOpenLinks': '원하는 에이전트 카드에서 설치 또는 문서 링크를 여세요.',
  'settings.agentInstall.stepAuth':
    'WorkBuild으로 돌아오기 전에 공급자 CLI에서 인증(로그인 또는 API 자격 증명 추가)을 완료하세요.',
  ...
  'settings.mcpServerHint': 'WorkBuild을 코딩 에이전트용 MCP 서버로 노출합니다.',
  ...
  'entry.githubStarAria': 'GitHub 에서 WorkBuild 에 별 누르기',
  ...
  'preview.errorBody': '예제 HTML을 가져오지 못했습니다. WorkBuild이 실행 중인지 확인하고 다시 시도하세요.',
  'preview.retry': '다시 시도',
  ...
  'pet.title': '펫',
  'pet.tabBuiltIn': '내장',
  'pet.tabBuiltInHint': 'WorkBuild에 기본 포함된 친구들 — 골라서 입양하세요.',
  ...
  'pet.codexBundled': '내장',
  'pet.codexBundledTitle': 'WorkBuild 에 내장 — 다운로드 불필요.',
  ...
  'updater.availableBody': 'WorkBuild {version}을 사용할 수 있습니다. 설치 프로그램을 열기 전에 다운로드됩니다.',
  ...
  'updater.installerOpenBody': '설치 프로그램이 열려 있습니다. 업데이트를 완료할 수 있도록 WorkBuild을 종료하는 중입니다.',
  ...
  'updater.quitButton': 'WorkBuild 종료',
  'updater.quitFailedBody': '설치 프로그램이 열려 있지만 WorkBuild을 종료할 수 없습니다. 앱을 교체하기 전에 WorkBuild을 종료하세요.',
  'updater.quitFailedTitle': '종료할 수 없음',
  'updater.quitting': '종료 중...',
  'updater.ready': '업데이트 준비됨',
  'updater.readyGeneric': '새 버전이 준비되었습니다. WorkBuild을 닫고 설치 프로그램을 엽니다.',
  'updater.readyVersion': 'WorkBuild {version}이 준비되었습니다. WorkBuild을 닫고 설치 프로그램을 엽니다.',
