...
export const esES: Dict = {
  ...
  'chat.amrCard.switchBody': 'Cambia al servicio oficial de modelos AMR de social-auto — sin configurar API Key. Tras iniciar sesión, autorizar y recargar, esta ejecución se reintentará automáticamente.',
  ...
  'creator.eyebrow': "Crear",
  'creator.pluginTitle': "Crear un plugin",
  'creator.skillTitle': "Crear una skill",
  'creator.pluginLede': "Describe el flujo de trabajo con tus propias palabras: qué debe lograr, los pasos aproximados y dónde quieres confirmar antes de continuar. La IA redacta el plugin completo (metodología, brief inicial, pasos del workflow) para que lo revises; no se guarda nada hasta que lo confirmes.",
  'creator.skillLede': "Describe qué debe hacer la skill y cuándo debe usarse. La IA redacta un SKILL.md completo —descripción activable, metodología y algunos prompts de prueba— para que lo revises; no se guarda nada hasta que lo confirmes.",
  'creator.pluginPlaceholder': "p. ej. Una cadena semanal de vídeos cortos para mi cuenta de crianza: elegir temas en tendencia (yo confirmo), escribir el guion (yo confirmo) y luego generar el vídeo y cerrar con un resumen.",
  'creator.skillPlaceholder': "p. ej. Escribir ganchos de apertura de 3 segundos para vídeos cortos. Úsala siempre que mencione ganchos, aperturas o retención. Devuelve 5 opciones ordenadas por impacto.",
  'creator.targetPlugin': "Plugin",
  'creator.targetSkill': "Skill",
  'creator.draftButton': "Redactar con IA",
  'creator.drafting': "Redactando…",
  'creator.redraft': "Redactar de nuevo",
  'creator.draftFailed': "Error al redactar. Revisa la configuración del modelo y vuelve a intentarlo.",
  'creator.save': "Guardar y publicar",
  'creator.saving': "Guardando…",
  'creator.saveFailed': "Error al guardar.",
  'creator.skillSaved': "Skill guardada en tu biblioteca.",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "Título",
  'creator.descriptionLabel': "Descripción",
  'creator.stagesHint': "Prompts paso a paso con puntos de confirmación humana. Ajústalos en el editor completo después de guardar.",
  'creator.triggersLabel': "Disparadores (separados por comas)",
  'creator.bodyLabel': "Cuerpo del SKILL.md",
  'creator.evalsLabel': "Prompts de prueba",
  'creator.evalsHint': "Se guarda como evals/evals.json; se usará después para probar y mejorar la skill.",
  ...
  'settings.agentInstall.oneClick': 'Instalación con un clic',
  'settings.agentInstall.running': 'Instalando…',
  'settings.agentInstall.failedRetry': 'Falló — reintentar',
  'settings.agentInstall.autoKimi': 'No se detectó ninguna CLI local; instalando automáticamente la CLI Kimi predeterminada…',
  'settings.agentInstall.docs': 'Docs',
  'settings.agentInstall.pathHint':
    'Si instalaste una CLI con npm o Homebrew y sigue apareciendo como no instalada, asegúrate de que el directorio bin de la herramienta esté en el PATH que hereda el daemon de social-auto (Terminal y apps GUI pueden diferir en macOS). Consulta QUICKSTART.md (sección "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abre Instalar o Docs para el agente que prefieras.',
  'settings.agentInstall.stepAuth':
    'Autentícate con la CLI del proveedor (inicia sesión o añade credenciales API) antes de volver a social-auto.',
  ...
  'settings.mcpServerHint': 'Expón social-auto como servidor MCP para tu agente de código.',
  ...
  'entry.githubStarAria': 'Dar una estrella a social-auto en GitHub',
  ...
  'preview.errorBody': 'No se pudo obtener el HTML del ejemplo. Asegúrate de que social-auto esté en ejecución e inténtalo de nuevo.',
  ...
  'pet.tabBuiltInHint': 'Compañeros incluidos con social-auto — elige uno y adóptalo.',
  ...
  'pet.codexBundledTitle': 'Viene con social-auto — sin descarga.',
  ...
  'updater.availableBody': 'social-auto {version} está disponible. Se descargará antes de abrir el instalador.',
  ...
  'updater.installerOpenBody': 'El instalador está abierto. social-auto se está cerrando para que puedas completar la actualización.',
  ...
  'updater.quitButton': 'Salir de social-auto',
  'updater.quitFailedBody': 'El instalador está abierto, pero social-auto no pudo cerrarse. Cierra social-auto antes de reemplazar la app.',
  'updater.quitFailedTitle': 'No se pudo salir',
  'updater.quitting': 'Cerrando...',
  'updater.ready': 'Actualización lista',
  'updater.readyGeneric': 'Hay una nueva versión lista. social-auto se cerrará y abrirá el instalador.',
  'updater.readyVersion': 'social-auto {version} está listo. social-auto se cerrará y abrirá el instalador.',
