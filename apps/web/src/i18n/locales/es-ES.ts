...
export const esES: Dict = {
  ...
  'chat.amrCard.switchBody': 'Cambia al servicio oficial de modelos AMR de 爆创 — sin configurar API Key. Tras iniciar sesión, autorizar y recargar, esta ejecución se reintentará automáticamente.',
  ...
  'settings.agentInstall.pathHint':
    'Si instalaste una CLI con npm o Homebrew y sigue apareciendo como no instalada, asegúrate de que el directorio bin de la herramienta esté en el PATH que hereda el daemon de 爆创 (Terminal y apps GUI pueden diferir en macOS). Consulta QUICKSTART.md (sección "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abre Instalar o Docs para el agente que prefieras.',
  'settings.agentInstall.stepAuth':
    'Autentícate con la CLI del proveedor (inicia sesión o añade credenciales API) antes de volver a 爆创.',
  ...
  'settings.mcpServerHint': 'Expón 爆创 como servidor MCP para tu agente de código.',
  ...
  'entry.githubStarAria': 'Dar una estrella a 爆创 en GitHub',
  ...
  'preview.errorBody': 'No se pudo obtener el HTML del ejemplo. Asegúrate de que 爆创 esté en ejecución e inténtalo de nuevo.',
  ...
  'pet.tabBuiltInHint': 'Compañeros incluidos con 爆创 — elige uno y adóptalo.',
  ...
  'pet.codexBundledTitle': 'Viene con 爆创 — sin descarga.',
  ...
  'updater.availableBody': '爆创 {version} está disponible. Se descargará antes de abrir el instalador.',
  ...
  'updater.installerOpenBody': 'El instalador está abierto. 爆创 se está cerrando para que puedas completar la actualización.',
  ...
  'updater.quitButton': 'Salir de 爆创',
  'updater.quitFailedBody': 'El instalador está abierto, pero 爆创 no pudo cerrarse. Cierra 爆创 antes de reemplazar la app.',
  'updater.quitFailedTitle': 'No se pudo salir',
  'updater.quitting': 'Cerrando...',
  'updater.ready': 'Actualización lista',
  'updater.readyGeneric': 'Hay una nueva versión lista. 爆创 se cerrará y abrirá el instalador.',
  'updater.readyVersion': '爆创 {version} está listo. 爆创 se cerrará y abrirá el instalador.',
