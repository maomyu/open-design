...
export const esES: Dict = {
  ...
  'chat.amrCard.switchBody': 'Cambia al servicio oficial de modelos AMR de WorkBuild — sin configurar API Key. Tras iniciar sesión, autorizar y recargar, esta ejecución se reintentará automáticamente.',
  ...
  'settings.agentInstall.pathHint':
    'Si instalaste una CLI con npm o Homebrew y sigue apareciendo como no instalada, asegúrate de que el directorio bin de la herramienta esté en el PATH que hereda el daemon de WorkBuild (Terminal y apps GUI pueden diferir en macOS). Consulta QUICKSTART.md (sección "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abre Instalar o Docs para el agente que prefieras.',
  'settings.agentInstall.stepAuth':
    'Autentícate con la CLI del proveedor (inicia sesión o añade credenciales API) antes de volver a WorkBuild.',
  ...
  'settings.mcpServerHint': 'Expón WorkBuild como servidor MCP para tu agente de código.',
  ...
  'entry.githubStarAria': 'Dar una estrella a WorkBuild en GitHub',
  ...
  'preview.errorBody': 'No se pudo obtener el HTML del ejemplo. Asegúrate de que WorkBuild esté en ejecución e inténtalo de nuevo.',
  ...
  'pet.tabBuiltInHint': 'Compañeros incluidos con WorkBuild — elige uno y adóptalo.',
  ...
  'pet.codexBundledTitle': 'Viene con WorkBuild — sin descarga.',
  ...
  'updater.availableBody': 'WorkBuild {version} está disponible. Se descargará antes de abrir el instalador.',
  ...
  'updater.installerOpenBody': 'El instalador está abierto. WorkBuild se está cerrando para que puedas completar la actualización.',
  ...
  'updater.quitButton': 'Salir de WorkBuild',
  'updater.quitFailedBody': 'El instalador está abierto, pero WorkBuild no pudo cerrarse. Cierra WorkBuild antes de reemplazar la app.',
  'updater.quitFailedTitle': 'No se pudo salir',
  'updater.quitting': 'Cerrando...',
  'updater.ready': 'Actualización lista',
  'updater.readyGeneric': 'Hay una nueva versión lista. WorkBuild se cerrará y abrirá el instalador.',
  'updater.readyVersion': 'WorkBuild {version} está listo. WorkBuild se cerrará y abrirá el instalador.',
