...
export const tr: Dict = {
  ...
  'chat.amrCard.switchBody': 'social-auto\'ın resmi AMR model hizmetine geçin — API anahtarı yapılandırması gerekmez. Oturum açma, yetkilendirme ve bakiye yükleme sonrası bu çalıştırma otomatik olarak yeniden denenir.',
  ...
  'settings.agentInstall.stepAuth':
    'social-auto\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.mcpServerHint': 'social-auto\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'entry.githubStarAria': 'social-auto\u2019a GitHub üzerinde yıldız ver',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. social-auto\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'pet.tabBuiltInHint': 'social-auto ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'social-auto ile birlikte gelir — indirme gerekmez.',
  ...
  'updater.availableBody': 'social-auto {version} mevcut. Yükleyici açılmadan önce indirilecek.',
  ...
  'updater.installerOpenBody': 'Yükleyici açık. Güncellemeyi tamamlayabilmeniz için social-auto kapatılıyor.',
  ...
  'updater.quitButton': 'social-auto’dan çık',
  'updater.quitFailedBody': 'Yükleyici açık, ancak social-auto kapatılamadı. Uygulamayı değiştirmeden önce social-auto’dan çıkın.',
  'updater.quitFailedTitle': 'Çıkılamadı',
  'updater.quitting': 'Çıkılıyor...',
  'updater.ready': 'Güncelleme hazır',
  'updater.readyGeneric': 'Yeni bir sürüm hazır. social-auto kapanıp yükleyiciyi açacak.',
  'updater.readyVersion': 'social-auto {version} hazır. social-auto kapanıp yükleyiciyi açacak.',
