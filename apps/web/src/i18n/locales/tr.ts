...
export const tr: Dict = {
  ...
  'chat.amrCard.switchBody': 'WorkBuild\'ın resmi AMR model hizmetine geçin — API anahtarı yapılandırması gerekmez. Oturum açma, yetkilendirme ve bakiye yükleme sonrası bu çalıştırma otomatik olarak yeniden denenir.',
  ...
  'creator.eyebrow': "Oluştur",
  'creator.pluginTitle': "Eklenti oluştur",
  'creator.skillTitle': "Yetenek oluştur",
  'creator.pluginLede': "İş akışını kendi sözlerinizle anlatın — neyi başarması gerektiğini, kabaca adımları ve devam etmeden önce nerede onay vermek istediğinizi. Yapay zekâ eklentinin tamamını (metodoloji, başlangıç brifi, iş akışı adımları) incelemeniz için taslak olarak hazırlar; siz onaylamadan hiçbir şey kaydedilmez.",
  'creator.skillLede': "Yeteneğin ne yapması ve ne zaman kullanılması gerektiğini anlatın. Yapay zekâ eksiksiz bir SKILL.md — tetiklenmeye hazır açıklama, metodoloji ve birkaç test prompt'u — taslağını incelemeniz için hazırlar; siz onaylamadan hiçbir şey kaydedilmez.",
  'creator.pluginPlaceholder': "örn. Ebeveynlik hesabım için haftalık kısa video hattı: trend konuları seç (ben onaylarım), senaryoyu yaz (ben onaylarım), sonra videoyu üret ve bir özetle bitir.",
  'creator.skillPlaceholder': "örn. Kısa videolar için 3 saniyelik açılış hook'ları yaz. Hook, açılış veya izlenme tutma dediğimde kullan. Etki gücüne göre sıralı 5 seçenek üret.",
  'creator.targetPlugin': "Eklenti",
  'creator.targetSkill': "Yetenek",
  'creator.draftButton': "Yapay zekâ ile taslak oluştur",
  'creator.drafting': "Taslak hazırlanıyor…",
  'creator.redraft': "Yeniden taslak oluştur",
  'creator.draftFailed': "Taslak oluşturulamadı. Model ayarlarınızı kontrol edip yeniden deneyin.",
  'creator.save': "Kaydet ve yayınla",
  'creator.saving': "Kaydediliyor…",
  'creator.saveFailed': "Kaydetme başarısız.",
  'creator.skillSaved': "Yetenek kitaplığınıza kaydedildi.",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "Başlık",
  'creator.descriptionLabel': "Açıklama",
  'creator.stagesHint': "İnsan onay noktaları içeren adım adım prompt'lar. Kaydettikten sonra tam editörde ince ayar yapın.",
  'creator.triggersLabel': "Tetikleyiciler (virgülle ayrılmış)",
  'creator.bodyLabel': "SKILL.md gövdesi",
  'creator.evalsLabel': "Test prompt'ları",
  'creator.evalsHint': "evals/evals.json olarak kaydedilir — daha sonra yeteneği test edip geliştirmek için kullanılır.",
  ...
  'settings.agentInstall.pathHint':
    'Bir CLI\'yi npm veya Homebrew ile kurduysan ancak hâlâ kurulu değil olarak görünüyorsa, aracın bin dizininin WorkBuild daemon\'unun devraldığı PATH içinde olduğundan emin ol (macOS\'te Terminal ve GUI uygulamalarının PATH\'i farklı olabilir). QUICKSTART.md içindeki "Local agent CLI and PATH" bölümüne bak.',
  'settings.agentInstall.stepOpenLinks': 'Tercih ettiğin ajan için Yükle veya Dokümanlar bağlantısını aç.',
  'settings.agentInstall.stepAuth':
    'WorkBuild\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.mcpServerHint': 'WorkBuild\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'entry.githubStarAria': 'WorkBuild\u2019a GitHub üzerinde yıldız ver',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. WorkBuild\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'pet.tabBuiltInHint': 'WorkBuild ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'WorkBuild ile birlikte gelir — indirme gerekmez.',
  ...
  'updater.availableBody': 'WorkBuild {version} mevcut. Yükleyici açılmadan önce indirilecek.',
  ...
  'updater.installerOpenBody': 'Yükleyici açık. Güncellemeyi tamamlayabilmeniz için WorkBuild kapatılıyor.',
  ...
  'updater.quitButton': 'WorkBuild’dan çık',
  'updater.quitFailedBody': 'Yükleyici açık, ancak WorkBuild kapatılamadı. Uygulamayı değiştirmeden önce WorkBuild’dan çıkın.',
  'updater.quitFailedTitle': 'Çıkılamadı',
  'updater.quitting': 'Çıkılıyor...',
  'updater.ready': 'Güncelleme hazır',
  'updater.readyGeneric': 'Yeni bir sürüm hazır. WorkBuild kapanıp yükleyiciyi açacak.',
  'updater.readyVersion': 'WorkBuild {version} hazır. WorkBuild kapanıp yükleyiciyi açacak.',
