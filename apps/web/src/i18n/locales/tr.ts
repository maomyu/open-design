...
export const tr: Dict = {
  ...
  'chat.amrCard.switchBody': '爆创\'ın resmi AMR model hizmetine geçin — API anahtarı yapılandırması gerekmez. Oturum açma, yetkilendirme ve bakiye yükleme sonrası bu çalıştırma otomatik olarak yeniden denenir.',
  ...
  'settings.agentInstall.pathHint':
    'Bir CLI\'yi npm veya Homebrew ile kurduysan ancak hâlâ kurulu değil olarak görünüyorsa, aracın bin dizininin 爆创 daemon\'unun devraldığı PATH içinde olduğundan emin ol (macOS\'te Terminal ve GUI uygulamalarının PATH\'i farklı olabilir). QUICKSTART.md içindeki "Local agent CLI and PATH" bölümüne bak.',
  'settings.agentInstall.stepOpenLinks': 'Tercih ettiğin ajan için Yükle veya Dokümanlar bağlantısını aç.',
  'settings.agentInstall.stepAuth':
    '爆创\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.mcpServerHint': '爆创\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'entry.githubStarAria': '爆创\u2019a GitHub üzerinde yıldız ver',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. 爆创\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'pet.tabBuiltInHint': '爆创 ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': '爆创 ile birlikte gelir — indirme gerekmez.',
  ...
  'updater.availableBody': '爆创 {version} mevcut. Yükleyici açılmadan önce indirilecek.',
  ...
  'updater.installerOpenBody': 'Yükleyici açık. Güncellemeyi tamamlayabilmeniz için 爆创 kapatılıyor.',
  ...
  'updater.quitButton': '爆创’dan çık',
  'updater.quitFailedBody': 'Yükleyici açık, ancak 爆创 kapatılamadı. Uygulamayı değiştirmeden önce 爆创’dan çıkın.',
  'updater.quitFailedTitle': 'Çıkılamadı',
  'updater.quitting': 'Çıkılıyor...',
  'updater.ready': 'Güncelleme hazır',
  'updater.readyGeneric': 'Yeni bir sürüm hazır. 爆创 kapanıp yükleyiciyi açacak.',
  'updater.readyVersion': '爆创 {version} hazır. 爆创 kapanıp yükleyiciyi açacak.',
