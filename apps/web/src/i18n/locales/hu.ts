...
export const hu: Dict = {
  ...
  'chat.amrCard.switchBody': 'Válts az social-auto hivatalos AMR modellszolgáltatására — nincs szükség API-kulcs beállítására. Bejelentkezés, engedélyezés és feltöltés után ez a futtatás automatikusan újraindul.',
  ...
  'settings.agentInstall.stepAuth':
    'Hitelesíts a szolgáltató CLI-jében (bejelentkezés vagy API hitelesítő adatok megadása), mielőtt visszatérsz az social-autohoz.',
  ...
  'settings.mcpServerHint': 'Tedd elérhetővé az social-autot MCP-szerverként a kódügynököd számára.',
  ...
  'entry.githubStarAria': 'Csillagozd meg az social-auto projektet a GitHubon',
  ...
  'preview.errorBody': 'A példa HTML-jének letöltése meghiúsult. Győződj meg róla, hogy az social-auto fut, majd próbáld újra.',
  'preview.retry': 'Újra',
  ...
  'pet.tabBuiltInHint': 'Az social-autonal csomagolt társak — válassz egyet és fogadd örökbe.',
  ...
  'pet.codexBundledTitle': 'Az social-autogal érkezik — letöltés nem szükséges.',
  ...
  'updater.availableBody': 'Az social-auto {version} elérhető. A telepítő megnyitása előtt letöltődik.',
  ...
  'updater.installerOpenBody': 'A telepítő meg van nyitva. Az social-auto kilép, hogy befejezhesse a frissítést.',
  ...
  'updater.quitButton': 'Kilépés az social-autoból',
  'updater.quitFailedBody': 'A telepítő meg van nyitva, de az social-auto nem tudott kilépni. Az alkalmazás cseréje előtt lépjen ki az social-autoból.',
  'updater.quitFailedTitle': 'Nem sikerült kilépni',
  'updater.quitting': 'Kilépés...',
  'updater.ready': 'Frissítés kész',
  'updater.readyGeneric': 'Elkészült az új verzió. Az social-auto bezárul, és megnyitja a telepítőt.',
  'updater.readyVersion': 'Az social-auto {version} elkészült. Az social-auto bezárul, és megnyitja a telepítőt.',
