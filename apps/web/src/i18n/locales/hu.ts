...
export const hu: Dict = {
  ...
  'chat.amrCard.switchBody': 'Válts az WorkBuild hivatalos AMR modellszolgáltatására — nincs szükség API-kulcs beállítására. Bejelentkezés, engedélyezés és feltöltés után ez a futtatás automatikusan újraindul.',
  ...
  'creator.eyebrow': "Létrehozás",
  'creator.pluginTitle': "Plugin létrehozása",
  'creator.skillTitle': "Skill létrehozása",
  'creator.pluginLede': "Írd le a munkafolyamatot a saját szavaiddal — mit kell elérnie, nagyjából milyen lépésekből áll, és hol szeretnél megerősíteni, mielőtt továbbmegy. Az AI elkészíti a teljes plugin vázlatát (módszertan, kezdő brief, workflow-lépések) átnézésre; semmi sem mentődik, amíg jóvá nem hagyod.",
  'creator.skillLede': "Írd le, mit csináljon a skill és mikor kell használni. Az AI elkészít egy teljes SKILL.md-t — triggerre kész leírás, módszertan és néhány teszt prompt — átnézésre; semmi sem mentődik, amíg jóvá nem hagyod.",
  'creator.pluginPlaceholder': "pl. Heti rövidvideó-futószalag a szülős fiókomhoz: felkapott témák kiválasztása (jóváhagyom), forgatókönyv megírása (jóváhagyom), majd a videó legenerálása és összegzés.",
  'creator.skillPlaceholder': "pl. 3 másodperces nyitóhookok írása rövid videókhoz. Használd, amikor hookokról, nyitásról vagy megtartásról beszélek. Adj 5 lehetőséget ütőerő szerint rendezve.",
  'creator.targetPlugin': "Plugin",
  'creator.targetSkill': "Skill",
  'creator.draftButton': "Vázlat AI-jal",
  'creator.drafting': "Vázlat készül…",
  'creator.redraft': "Új vázlat",
  'creator.draftFailed': "A vázlat készítése nem sikerült. Ellenőrizd a modellbeállításokat, és próbáld újra.",
  'creator.save': "Mentés és közzététel",
  'creator.saving': "Mentés…",
  'creator.saveFailed': "A mentés nem sikerült.",
  'creator.skillSaved': "A skill a könyvtáradba mentve.",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "Cím",
  'creator.descriptionLabel': "Leírás",
  'creator.stagesHint': "Lépésenkénti promptok emberi jóváhagyási pontokkal. Mentés után a teljes szerkesztőben finomhangolhatod őket.",
  'creator.triggersLabel': "Triggerek (vesszővel elválasztva)",
  'creator.bodyLabel': "SKILL.md törzs",
  'creator.evalsLabel': "Teszt promptok",
  'creator.evalsHint': "evals/evals.json néven mentődik — később a skill tesztelésére és fejlesztésére szolgál.",
  ...
  'settings.agentInstall.pathHint':
    'Ha npm-mel vagy Homebrew-val telepítettél egy CLI-t, de továbbra is nincs telepítve állapotban látszik, ellenőrizd, hogy az eszköz bin könyvtára benne van-e abban a PATH-ban, amit az WorkBuild daemon örököl (macOS-en a Terminal és a GUI appok PATH-ja eltérhet). Lásd a QUICKSTART.md "Local agent CLI and PATH" szakaszát.',
  'settings.agentInstall.stepOpenLinks': 'Nyisd meg a Telepítés vagy Dokumentáció hivatkozást a kívánt ügynöknél.',
  'settings.agentInstall.stepAuth':
    'Hitelesíts a szolgáltató CLI-jében (bejelentkezés vagy API hitelesítő adatok megadása), mielőtt visszatérsz az WorkBuildhoz.',
  ...
  'settings.mcpServerHint': 'Tedd elérhetővé az WorkBuildt MCP-szerverként a kódügynököd számára.',
  ...
  'entry.githubStarAria': 'Csillagozd meg az WorkBuild projektet a GitHubon',
  ...
  'preview.errorBody': 'A példa HTML-jének letöltése meghiúsult. Győződj meg róla, hogy az WorkBuild fut, majd próbáld újra.',
  'preview.retry': 'Újra',
  ...
  'pet.tabBuiltInHint': 'Az WorkBuildnal csomagolt társak — válassz egyet és fogadd örökbe.',
  ...
  'pet.codexBundledTitle': 'Az WorkBuildgal érkezik — letöltés nem szükséges.',
  ...
  'updater.availableBody': 'Az WorkBuild {version} elérhető. A telepítő megnyitása előtt letöltődik.',
  ...
  'updater.installerOpenBody': 'A telepítő meg van nyitva. Az WorkBuild kilép, hogy befejezhesse a frissítést.',
  ...
  'updater.quitButton': 'Kilépés az WorkBuildból',
  'updater.quitFailedBody': 'A telepítő meg van nyitva, de az WorkBuild nem tudott kilépni. Az alkalmazás cseréje előtt lépjen ki az WorkBuildból.',
  'updater.quitFailedTitle': 'Nem sikerült kilépni',
  'updater.quitting': 'Kilépés...',
  'updater.ready': 'Frissítés kész',
  'updater.readyGeneric': 'Elkészült az új verzió. Az WorkBuild bezárul, és megnyitja a telepítőt.',
  'updater.readyVersion': 'Az WorkBuild {version} elkészült. Az WorkBuild bezárul, és megnyitja a telepítőt.',
