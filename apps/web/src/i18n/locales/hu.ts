...
export const hu: Dict = {
  ...
  'chat.amrCard.switchBody': 'Válts az 爆创 hivatalos AMR modellszolgáltatására — nincs szükség API-kulcs beállítására. Bejelentkezés, engedélyezés és feltöltés után ez a futtatás automatikusan újraindul.',
  ...
  'settings.agentInstall.pathHint':
    'Ha npm-mel vagy Homebrew-val telepítettél egy CLI-t, de továbbra is nincs telepítve állapotban látszik, ellenőrizd, hogy az eszköz bin könyvtára benne van-e abban a PATH-ban, amit az 爆创 daemon örököl (macOS-en a Terminal és a GUI appok PATH-ja eltérhet). Lásd a QUICKSTART.md "Local agent CLI and PATH" szakaszát.',
  'settings.agentInstall.stepOpenLinks': 'Nyisd meg a Telepítés vagy Dokumentáció hivatkozást a kívánt ügynöknél.',
  'settings.agentInstall.stepAuth':
    'Hitelesíts a szolgáltató CLI-jében (bejelentkezés vagy API hitelesítő adatok megadása), mielőtt visszatérsz az 爆创hoz.',
  ...
  'settings.mcpServerHint': 'Tedd elérhetővé az 爆创t MCP-szerverként a kódügynököd számára.',
  ...
  'entry.githubStarAria': 'Csillagozd meg az 爆创 projektet a GitHubon',
  ...
  'preview.errorBody': 'A példa HTML-jének letöltése meghiúsult. Győződj meg róla, hogy az 爆创 fut, majd próbáld újra.',
  'preview.retry': 'Újra',
  ...
  'pet.tabBuiltInHint': 'Az 爆创nal csomagolt társak — válassz egyet és fogadd örökbe.',
  ...
  'pet.codexBundledTitle': 'Az 爆创gal érkezik — letöltés nem szükséges.',
  ...
  'updater.availableBody': 'Az 爆创 {version} elérhető. A telepítő megnyitása előtt letöltődik.',
  ...
  'updater.installerOpenBody': 'A telepítő meg van nyitva. Az 爆创 kilép, hogy befejezhesse a frissítést.',
  ...
  'updater.quitButton': 'Kilépés az 爆创ból',
  'updater.quitFailedBody': 'A telepítő meg van nyitva, de az 爆创 nem tudott kilépni. Az alkalmazás cseréje előtt lépjen ki az 爆创ból.',
  'updater.quitFailedTitle': 'Nem sikerült kilépni',
  'updater.quitting': 'Kilépés...',
  'updater.ready': 'Frissítés kész',
  'updater.readyGeneric': 'Elkészült az új verzió. Az 爆创 bezárul, és megnyitja a telepítőt.',
  'updater.readyVersion': 'Az 爆创 {version} elkészült. Az 爆创 bezárul, és megnyitja a telepítőt.',
