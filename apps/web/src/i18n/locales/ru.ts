...
export const ru: Dict = {
  ...
  'chat.amrCard.switchBody': 'Переключитесь на официальный сервис моделей AMR от social-auto — без настройки API-ключа. После входа, авторизации и пополнения это выполнение будет автоматически повторено.',
  ...
  'settings.agentInstall.stepAuth':
    'Пройдите аутентификацию в CLI поставщика (вход или добавление API-ключей), затем вернитесь в social-auto.',
  ...
  'settings.mcpServerHint': 'Откройте social-auto как MCP-сервер для вашего кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставить social-auto звезду на GitHub',
  ...
  'preview.errorBody': 'Не удалось получить HTML примера. Убедитесь, что social-auto запущен, и повторите попытку.',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте social-auto — выберите и забирайте.',
  ...
  'pet.codexBundledTitle': 'Поставляется с social-auto — загрузка не нужна.',
  ...
  'updater.availableBody': 'social-auto {version} доступен. Он будет загружен перед открытием установщика.',
  ...
  'updater.installerOpenBody': 'Установщик открыт. social-auto закрывается, чтобы вы могли завершить обновление.',
  ...
  'updater.quitButton': 'Закрыть social-auto',
  'updater.quitFailedBody': 'Установщик открыт, но social-auto не удалось закрыть. Закройте social-auto перед заменой приложения.',
  'updater.quitFailedTitle': 'Не удалось закрыть',
  'updater.quitting': 'Закрытие...',
  'updater.ready': 'Обновление готово',
  'updater.readyGeneric': 'Новая версия готова. social-auto закроется и откроет установщик.',
  'updater.readyVersion': 'social-auto {version} готов. social-auto закроется и откроет установщик.',
