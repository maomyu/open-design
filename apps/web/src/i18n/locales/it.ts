...
export const it: Dict = {
  ...
  'chat.amrCard.switchBody': 'Passa al servizio modelli AMR ufficiale di 爆创 — nessuna chiave API da configurare. Dopo accesso, autorizzazione e ricarica, questa esecuzione verrà ritentata automaticamente.',
  ...
  'settings.agentInstall.pathHint':
    'Se hai installato una CLI con npm o Homebrew e appare ancora come non installata, verifica che la cartella bin dello strumento sia nel PATH ereditato dal daemon 爆创 (Terminale e app GUI possono differire su macOS). Vedi QUICKSTART.md (sezione "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Apri Installa o Documentazione per l\'agente desiderato.',
  'settings.agentInstall.stepAuth':
    'Autenticati con la CLI del provider (login o aggiunta delle credenziali API) prima di tornare in 爆创.',
  ...
  'settings.mcpServerHint': 'Esponi 爆创 come server MCP per il tuo agente di codice.',
  ...
  'settings.privacyHint': 'Quali dati vengono condivisi con il team di 爆创',
  'settings.privacyConsentKicker': 'Aiutaci a migliorare 爆创',
  'settings.privacyConsentLead': '爆创 può condividere dati di utilizzo con il nostro team per aiutarci a migliorare. Questo include:',
  ...
  'preview.errorBody': 'Il caricamento dell\'HTML dell\'esempio è fallito. Verifica che 爆创 sia in esecuzione e riprova.',
  ...
  'pet.tabBuiltInHint': 'Compagni forniti con 爆创 — scegline uno e adottalo.',
  ...
  'pet.codexBundledTitle': 'Fornito con 爆创 — nessun download necessario.',
  ...
  'settings.memoryStarterProjectDesc': '爆创 v0.5 — editor di design guidato da chat',
  ...
  'updater.availableBody': '爆创 {version} è disponibile. Verrà scaricato prima di aprire il programma di installazione.',
  ...
  'updater.installerOpenBody': 'Il programma di installazione è aperto. 爆创 si sta chiudendo per consentirti di completare l’aggiornamento.',
  ...
  'updater.quitButton': 'Esci da 爆创',
  'updater.quitFailedBody': 'Il programma di installazione è aperto, ma 爆创 non è riuscito a uscire. Esci da 爆创 prima di sostituire l’app.',
  'updater.quitFailedTitle': 'Impossibile uscire',
  'updater.quitting': 'Uscita...',
  'updater.ready': 'Aggiornamento pronto',
  'updater.readyGeneric': 'È pronta una nuova versione. 爆创 si chiuderà e aprirà il programma di installazione.',
  'updater.readyVersion': '爆创 {version} è pronto. 爆创 si chiuderà e aprirà il programma di installazione.',
