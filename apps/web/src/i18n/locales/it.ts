...
export const it: Dict = {
  ...
  'chat.amrCard.switchBody': 'Passa al servizio modelli AMR ufficiale di WorkBuild — nessuna chiave API da configurare. Dopo accesso, autorizzazione e ricarica, questa esecuzione verrà ritentata automaticamente.',
  ...
  'settings.agentInstall.pathHint':
    'Se hai installato una CLI con npm o Homebrew e appare ancora come non installata, verifica che la cartella bin dello strumento sia nel PATH ereditato dal daemon WorkBuild (Terminale e app GUI possono differire su macOS). Vedi QUICKSTART.md (sezione "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Apri Installa o Documentazione per l\'agente desiderato.',
  'settings.agentInstall.stepAuth':
    'Autenticati con la CLI del provider (login o aggiunta delle credenziali API) prima di tornare in WorkBuild.',
  ...
  'settings.mcpServerHint': 'Esponi WorkBuild come server MCP per il tuo agente di codice.',
  ...
  'settings.privacyHint': 'Quali dati vengono condivisi con il team di WorkBuild',
  'settings.privacyConsentKicker': 'Aiutaci a migliorare WorkBuild',
  'settings.privacyConsentLead': 'WorkBuild può condividere dati di utilizzo con il nostro team per aiutarci a migliorare. Questo include:',
  ...
  'preview.errorBody': 'Il caricamento dell\'HTML dell\'esempio è fallito. Verifica che WorkBuild sia in esecuzione e riprova.',
  ...
  'pet.tabBuiltInHint': 'Compagni forniti con WorkBuild — scegline uno e adottalo.',
  ...
  'pet.codexBundledTitle': 'Fornito con WorkBuild — nessun download necessario.',
  ...
  'settings.memoryStarterProjectDesc': 'WorkBuild v0.5 — editor di design guidato da chat',
  ...
  'updater.availableBody': 'WorkBuild {version} è disponibile. Verrà scaricato prima di aprire il programma di installazione.',
  ...
  'updater.installerOpenBody': 'Il programma di installazione è aperto. WorkBuild si sta chiudendo per consentirti di completare l’aggiornamento.',
  ...
  'updater.quitButton': 'Esci da WorkBuild',
  'updater.quitFailedBody': 'Il programma di installazione è aperto, ma WorkBuild non è riuscito a uscire. Esci da WorkBuild prima di sostituire l’app.',
  'updater.quitFailedTitle': 'Impossibile uscire',
  'updater.quitting': 'Uscita...',
  'updater.ready': 'Aggiornamento pronto',
  'updater.readyGeneric': 'È pronta una nuova versione. WorkBuild si chiuderà e aprirà il programma di installazione.',
  'updater.readyVersion': 'WorkBuild {version} è pronto. WorkBuild si chiuderà e aprirà il programma di installazione.',
