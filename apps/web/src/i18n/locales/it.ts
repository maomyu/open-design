...
export const it: Dict = {
  ...
  'chat.amrCard.switchBody': 'Passa al servizio modelli AMR ufficiale di social-auto — nessuna chiave API da configurare. Dopo accesso, autorizzazione e ricarica, questa esecuzione verrà ritentata automaticamente.',
  ...
  'settings.agentInstall.pathHint':
    'Se hai installato una CLI con npm o Homebrew e appare ancora come non installata, verifica che la cartella bin dello strumento sia nel PATH ereditato dal daemon social-auto (Terminale e app GUI possono differire su macOS). Vedi QUICKSTART.md (sezione "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Apri Installa o Documentazione per l\'agente desiderato.',
  'settings.agentInstall.stepAuth':
    'Autenticati con la CLI del provider (login o aggiunta delle credenziali API) prima di tornare in social-auto.',
  ...
  'settings.mcpServerHint': 'Esponi social-auto come server MCP per il tuo agente di codice.',
  ...
  'settings.privacyHint': 'Quali dati vengono condivisi con il team di social-auto',
  'settings.privacyConsentKicker': 'Aiutaci a migliorare social-auto',
  'settings.privacyConsentLead': 'social-auto può condividere dati di utilizzo con il nostro team per aiutarci a migliorare. Questo include:',
  ...
  'preview.errorBody': 'Il caricamento dell\'HTML dell\'esempio è fallito. Verifica che social-auto sia in esecuzione e riprova.',
  ...
  'pet.tabBuiltInHint': 'Compagni forniti con social-auto — scegline uno e adottalo.',
  ...
  'pet.codexBundledTitle': 'Fornito con social-auto — nessun download necessario.',
  ...
  'settings.memoryStarterProjectDesc': 'social-auto v0.5 — editor di design guidato da chat',
  ...
  'updater.availableBody': 'social-auto {version} è disponibile. Verrà scaricato prima di aprire il programma di installazione.',
  ...
  'updater.installerOpenBody': 'Il programma di installazione è aperto. social-auto si sta chiudendo per consentirti di completare l’aggiornamento.',
  ...
  'updater.quitButton': 'Esci da social-auto',
  'updater.quitFailedBody': 'Il programma di installazione è aperto, ma social-auto non è riuscito a uscire. Esci da social-auto prima di sostituire l’app.',
  'updater.quitFailedTitle': 'Impossibile uscire',
  'updater.quitting': 'Uscita...',
  'updater.ready': 'Aggiornamento pronto',
  'updater.readyGeneric': 'È pronta una nuova versione. social-auto si chiuderà e aprirà il programma di installazione.',
  'updater.readyVersion': 'social-auto {version} è pronto. social-auto si chiuderà e aprirà il programma di installazione.',
