...
export const th: Dict = {
  ...
  'chat.amrCard.switchBody': 'สลับไปยังบริการโมเดล AMR อย่างเป็นทางการของ WorkBuild — ไม่ต้องตั้งค่า API Key หลังจากเข้าสู่ระบบ ให้สิทธิ์ และเติมเงินแล้ว งานนี้จะถูกลองใหม่โดยอัตโนมัติ',
  ...
  'creator.eyebrow': "สร้าง",
  'creator.pluginTitle': "สร้างปลั๊กอิน",
  'creator.skillTitle': "สร้างทักษะ",
  'creator.pluginLede': "อธิบายขั้นตอนงานด้วยคำพูดของคุณเอง — ต้องการให้ทำอะไร มีขั้นตอนคร่าว ๆ อย่างไร และจุดไหนที่ต้องการยืนยันก่อนดำเนินการต่อ AI จะร่างปลั๊กอินฉบับเต็ม (วิธีการ บรีฟเริ่มต้น ขั้นตอนเวิร์กโฟลว์) ให้คุณตรวจสอบ จะไม่บันทึกจนกว่าคุณจะยืนยัน",
  'creator.skillLede': "อธิบายว่าทักษะนี้ควรทำอะไรและใช้เมื่อไหร่ AI จะร่าง SKILL.md ฉบับสมบูรณ์ — คำอธิบายพร้อมทริกเกอร์ วิธีการ และ prompt ทดสอบจำนวนหนึ่ง — ให้คุณตรวจสอบ จะไม่บันทึกจนกว่าคุณจะยืนยัน",
  'creator.pluginPlaceholder': "เช่น ไปป์ไลน์วิดีโอสั้นรายสัปดาห์สำหรับบัญชีเลี้ยงลูกของฉัน: เลือกหัวข้อที่กำลังมาแรง (ฉันยืนยัน) เขียนสคริปต์ (ฉันยืนยัน) จากนั้นสร้างวิดีโอและปิดท้ายด้วยสรุป",
  'creator.skillPlaceholder': "เช่น เขียนฮุกเปิด 3 วินาทีสำหรับวิดีโอสั้น ใช้ทุกครั้งที่ฉันพูดถึงฮุก การเปิดเรื่อง หรือการรักษาผู้ชม ให้ตัวเลือก 5 แบบเรียงตามความแรง",
  'creator.targetPlugin': "ปลั๊กอิน",
  'creator.targetSkill': "ทักษะ",
  'creator.draftButton': "ร่างด้วย AI",
  'creator.drafting': "กำลังร่าง…",
  'creator.redraft': "ร่างใหม่",
  'creator.draftFailed': "ร่างไม่สำเร็จ โปรดตรวจสอบการตั้งค่าโมเดลแล้วลองอีกครั้ง",
  'creator.save': "บันทึกและเผยแพร่",
  'creator.saving': "กำลังบันทึก…",
  'creator.saveFailed': "บันทึกไม่สำเร็จ",
  'creator.skillSaved': "บันทึกทักษะลงในคลังของคุณแล้ว",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "ชื่อ",
  'creator.descriptionLabel': "คำอธิบาย",
  'creator.stagesHint': "prompt แบบทีละขั้นพร้อมจุดยืนยันโดยคน ปรับละเอียดได้ในตัวแก้ไขเต็มรูปแบบหลังบันทึก",
  'creator.triggersLabel': "ทริกเกอร์ (คั่นด้วยจุลภาค)",
  'creator.bodyLabel': "เนื้อหา SKILL.md",
  'creator.evalsLabel': "prompt ทดสอบ",
  'creator.evalsHint': "บันทึกเป็น evals/evals.json — ใช้ทดสอบและปรับปรุงทักษะนี้ในภายหลัง",
  ...
  'settings.agentInstall.pathHint':
    'หากคุณติดตั้ง CLI ด้วย npm หรือ Homebrew แล้วแต่ยังแสดงว่าไม่ได้ติดตั้ง โปรดตรวจสอบว่าโฟลเดอร์ bin ของเครื่องมือนั้นอยู่ใน PATH ที่ WorkBuild daemon ใช้งาน (บน macOS ค่า PATH ของ Terminal และแอป GUI อาจต่างกัน) ดู QUICKSTART.md (ส่วน "Local agent CLI and PATH")',
  'settings.agentInstall.stepOpenLinks': 'เปิดลิงก์ติดตั้งหรือเอกสารสำหรับเอเจนต์ที่ต้องการ',
  'settings.agentInstall.stepAuth':
    'ยืนยันตัวตนกับ CLI ของผู้ให้บริการ (ลงชื่อเข้าใช้หรือเพิ่มข้อมูลรับรอง API) ก่อนกลับไปที่ WorkBuild',
  ...
  'settings.mcpServerHint': 'เปิดให้ WorkBuild เป็นเซิร์ฟเวอร์ MCP สำหรับเอเจนต์โค้ด',
  ...
  'settings.privacyHint': 'ข้อมูลที่แชร์กับทีม WorkBuild',
  'settings.privacyConsentKicker': 'ช่วยเราพัฒนา WorkBuild',
  'settings.privacyConsentLead': 'WorkBuild สามารถแชร์ข้อมูลการใช้งานกับทีมของเราเพื่อช่วยพัฒนา ซึ่งรวมถึง:',
  ...
  'pet.tabBuiltInHint': 'จัดกลุ่มให้พร้อมใช้กับชุดระบบจาก WorkBuild แล้ว — เอาได้เลย',
  ...
  'pet.codexBundledTitle': 'เตรียมมาให้กับ WorkBuild แล้ว — ไม่ต้องดาวน์โหลดใหม่',
  ...
  'updater.availableBody': 'WorkBuild {version} พร้อมใช้งานแล้ว จะดาวน์โหลดก่อนเปิดตัวติดตั้ง',
  ...
  'updater.installerOpenBody': 'ตัวติดตั้งเปิดอยู่ WorkBuild กำลังออกเพื่อให้คุณอัปเดตให้เสร็จ',
  ...
  'updater.quitButton': 'ออกจาก WorkBuild',
  'updater.quitFailedBody': 'ตัวติดตั้งเปิดอยู่ แต่ไม่สามารถออกจาก WorkBuild ได้ โปรดออกจาก WorkBuild ก่อนแทนที่แอป',
  'updater.quitFailedTitle': 'ออกไม่ได้',
  'updater.quitting': 'กำลังออก...',
  'updater.ready': 'อัปเดตพร้อมแล้ว',
  'updater.readyGeneric': 'เวอร์ชันใหม่พร้อมแล้ว WorkBuild จะปิดและเปิดตัวติดตั้ง',
  'updater.readyVersion': 'WorkBuild {version} พร้อมแล้ว WorkBuild จะปิดและเปิดตัวติดตั้ง',
