...
export const ja: Dict = {
  ...
  'chat.amrCard.switchBody': 'WorkBuild 公式の AMR モデルサービスに切り替えてください — API キーの設定は不要です。サインイン・認可・チャージが完了すると、このタスクは自動で再試行されます。',
  ...
  'creator.eyebrow': "作成",
  'creator.pluginTitle': "プラグインを作成",
  'creator.skillTitle': "スキルを作成",
  'creator.pluginLede': "業務フローを自分の言葉で説明してください — 何を達成したいか、おおまかなステップ、続行前に確認したいポイント。AI がプラグイン全体（方法論、キックオフ指示、ワークフローステップ）を下書きしてレビューに出します。承認するまで保存されません。",
  'creator.skillLede': "スキルが何をするか、いつ使うかを説明してください。AI が完全な SKILL.md — トリガー可能な説明、方法論、いくつかのテスト用 prompt — を下書きしてレビューに出します。承認するまで保存されません。",
  'creator.pluginPlaceholder': "例：育児アカウント向けの週次ショート動画パイプライン。トレンドのトピックを選び（私が確認）、台本を書き（私が確認）、動画を生成して振り返りで締める。",
  'creator.skillPlaceholder': "例：ショート動画の冒頭 3 秒フックを書く。フック・冒頭・離脱防止に言及したら使う。インパクト順に 5 案を出す。",
  'creator.targetPlugin': "プラグイン",
  'creator.targetSkill': "スキル",
  'creator.draftButton': "AI で下書き",
  'creator.drafting': "下書き中…",
  'creator.redraft': "下書きをやり直す",
  'creator.draftFailed': "下書きに失敗しました。モデル設定を確認して再試行してください。",
  'creator.save': "保存して公開",
  'creator.saving': "保存中…",
  'creator.saveFailed': "保存に失敗しました。",
  'creator.skillSaved': "スキルをライブラリに保存しました。",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "タイトル",
  'creator.descriptionLabel': "説明",
  'creator.stagesHint': "人の確認を挟むステップごとの prompt。保存後にフルエディタで微調整できます。",
  'creator.triggersLabel': "トリガー（カンマ区切り）",
  'creator.bodyLabel': "SKILL.md 本文",
  'creator.evalsLabel': "テスト用 prompt",
  'creator.evalsHint': "evals/evals.json として保存され、後でスキルのテストと改善に使われます。",
  ...
  'settings.agentInstall.pathHint':
    'npm または Homebrew で CLI をインストールしたのに未インストールのまま表示される場合は、WorkBuild daemon が引き継ぐ PATH にツールの bin ディレクトリが含まれていることを確認してください（macOS では Terminal と GUI アプリで PATH が異なる場合があります）。QUICKSTART.md（"Local agent CLI and PATH" セクション）を参照してください。',
  'settings.agentInstall.stepOpenLinks': '利用したいエージェントの「インストール」または「ドキュメント」を開きます。',
  'settings.agentInstall.stepAuth':
    'WorkBuild に戻る前に、ベンダー CLI で認証（サインインまたは API 資格情報の追加）を行います。',
  ...
  'settings.mcpServerHint': 'WorkBuild を MCP サーバーとしてコーディングエージェントに公開します。',
  ...
  'entry.githubStarAria': 'GitHub で WorkBuild にスターを付ける',
  ...
  'preview.errorBody': '例の HTML を取得できませんでした。WorkBuild が起動していることを確認して再試行してください。',
  'preview.retry': '再試行',
  ...
  'pet.title': 'ペット',
  'pet.tabBuiltIn': '組み込み',
  'pet.tabBuiltInHint': 'WorkBuild に同梱された厳選コンパニオン — 選んで迎え入れよう。',
  ...
  'pet.codexBundled': '同梱',
  'pet.codexBundledTitle': 'WorkBuild に同梱 — ダウンロード不要。',
  ...
  'updater.availableBody': 'WorkBuild {version} を利用できます。インストーラーを開く前にダウンロードします。',
  ...
  'updater.installerOpenBody': 'インストーラーが開いています。更新を完了できるよう WorkBuild を終了しています。',
  ...
  'updater.quitButton': 'WorkBuild を終了',
  'updater.quitFailedBody': 'インストーラーは開いていますが、WorkBuild を終了できませんでした。アプリを置き換える前に WorkBuild を終了してください。',
  'updater.quitFailedTitle': '終了できませんでした',
  'updater.quitting': '終了しています...',
  'updater.ready': 'アップデート準備完了',
  'updater.readyGeneric': '新しいバージョンの準備ができました。WorkBuild を閉じてインストーラーを開きます。',
  'updater.readyVersion': 'WorkBuild {version} の準備ができました。WorkBuild を閉じてインストーラーを開きます。',
