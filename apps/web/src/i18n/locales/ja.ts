...
export const ja: Dict = {
  ...
  'chat.amrCard.switchBody': 'social-auto 公式の AMR モデルサービスに切り替えてください — API キーの設定は不要です。サインイン・認可・チャージが完了すると、このタスクは自動で再試行されます。',
  ...
  'settings.agentInstall.stepAuth':
    'social-auto に戻る前に、ベンダー CLI で認証（サインインまたは API 資格情報の追加）を行います。',
  ...
  'settings.mcpServerHint': 'social-auto を MCP サーバーとしてコーディングエージェントに公開します。',
  ...
  'entry.githubStarAria': 'GitHub で social-auto にスターを付ける',
  ...
  'preview.errorBody': '例の HTML を取得できませんでした。social-auto が起動していることを確認して再試行してください。',
  'preview.retry': '再試行',
  ...
  'pet.title': 'ペット',
  'pet.tabBuiltIn': '組み込み',
  'pet.tabBuiltInHint': 'social-auto に同梱された厳選コンパニオン — 選んで迎え入れよう。',
  ...
  'pet.codexBundled': '同梱',
  'pet.codexBundledTitle': 'social-auto に同梱 — ダウンロード不要。',
  ...
  'updater.availableBody': 'social-auto {version} を利用できます。インストーラーを開く前にダウンロードします。',
  ...
  'updater.installerOpenBody': 'インストーラーが開いています。更新を完了できるよう social-auto を終了しています。',
  ...
  'updater.quitButton': 'social-auto を終了',
  'updater.quitFailedBody': 'インストーラーは開いていますが、social-auto を終了できませんでした。アプリを置き換える前に social-auto を終了してください。',
  'updater.quitFailedTitle': '終了できませんでした',
  'updater.quitting': '終了しています...',
  'updater.ready': 'アップデート準備完了',
  'updater.readyGeneric': '新しいバージョンの準備ができました。social-auto を閉じてインストーラーを開きます。',
  'updater.readyVersion': 'social-auto {version} の準備ができました。social-auto を閉じてインストーラーを開きます。',
