...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': "Switch to 爆创's official AMR model service — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.",
  ...
  'settings.onboardingCreateBody':
    'Describe the site, app, deck, image, or video you want. 爆创 will create a project and keep the work editable.',
  ...
  'settings.agentInstall.pathHint':
    'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the 爆创 daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth':
    'Authenticate with the vendor CLI (sign in or add API credentials) before returning to 爆创.',
  ...
  'settings.mcpServerHint': 'Expose 爆创 as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the 爆创 team',
  'settings.privacyConsentKicker': 'Help us improve 爆创',
  'settings.privacyConsentLead': '爆创 can share usage data with our team to help us improve. This includes:',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your 爆创 projects directly.',
  'settings.mcpDaemonError':
    "Couldn't reach the local daemon to resolve install paths ({error}). Make sure 爆创 is running, then reopen this panel.",
  ...
  'settings.mcpCapabilityDefault':
    'Default to the project and file you have open in 爆创, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote':
    '爆创 must be running for MCP tool calls to succeed. If you started your coding agent before opening 爆创, restart the agent so it can reach the live daemon.',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable 爆创 plugin and add it to My plugins.',
  ...
  'designSystemPicker.noPreview': 'No preview page. 爆创 Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use 爆创 workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with 爆创 and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to 爆创',
  'pluginCard.contributeTitle': 'Contribute plugin to 爆创 with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use 爆创 from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure 爆创 is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use 爆创 everywhere',
  'useEverywhere.modalTitle': 'Use 爆创 everywhere',
  'useEverywhere.modalSubtitle': 'Drop 爆创 into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': '爆创 works wherever your agent works',
  'useEverywhere.section.overview.intro': '爆创 is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires 爆创 as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without 爆创 at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive 爆创 from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose 爆创 as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': '爆创 ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover 爆创 tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the 爆创 app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without 爆创 running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). 爆创 extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside 爆创 and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + 爆创 extras)',
  ...
  'entry.githubStarAria': 'Star 爆创 on GitHub',
  ...
  'preview.shareTextDefault': '爆创 template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure 爆创 is running and try again.',
  'preview.retry': 'Retry',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with 爆创 — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with 爆创 — no download needed.',
  ...
  'settings.memoryStarterProjectDesc': '爆创 v0.5 — chat-driven design editor',
  ...
  'updater.availableBody': '爆创 {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. 爆创 is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit 爆创',
  'updater.quitFailedBody': 'The installer is open, but 爆创 could not quit. Quit 爆创 before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. 爆创 will close and open the installer.',
  'updater.readyVersion': '爆创 {version} is ready. 爆创 will close and open the installer.',
