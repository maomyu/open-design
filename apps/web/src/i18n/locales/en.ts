...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': "Switch to WorkBuild's official AMR model service — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.",
  ...
  'settings.onboardingCreateBody':
    'Describe the site, app, deck, image, or video you want. WorkBuild will create a project and keep the work editable.',
  ...
  'settings.agentInstall.pathHint':
    'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the WorkBuild daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth':
    'Authenticate with the vendor CLI (sign in or add API credentials) before returning to WorkBuild.',
  ...
  'settings.amrCloud': 'WorkBuild AMR',
  ...
  'settings.mcpServerHint': 'Expose WorkBuild as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the WorkBuild team',
  'settings.privacyConsentKicker': 'Help us improve WorkBuild',
  'settings.privacyConsentLead': 'WorkBuild can share usage data with our team to help us improve. This includes:',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your WorkBuild projects directly.',
  'settings.mcpDaemonError':
    "Couldn't reach the local daemon to resolve install paths ({error}). Make sure WorkBuild is running, then reopen this panel.",
  ...
  'settings.mcpCapabilityDefault':
    'Default to the project and file you have open in WorkBuild, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote':
    'WorkBuild must be running for MCP tool calls to succeed. If you started your coding agent before opening WorkBuild, restart the agent so it can reach the live daemon.',
  ...
  'entry.navMedia': 'Self-media',
  'entry.navAccounts': 'Accounts',
  'mediaHub.title': 'Self-media',
  'mediaHub.lede': 'One entry per platform — pick an account, prepare content, publish. Accounts are managed centrally.',
  'mediaHub.manageAccounts': 'Manage accounts',
  'mediaHub.publishSuffix': ' publishing',
  'mediaHub.start': 'Start',
  'mediaHub.matrixTitle': 'Matrix (one content → all platforms)',
  'mediaHub.matrixFallback': 'Short-video workflow',
  'mediaHub.entryMissing': 'Entry plugin not registered — restart the daemon to load bundled plugins.',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable WorkBuild plugin and add it to My plugins.',
  ...
  'designSystemPicker.noPreview': 'No preview page. WorkBuild Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use WorkBuild workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with WorkBuild and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to WorkBuild',
  'pluginCard.contributeTitle': 'Contribute plugin to WorkBuild with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use WorkBuild from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure WorkBuild is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use WorkBuild everywhere',
  'useEverywhere.modalTitle': 'Use WorkBuild everywhere',
  'useEverywhere.modalSubtitle': 'Drop WorkBuild into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without WorkBuild at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive WorkBuild from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose WorkBuild as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'WorkBuild ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover WorkBuild tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the WorkBuild app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without WorkBuild running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). WorkBuild extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside WorkBuild and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + WorkBuild extras)',
  ...
  'entry.githubStarAria': 'Star WorkBuild on GitHub',
  ...
  'preview.shareTextDefault': 'WorkBuild template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure WorkBuild is running and try again.',
  'preview.retry': 'Retry',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with WorkBuild — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with WorkBuild — no download needed.',
  ...
  'settings.memoryStarterProjectDesc': 'WorkBuild v0.5 — chat-driven design editor',
  ...
  'updater.availableBody': 'WorkBuild {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. WorkBuild is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit WorkBuild',
  'updater.quitFailedBody': 'The installer is open, but WorkBuild could not quit. Quit WorkBuild before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. WorkBuild will close and open the installer.',
  'updater.readyVersion': 'WorkBuild {version} is ready. WorkBuild will close and open the installer.',
