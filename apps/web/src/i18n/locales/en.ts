...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': "Switch to social-auto's official AMR model service — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.",
  ...
  'common.save': 'Save',
  'common.close': 'Close',
  'pluginEditor.title': "Edit prompts",
  'pluginEditor.openButton': "Edit prompts",
  'pluginEditor.aiTitle': "AI helps you edit",
  'pluginEditor.aiPlaceholder': "Say what to change in one line, e.g. give 3 topics but punchier / add another copy version",
  'pluginEditor.aiButton': "Let AI edit",
  'pluginEditor.aiWorking': "Editing…",
  'pluginEditor.aiDone': "AI edited it — review below; save & publish when happy",
  'pluginEditor.aiUndo': "Undo",
  'pluginEditor.aiFailed': "AI edit failed",
  'pluginEditor.queryLabel': "Kickoff brief",
  'pluginEditor.queryHint': "Seeded into the composer when the plugin is used. {{...}} are input placeholders.",
  'pluginEditor.skillLabel': "Behavior & method (SKILL.md)",
  'pluginEditor.skillHint': "The agent's per-step methodology — edit this to change how it works.",
  'pluginEditor.publish': "Save & publish",
  'pluginEditor.publishing': "Publishing…",
  'pluginEditor.published': "Saved & published — live on the next run",
  'pluginEditor.configHeading': "Plugin config · API keys",
  'pluginEditor.configHint': "Stored per-plugin, injected only into this plugin's runs (never written to files or uploaded).",
  'pluginEditor.configSet': "Saved",
  'pluginEditor.configNone': "This plugin needs no extra config.",
  'pluginEditor.configClear': "Clear",
  'pluginEditor.failed': "Save failed",
  'pluginEditor.readOnly': "This plugin's source is read-only.",
  'pluginEditor.unsaved': "Unsaved changes",
  'pluginEditor.back': "Back",
  'pluginEditor.displayHeading': "Prompts",
  'pluginEditor.chatEmpty': "Say what to change in one line — e.g. \"give 3 topics but punchier\". AI rewrites the prompts on the left; review, then Save & publish.",
  'pluginEditor.youLabel': "You",
  'pluginEditor.aiLabel': "AI",
  'pluginEditor.stepsLabel': "Steps",
  'pluginEditor.stepsHint': "The step rail + board render from these. Keep them aligned with the steps described in the prompts above.",
  'pluginEditor.stepIdPlaceholder': "id",
  'pluginEditor.stepTitlePlaceholder': "Step name",
  'pluginEditor.stepAdd': "Add step",
  'pluginEditor.stepRemove': "Remove step",
  'pluginEditor.stepUp': "Move up",
  'pluginEditor.stepDown': "Move down",
  'pluginEditor.stepLeft': "Move left",
  'pluginEditor.stepRight': "Move right",
  'pluginEditor.nodeQuery': "Kickoff",
  'pluginEditor.nodeSkill': "Methodology",
  'pluginEditor.gateConfirm': "Confirm",
  'pluginEditor.gateChoice': "Choice",
  'pluginEditor.gateNone': "No gate",
  'pluginEditor.stepPromptPlaceholder': "This step's prompt — decides its output effect & style",
  'pluginEditor.modeLabelPlaceholder': "Mode name (e.g. AI suggest)",
  'pluginEditor.modePromptPlaceholder': "This mode's prompt",
  'pluginEditor.modeAdd': "Add mode",
  'pluginEditor.modeRemove': "Remove mode",
  'pluginEditor.modeAiEdit': "AI-edit this mode",
  'pluginEditor.modeUntitled': "Untitled mode",
  'pluginEditor.branchLabel': "Child options (a fork)",
  'pluginEditor.branchHint': "These children are parallel options, not steps. Single = pick one; Multi = each picked option runs a pass.",
  'pluginEditor.branchSelectLabel': "Select",
  'pluginEditor.branchPickLabel': "Chosen",
  'pluginEditor.branchSingle': "Single (pick one)",
  'pluginEditor.branchMulti': "Multi (run each picked)",
  'pluginEditor.branchPickAsk': "Ask at runtime",
  'pluginEditor.branchPickInput': "By input value",
  'pluginEditor.branchGroupSingle': "pick one",
  'pluginEditor.branchGroupMulti': "multi",
  'pluginEditor.branchGroupInput': "by input",
  'pluginEditor.submodeAdd': "Add option",
  'pluginEditor.submodeRemove': "Remove option",
  'pluginEditor.submodeUntitled': "Untitled option",
  'pluginEditor.submodeLabelPlaceholder': "Option name, e.g. bb-browser",
  'pluginEditor.submodePromptPlaceholder': "This option's own prompt…",
  'pluginEditor.accountsHeading': "Accounts",
  'pluginEditor.accountsHint': "Each account has its own credentials AND its own writing voice. The run's first step picks one; the writing step follows that account's persona.",
  'pluginEditor.accountAdd': "Add account",
  'pluginEditor.accountEdit': "Edit",
  'pluginEditor.accountDelete': "Delete",
  'pluginEditor.accountSave': "Save account",
  'pluginEditor.accountEmpty': "No accounts yet. Add one so the workflow can pick it up front.",
  'pluginEditor.accountName': "Account name",
  'pluginEditor.accountNamePlaceholder': "Account name, e.g. Exam Diary",
  'pluginEditor.accountPersona': "Writing voice / persona",
  'pluginEditor.accountPersonaHint': "How this account writes — tone, audience, taboos. Injected into the writing step.",
  'pluginEditor.accountSamples': "Reference samples (optional)",
  'pluginEditor.accountSamplesHint': "Paste 1–3 past articles, separated by a blank line. The agent studies the voice before writing.",
  'pluginEditor.accountCredentials': "Credentials",
  'pluginEditor.accountCredsHint': "This account's own keys — the ONLY source used at publish time (no plugin-level fallback).",
  'pluginEditor.accountSaved': "Account saved",
  'pluginEditor.accountSaveFailed': "Save failed",
  'pluginEditor.stepAiEdit': "AI-edit this step",
  'pluginEditor.stageSkillsLabel': "Skills for this step",
  'pluginEditor.skillBindPlaceholder': "+ Bind a skill",
  'pluginEditor.skillUnbind': "Unbind skill",
  'pluginEditor.skillMissing': "This skill no longer exists — rebind or create it in the skill library.",
  'pluginEditor.history': "History",
  'pluginEditor.historyEmpty': "No restore points yet — every save records one.",
  'pluginEditor.restore': "Restore",
  'pluginEditor.restored': "Restored. The previous state was saved as a new restore point.",
  'skillsLibrary.title': "Skill library",
  'skillsLibrary.lede': "Every skill your agents can use — built-in and your own. Bind them to plugin workflow steps to orchestrate which methodology runs where.",
  'skillsLibrary.searchPlaceholder': "Search skills…",
  'skillsLibrary.sourceUser': "Mine",
  'skillsLibrary.sourceClaude': "Claude",
  'skillsLibrary.sourceBuiltIn': "Built-in",
  'skillsLibrary.usedBy': "Used by:",
  'skillsLibrary.delete': "Delete skill",
  'skillsLibrary.deleted': "Skill deleted.",
  'skillsLibrary.empty': "No skills match.",
  'creator.eyebrow': "Create",
  'creator.pluginTitle': "Create a plugin",
  'creator.skillTitle': "Create a skill",
  'creator.pluginLede': "Describe the business workflow in your own words — what it should accomplish, the rough steps, and where you want to confirm before it continues. AI drafts the full plugin (methodology, kickoff brief, workflow steps) for your review; nothing is saved until you say so.",
  'creator.skillLede': "Describe what the skill should do and when it should be used. AI drafts a complete SKILL.md — trigger-ready description, methodology, and a few test prompts — for your review; nothing is saved until you say so.",
  'creator.pluginPlaceholder': "e.g. A weekly short-video pipeline for my parenting account: pick trending topics (I confirm), write the script (I confirm), then generate the video and wrap up with a recap.",
  'creator.skillPlaceholder': "e.g. Write 3-second opening hooks for short videos. Use it whenever I mention hooks, openings, or retention. Output 5 options ranked by punchiness.",
  'creator.targetPlugin': "Plugin",
  'creator.targetSkill': "Skill",
  'creator.draftButton': "Draft with AI",
  'creator.drafting': "Drafting…",
  'creator.redraft': "Draft again",
  'creator.draftFailed': "Drafting failed. Check your model settings and try again.",
  'creator.save': "Save & publish",
  'creator.saving': "Saving…",
  'creator.saveFailed': "Saving failed.",
  'creator.skillSaved': "Skill saved to your library.",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "Title",
  'creator.descriptionLabel': "Description",
  'creator.stagesHint': "Step-by-step prompts with human gates. Fine-tune them in the full editor after saving.",
  'creator.triggersLabel': "Triggers (comma-separated)",
  'creator.bodyLabel': "SKILL.md body",
  'creator.evalsLabel': "Test prompts",
  'creator.evalsHint': "Saved as evals/evals.json — used later to test and improve the skill.",
  'tune.open': "Tune this agent",
  'tune.title': "Teach it by reacting to the output",
  'tune.notePlaceholder': "Anything else? e.g. hook harder, drop the ad tone (optional)",
  'tune.good': "Good, keep it",
  'tune.applyPreference': "Remember preference",
  'tune.saveSample': "Save as sample",
  'tune.saveSampleHint': "Remember this output as a style exemplar for next time",
  'tune.savedPreference': "Got it — I'll apply this next time",
  'tune.savedSample': "Saved as a style sample",
  'tune.failed': "Couldn't save",
  ...
  'settings.onboardingCreateBody':
    'Describe the site, app, deck, image, or video you want. social-auto will create a project and keep the work editable.',
  ...
  'settings.agentInstall.oneClick': 'One-click install',
  'settings.agentInstall.running': 'Installing…',
  'settings.agentInstall.failedRetry': 'Install failed — retry',
  'settings.agentInstall.autoKimi': 'No local CLI detected on first run — installing the default Kimi CLI automatically…',
  'settings.agentInstall.docs': 'Docs',
  'settings.agentInstall.pathHint':
    'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the social-auto daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth':
    'Authenticate with the vendor CLI (sign in or add API credentials) before returning to social-auto.',
  ...
  'settings.amrCloud': 'social-auto AMR',
  ...
  'settings.mcpServerHint': 'Expose social-auto as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the social-auto team',
  'settings.privacyConsentKicker': 'Help us improve social-auto',
  'settings.privacyConsentLead': 'social-auto can share usage data with our team to help us improve. This includes:',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your social-auto projects directly.',
  'settings.mcpDaemonError':
    "Couldn't reach the local daemon to resolve install paths ({error}). Make sure social-auto is running, then reopen this panel.",
  ...
  'settings.mcpCapabilityDefault':
    'Default to the project and file you have open in social-auto, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote':
    'social-auto must be running for MCP tool calls to succeed. If you started your coding agent before opening social-auto, restart the agent so it can reach the live daemon.',
  ...
  'entry.navAccounts': 'Accounts',
  'accountsView.title': 'Self-media accounts',
  'accountsView.manageLink': 'Manage accounts',
  'accountsView.lede': 'Accounts belong to platforms. Every plugin targeting a platform shares its roster — configure once, use everywhere.',
  'accountsView.kindApi': 'API credentials',
  'accountsView.kindSau': 'QR login (sau)',
  'accountsView.platformEmpty': 'No accounts yet.',
  'accountsView.sauNamePlaceholder': 'Account name = local sau --account profile name, e.g. main',
  'accountsView.sauHint': 'This platform logs in by QR code at run time (the workflow pops the window). The account name doubles as the local sau cookie profile.',
  'workspaceTabs.project': 'Project',
  'workspaceTabs.pluginDetails': 'Plugin details',
  'workspaceTabs.marketplace': 'Marketplace',
  'homeHero.title': 'What do you want to build?',
  'homeHero.subtitlePrefix': 'The open-source full-stack AI build agent — from one sentence to shipped.',
  ...
  'homeHero.runModeAsk': 'Ask',
  'homeHero.runModeAuto': 'Auto',
  'homeHero.runModeAskHint': 'Ask mode: the workflow pauses at each checkpoint for your confirmation.',
  'homeHero.runModeAutoHint': 'Auto mode: runs straight through without asking (a real outward publish still confirms once). If a config/API key is missing it pauses — configure it, then reply "continue".',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable social-auto plugin and add it to My plugins.',
  ...
  'designSystemPicker.noPreview': 'No preview page. social-auto Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use social-auto workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with social-auto and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginsHome.showBuiltins': "Official",
  'pluginsHome.ownedBadge': "Built-in",
  'pluginsHome.showBuiltinsHint': "Show the official plugins from the upstream repo (hidden by default)",
  ...
  'pluginCard.contributeAria': 'Contribute {title} to social-auto',
  'pluginCard.contributeTitle': 'Contribute plugin to social-auto with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use social-auto from other IDEs, scripts, and automations.',
  ...
  'integrations.apiKeys.title': 'Third-party API Keys',
  'integrations.apiKeys.desc': 'Saved locally on this machine only and injected into agent runs as environment variables. They never leave this device.',
  'integrations.apiKeys.empty': 'No keys configured yet.',
  'integrations.apiKeys.tikhubHint': 'Example: TIKHUB_API_KEY — used for short-video trending-topic scraping. Get a key at',
  'integrations.apiKeys.keyPlaceholder': 'KEY_NAME (e.g. TIKHUB_API_KEY)',
  'integrations.apiKeys.valuePlaceholder': 'Secret value',
  'integrations.apiKeys.add': 'Add key',
  'integrations.apiKeys.save': 'Save keys',
  'integrations.apiKeys.saving': 'Saving…',
  'integrations.apiKeys.saved': 'Saved',
  'integrations.apiKeys.remove': 'Remove',
  'integrations.apiKeys.invalidKey': 'Key names must look like environment variables: A–Z, digits, underscores, starting with a letter.',
  'integrations.apiKeys.saveFailed': 'Save failed. Check that the local daemon is running and try again.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure social-auto is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use social-auto everywhere',
  'useEverywhere.modalTitle': 'Use social-auto everywhere',
  'useEverywhere.modalSubtitle': 'Drop social-auto into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'social-auto works wherever your agent works',
  'useEverywhere.section.overview.intro': 'social-auto is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires social-auto as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without social-auto at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive social-auto from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose social-auto as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'social-auto ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover social-auto tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the social-auto app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without social-auto running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). social-auto extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside social-auto and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + social-auto extras)',
  ...
  'automations.hero.eyebrow': 'Scheduled agent sessions',
  'automations.hero.title': 'Automations',
  'automations.hero.lede': 'Plan recurring conversations for project work, Orbit digests, and live artifacts.',
  ...
  'automations.savedAria': 'Your automations',
  'automations.savedTitle': 'Your automations',
  ...
  'automations.run': 'Run',
  'automations.runTitle': 'Run now and open the conversation',
  ...
  'automations.rejectReason': 'Dismissed in Automations',
  'automations.target.memory': 'Memory',
  'automations.target.designSystem': 'Design system',
  'automations.target.skill': 'Skill',
  'automations.target.template': 'Automation template',
  'automations.action.create': 'Create',
  'automations.action.update': 'Update',
  'automations.action.merge': 'Merge',
  'automations.action.move': 'Move',
  'automations.action.delete': 'Delete',
  'automations.action.promote': 'Promote',
  ...
  'automations.filter.orbit': 'Orbit',
  'automations.filter.liveArtifact': 'Live artifacts',
  'automations.filter.memory': 'Memory',
  'automations.filter.designSystem': 'Design systems',
  'automations.filter.skills': 'Skills',
  'automations.filter.connectors': 'Connectors',
  'automations.filter.compression': 'Compression',
  'automations.filter.release': 'Release',
  'automations.filter.quality': 'Quality',
  ...
  'entry.githubStarAria': 'Star social-auto on GitHub',
  ...
  'code.agentMode.label': 'Mode',
  'code.agentMode.code': 'Code',
  'code.agentMode.plan': 'Plan',
  'code.agentMode.ask': 'Ask',
  'code.agentMode.codeHint': 'Code: read and write files and run commands (full access).',
  'code.agentMode.planHint': 'Plan: analyze and propose a plan without executing anything.',
  'code.agentMode.askHint': 'Ask: answer questions read-only, without changing your project.',
  ...
  'preview.shareTextDefault': 'social-auto template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure social-auto is running and try again.',
  'preview.retry': 'Retry',
  ...
  'tool.askQuestionNotePlaceholder': "Add your own note or suggestion (optional)…",
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with social-auto — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with social-auto — no download needed.',
  ...
  'settings.memoryStarterProjectDesc': 'social-auto v0.5 — chat-driven design editor',
  ...
  'updater.availableBody': 'social-auto {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. social-auto is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit social-auto',
  'updater.quitFailedBody': 'The installer is open, but social-auto could not quit. Quit social-auto before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. social-auto will close and open the installer.',
  'updater.readyVersion': 'social-auto {version} is ready. social-auto will close and open the installer.',
