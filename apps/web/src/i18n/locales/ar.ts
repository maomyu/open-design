...
export const ar: Dict = {
  ...
  'chat.amrCard.switchBody': 'بدِّل إلى خدمة نماذج AMR الرسمية من WorkBuild — لا حاجة لإعداد مفتاح API. بعد تسجيل الدخول والتفويض والشحن، ستُعاد محاولة هذه المهمة تلقائيًا.',
  ...
  'creator.eyebrow': "إنشاء",
  'creator.pluginTitle': "إنشاء إضافة",
  'creator.skillTitle': "إنشاء مهارة",
  'creator.pluginLede': "صِف سير العمل بكلماتك الخاصة — ما الذي يجب أن يحققه، والخطوات التقريبية، وأين تريد التأكيد قبل المتابعة. يقوم الذكاء الاصطناعي بصياغة مسودة الإضافة كاملة (المنهجية، موجز البدء، خطوات سير العمل) لمراجعتك؛ لا يُحفظ شيء حتى توافق.",
  'creator.skillLede': "صِف ما يجب أن تفعله المهارة ومتى تُستخدم. يقوم الذكاء الاصطناعي بصياغة ملف SKILL.md كامل — وصف جاهز للتفعيل، ومنهجية، وبعض prompt الاختبار — لمراجعتك؛ لا يُحفظ شيء حتى توافق.",
  'creator.pluginPlaceholder': "مثال: خط إنتاج أسبوعي لفيديوهات قصيرة لحسابي عن تربية الأطفال: اختيار مواضيع رائجة (أؤكد)، كتابة النص (أؤكد)، ثم توليد الفيديو والختام بملخص.",
  'creator.skillPlaceholder': "مثال: كتابة خطافات افتتاحية مدتها 3 ثوانٍ للفيديوهات القصيرة. استخدمها كلما ذكرت الخطافات أو الافتتاحيات أو الاحتفاظ بالمشاهدين. أخرج 5 خيارات مرتبة حسب قوة التأثير.",
  'creator.targetPlugin': "إضافة",
  'creator.targetSkill': "مهارة",
  'creator.draftButton': "صياغة بالذكاء الاصطناعي",
  'creator.drafting': "جارٍ الصياغة…",
  'creator.redraft': "صياغة من جديد",
  'creator.draftFailed': "فشلت الصياغة. تحقق من إعدادات النموذج وحاول مرة أخرى.",
  'creator.save': "حفظ ونشر",
  'creator.saving': "جارٍ الحفظ…",
  'creator.saveFailed': "فشل الحفظ.",
  'creator.skillSaved': "حُفظت المهارة في مكتبتك.",
  'creator.nameLabel': "المعرّف",
  'creator.titleLabel': "العنوان",
  'creator.descriptionLabel': "الوصف",
  'creator.stagesHint': "prompt خطوة بخطوة مع نقاط تأكيد بشرية. يمكنك ضبطها بدقة في المحرر الكامل بعد الحفظ.",
  'creator.triggersLabel': "المحفّزات (مفصولة بفواصل)",
  'creator.bodyLabel': "متن SKILL.md",
  'creator.evalsLabel': "prompt الاختبار",
  'creator.evalsHint': "يُحفظ باسم evals/evals.json — يُستخدم لاحقًا لاختبار المهارة وتحسينها.",
  ...
  'settings.agentInstall.pathHint':
    'إذا ثبّتّ CLI باستخدام npm أو Homebrew وما زال يظهر كغير مثبت، فتأكد من أن مجلد bin للأداة موجود في PATH الذي يرثه daemon الخاص بـ WorkBuild (قد يختلف PATH بين Terminal وتطبيقات GUI على macOS). راجع QUICKSTART.md (قسم "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'افتح رابط التثبيت أو الوثائق للوكيل الذي تفضله.',
  'settings.agentInstall.stepAuth':
    'أكمِل المصادقة في CLI الخاص بالمزوّد (تسجيل الدخول أو إضافة بيانات اعتماد API) قبل العودة إلى WorkBuild.',
  ...
  'settings.mcpServerHint': 'كشف WorkBuild كخادم MCP لوكيل البرمجة الخاص بك.',
  ...
  'entry.githubStarAria': 'منح WorkBuild نجمة على GitHub',
  ...
  'preview.errorBody': 'فشل جلب HTML الخاص بالمثال. تأكد من تشغيل WorkBuild ثم أعد المحاولة.',
  ...
  'pet.tabBuiltIn': 'مدمج',
  'pet.tabBuiltInHint': 'رفقاء منتقون مدمجون مع WorkBuild - اختر واحداً وتبنَّه.',
  ...
  'pet.codexBundledTitle': 'يأتي مع WorkBuild - لا حاجة للتحميل.',
  ...
  'updater.availableBody': 'WorkBuild {version} متوفر. سيتم تنزيله قبل فتح المثبت.',
  ...
  'updater.installerOpenBody': 'المثبت مفتوح. يتم الآن إنهاء WorkBuild لتتمكن من إكمال التحديث.',
  ...
  'updater.quitButton': 'إنهاء WorkBuild',
  'updater.quitFailedBody': 'المثبت مفتوح، لكن تعذر إنهاء WorkBuild. أغلق WorkBuild قبل استبدال التطبيق.',
  'updater.quitFailedTitle': 'تعذر الإنهاء',
  'updater.quitting': 'جارٍ الإنهاء...',
  'updater.ready': 'التحديث جاهز',
  'updater.readyGeneric': 'إصدار جديد جاهز. سيتم إغلاق WorkBuild وفتح المثبت.',
  'updater.readyVersion': 'WorkBuild {version} جاهز. سيتم إغلاق WorkBuild وفتح المثبت.',
