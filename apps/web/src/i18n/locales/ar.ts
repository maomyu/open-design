...
export const ar: Dict = {
  ...
  'chat.amrCard.switchBody': 'بدِّل إلى خدمة نماذج AMR الرسمية من social-auto — لا حاجة لإعداد مفتاح API. بعد تسجيل الدخول والتفويض والشحن، ستُعاد محاولة هذه المهمة تلقائيًا.',
  ...
  'settings.agentInstall.stepAuth':
    'أكمِل المصادقة في CLI الخاص بالمزوّد (تسجيل الدخول أو إضافة بيانات اعتماد API) قبل العودة إلى social-auto.',
  ...
  'settings.mcpServerHint': 'كشف social-auto كخادم MCP لوكيل البرمجة الخاص بك.',
  ...
  'entry.githubStarAria': 'منح social-auto نجمة على GitHub',
  ...
  'preview.errorBody': 'فشل جلب HTML الخاص بالمثال. تأكد من تشغيل social-auto ثم أعد المحاولة.',
  ...
  'pet.tabBuiltIn': 'مدمج',
  'pet.tabBuiltInHint': 'رفقاء منتقون مدمجون مع social-auto - اختر واحداً وتبنَّه.',
  ...
  'pet.codexBundledTitle': 'يأتي مع social-auto - لا حاجة للتحميل.',
  ...
  'updater.availableBody': 'social-auto {version} متوفر. سيتم تنزيله قبل فتح المثبت.',
  ...
  'updater.installerOpenBody': 'المثبت مفتوح. يتم الآن إنهاء social-auto لتتمكن من إكمال التحديث.',
  ...
  'updater.quitButton': 'إنهاء social-auto',
  'updater.quitFailedBody': 'المثبت مفتوح، لكن تعذر إنهاء social-auto. أغلق social-auto قبل استبدال التطبيق.',
  'updater.quitFailedTitle': 'تعذر الإنهاء',
  'updater.quitting': 'جارٍ الإنهاء...',
  'updater.ready': 'التحديث جاهز',
  'updater.readyGeneric': 'إصدار جديد جاهز. سيتم إغلاق social-auto وفتح المثبت.',
  'updater.readyVersion': 'social-auto {version} جاهز. سيتم إغلاق social-auto وفتح المثبت.',
