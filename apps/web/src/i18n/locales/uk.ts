...
export const uk: Dict = {
  ...
  'chat.amrCard.switchBody': 'Перейдіть на офіційний сервіс моделей AMR від WorkBuild — без налаштування API-ключа. Після входу, авторизації та поповнення це виконання буде повторено автоматично.',
  ...
  'settings.agentInstall.pathHint':
    'Якщо ви встановили CLI через npm або Homebrew, але вона все ще відображається як не встановлена, переконайтеся, що bin-каталог інструмента є у PATH, який успадковує daemon WorkBuild (у macOS PATH у Terminal і GUI-застосунків може відрізнятися). Див. QUICKSTART.md (розділ "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Відкрийте Встановити або Документація для потрібного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдіть автентифікацію у CLI постачальника (увійдіть або додайте API-облікові дані), потім поверніться до WorkBuild.',
  ...
  'settings.mcpServerHint': 'Відкрийте WorkBuild як MCP-сервер для вашого кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставити WorkBuild зірку на GitHub',
  ...
  'preview.errorBody': 'Не вдалося отримати HTML прикладу. Переконайтеся, що WorkBuild запущено, і повторіть спробу.',
  ...
  'pet.tabBuiltInHint': 'Кураторські супутники в комплекті з WorkBuild — виберіть один та встановіть.',
  ...
  'pet.codexBundledTitle': 'Поставляється з WorkBuild — завантаження не потрібне.',
  ...
  'updater.availableBody': 'WorkBuild {version} доступний. Його буде завантажено перед відкриттям інсталятора.',
  ...
  'updater.installerOpenBody': 'Інсталятор відкрито. WorkBuild закривається, щоб ви могли завершити оновлення.',
  ...
  'updater.quitButton': 'Закрити WorkBuild',
  'updater.quitFailedBody': 'Інсталятор відкрито, але WorkBuild не вдалося закрити. Закрийте WorkBuild перед заміною застосунку.',
  'updater.quitFailedTitle': 'Не вдалося закрити',
  'updater.quitting': 'Закриття...',
  'updater.ready': 'Оновлення готове',
  'updater.readyGeneric': 'Нова версія готова. WorkBuild закриється і відкриє інсталятор.',
  'updater.readyVersion': 'WorkBuild {version} готовий. WorkBuild закриється і відкриє інсталятор.',
