...
export const uk: Dict = {
  ...
  'chat.amrCard.switchBody': 'Перейдіть на офіційний сервіс моделей AMR від social-auto — без налаштування API-ключа. Після входу, авторизації та поповнення це виконання буде повторено автоматично.',
  ...
  'creator.eyebrow': "Створити",
  'creator.pluginTitle': "Створити плагін",
  'creator.skillTitle': "Створити навичку",
  'creator.pluginLede': "Опишіть робочий процес власними словами — що він має робити, орієнтовні кроки та де ви хочете підтверджувати перед продовженням. ШІ підготує чернетку повного плагіна (методологія, стартовий бриф, кроки workflow) для вашої перевірки; нічого не зберігається без вашого підтвердження.",
  'creator.skillLede': "Опишіть, що має робити навичка та коли її використовувати. ШІ підготує повний SKILL.md — опис для спрацьовування, методологію та кілька тестових prompt — для вашої перевірки; нічого не зберігається без вашого підтвердження.",
  'creator.pluginPlaceholder': "напр. Щотижневий конвеєр коротких відео для мого батьківського акаунта: обрати трендові теми (я підтверджую), написати сценарій (я підтверджую), потім згенерувати відео й завершити підсумком.",
  'creator.skillPlaceholder': "напр. Писати 3-секундні хуки для початку коротких відео. Використовувати щоразу, коли я згадую хуки, початок чи утримання. Видавати 5 варіантів, відсортованих за силою.",
  'creator.targetPlugin': "Плагін",
  'creator.targetSkill': "Навичка",
  'creator.draftButton': "Чернетка зі ШІ",
  'creator.drafting': "Створення чернетки…",
  'creator.redraft': "Створити чернетку знову",
  'creator.draftFailed': "Не вдалося створити чернетку. Перевірте налаштування моделі та спробуйте ще раз.",
  'creator.save': "Зберегти й опублікувати",
  'creator.saving': "Збереження…",
  'creator.saveFailed': "Не вдалося зберегти.",
  'creator.skillSaved': "Навичку збережено у вашій бібліотеці.",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "Назва",
  'creator.descriptionLabel': "Опис",
  'creator.stagesHint': "Покрокові prompt із точками підтвердження. Після збереження доналаштуйте їх у повному редакторі.",
  'creator.triggersLabel': "Тригери (через кому)",
  'creator.bodyLabel': "Текст SKILL.md",
  'creator.evalsLabel': "Тестові prompt",
  'creator.evalsHint': "Зберігається як evals/evals.json — згодом використовується для тестування та покращення навички.",
  ...
  'settings.agentInstall.oneClick': 'Встановлення в один клік',
  'settings.agentInstall.running': 'Встановлення…',
  'settings.agentInstall.failedRetry': 'Помилка — повторити',
  'settings.agentInstall.autoKimi': 'Локальний CLI не знайдено — автоматично встановлюється типовий Kimi CLI…',
  'settings.agentInstall.docs': 'Документація',
  'settings.agentInstall.pathHint':
    'Якщо ви встановили CLI через npm або Homebrew, але вона все ще відображається як не встановлена, переконайтеся, що bin-каталог інструмента є у PATH, який успадковує daemon social-auto (у macOS PATH у Terminal і GUI-застосунків може відрізнятися). Див. QUICKSTART.md (розділ "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Відкрийте Встановити або Документація для потрібного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдіть автентифікацію у CLI постачальника (увійдіть або додайте API-облікові дані), потім поверніться до social-auto.',
  ...
  'settings.mcpServerHint': 'Відкрийте social-auto як MCP-сервер для вашого кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставити social-auto зірку на GitHub',
  ...
  'preview.errorBody': 'Не вдалося отримати HTML прикладу. Переконайтеся, що social-auto запущено, і повторіть спробу.',
  ...
  'pet.tabBuiltInHint': 'Кураторські супутники в комплекті з social-auto — виберіть один та встановіть.',
  ...
  'pet.codexBundledTitle': 'Поставляється з social-auto — завантаження не потрібне.',
  ...
  'updater.availableBody': 'social-auto {version} доступний. Його буде завантажено перед відкриттям інсталятора.',
  ...
  'updater.installerOpenBody': 'Інсталятор відкрито. social-auto закривається, щоб ви могли завершити оновлення.',
  ...
  'updater.quitButton': 'Закрити social-auto',
  'updater.quitFailedBody': 'Інсталятор відкрито, але social-auto не вдалося закрити. Закрийте social-auto перед заміною застосунку.',
  'updater.quitFailedTitle': 'Не вдалося закрити',
  'updater.quitting': 'Закриття...',
  'updater.ready': 'Оновлення готове',
  'updater.readyGeneric': 'Нова версія готова. social-auto закриється і відкриє інсталятор.',
  'updater.readyVersion': 'social-auto {version} готовий. social-auto закриється і відкриє інсталятор.',
