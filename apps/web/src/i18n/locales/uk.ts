...
export const uk: Dict = {
  ...
  'chat.amrCard.switchBody': 'Перейдіть на офіційний сервіс моделей AMR від 爆创 — без налаштування API-ключа. Після входу, авторизації та поповнення це виконання буде повторено автоматично.',
  ...
  'settings.agentInstall.pathHint':
    'Якщо ви встановили CLI через npm або Homebrew, але вона все ще відображається як не встановлена, переконайтеся, що bin-каталог інструмента є у PATH, який успадковує daemon 爆创 (у macOS PATH у Terminal і GUI-застосунків може відрізнятися). Див. QUICKSTART.md (розділ "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Відкрийте Встановити або Документація для потрібного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдіть автентифікацію у CLI постачальника (увійдіть або додайте API-облікові дані), потім поверніться до 爆创.',
  ...
  'settings.mcpServerHint': 'Відкрийте 爆创 як MCP-сервер для вашого кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставити 爆创 зірку на GitHub',
  ...
  'preview.errorBody': 'Не вдалося отримати HTML прикладу. Переконайтеся, що 爆创 запущено, і повторіть спробу.',
  ...
  'pet.tabBuiltInHint': 'Кураторські супутники в комплекті з 爆创 — виберіть один та встановіть.',
  ...
  'pet.codexBundledTitle': 'Поставляється з 爆创 — завантаження не потрібне.',
  ...
  'updater.availableBody': '爆创 {version} доступний. Його буде завантажено перед відкриттям інсталятора.',
  ...
  'updater.installerOpenBody': 'Інсталятор відкрито. 爆创 закривається, щоб ви могли завершити оновлення.',
  ...
  'updater.quitButton': 'Закрити 爆创',
  'updater.quitFailedBody': 'Інсталятор відкрито, але 爆创 не вдалося закрити. Закрийте 爆创 перед заміною застосунку.',
  'updater.quitFailedTitle': 'Не вдалося закрити',
  'updater.quitting': 'Закриття...',
  'updater.ready': 'Оновлення готове',
  'updater.readyGeneric': 'Нова версія готова. 爆创 закриється і відкриє інсталятор.',
  'updater.readyVersion': '爆创 {version} готовий. 爆创 закриється і відкриє інсталятор.',
