...
export const pl: Dict = {
  ...
  'chat.amrCard.switchBody': 'Przełącz się na oficjalną usługę modeli AMR od social-auto — bez konfigurowania klucza API. Po zalogowaniu, autoryzacji i doładowaniu zadanie zostanie automatycznie ponowione.',
  ...
  'settings.agentInstall.stepAuth':
    'Uwierzytelnij się w CLI dostawcy (zaloguj się lub dodaj dane API), zanim wrócisz do social-auto.',
  ...
  'settings.mcpServerHint': 'Udostępnij social-auto jako serwer MCP dla swojego agenta kodu.',
  ...
  'entry.githubStarAria': 'Daj social-auto gwiazdkę na GitHubie',
  ...
  'preview.errorBody': 'Nie udało się pobrać kodu HTML przykładu. Upewnij się, że social-auto jest uruchomiony, i spróbuj ponownie.',
  ...
  'pet.tabBuiltInHint': 'Towarzysze dołączeni do social-auto — wybierz jednego i adoptuj.',
  ...
  'pet.codexBundledTitle': 'Dostarczany z social-auto — bez pobierania.',
  ...
  'updater.availableBody': 'social-auto {version} jest dostępny. Zostanie pobrany przed otwarciem instalatora.',
  ...
  'updater.installerOpenBody': 'Instalator jest otwarty. social-auto zamyka się, aby można było dokończyć aktualizację.',
  ...
  'updater.quitButton': 'Zamknij social-auto',
  'updater.quitFailedBody': 'Instalator jest otwarty, ale nie można zamknąć social-auto. Zamknij social-auto przed zastąpieniem aplikacji.',
  'updater.quitFailedTitle': 'Nie można zamknąć',
  'updater.quitting': 'Zamykanie...',
  'updater.ready': 'Aktualizacja gotowa',
  'updater.readyGeneric': 'Nowa wersja jest gotowa. social-auto zamknie się i otworzy instalator.',
  'updater.readyVersion': 'social-auto {version} jest gotowy. social-auto zamknie się i otworzy instalator.',
