...
export const pl: Dict = {
  ...
  'chat.amrCard.switchBody': 'Przełącz się na oficjalną usługę modeli AMR od 爆创 — bez konfigurowania klucza API. Po zalogowaniu, autoryzacji i doładowaniu zadanie zostanie automatycznie ponowione.',
  ...
  'settings.agentInstall.pathHint':
    'Jeśli zainstalowano CLI przez npm lub Homebrew, ale nadal widnieje jako niezainstalowana, upewnij się, że katalog bin narzędzia jest w PATH dziedziczonym przez daemon 爆创 (na macOS PATH w Terminalu i aplikacjach GUI może się różnić). Zobacz QUICKSTART.md (sekcja "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Otwórz Zainstaluj lub Dokumentacja dla wybranego agenta.',
  'settings.agentInstall.stepAuth':
    'Uwierzytelnij się w CLI dostawcy (zaloguj się lub dodaj dane API), zanim wrócisz do 爆创.',
  ...
  'settings.mcpServerHint': 'Udostępnij 爆创 jako serwer MCP dla swojego agenta kodu.',
  ...
  'entry.githubStarAria': 'Daj 爆创 gwiazdkę na GitHubie',
  ...
  'preview.errorBody': 'Nie udało się pobrać kodu HTML przykładu. Upewnij się, że 爆创 jest uruchomiony, i spróbuj ponownie.',
  ...
  'pet.tabBuiltInHint': 'Towarzysze dołączeni do 爆创 — wybierz jednego i adoptuj.',
  ...
  'pet.codexBundledTitle': 'Dostarczany z 爆创 — bez pobierania.',
  ...
  'updater.availableBody': '爆创 {version} jest dostępny. Zostanie pobrany przed otwarciem instalatora.',
  ...
  'updater.installerOpenBody': 'Instalator jest otwarty. 爆创 zamyka się, aby można było dokończyć aktualizację.',
  ...
  'updater.quitButton': 'Zamknij 爆创',
  'updater.quitFailedBody': 'Instalator jest otwarty, ale nie można zamknąć 爆创. Zamknij 爆创 przed zastąpieniem aplikacji.',
  'updater.quitFailedTitle': 'Nie można zamknąć',
  'updater.quitting': 'Zamykanie...',
  'updater.ready': 'Aktualizacja gotowa',
  'updater.readyGeneric': 'Nowa wersja jest gotowa. 爆创 zamknie się i otworzy instalator.',
  'updater.readyVersion': '爆创 {version} jest gotowy. 爆创 zamknie się i otworzy instalator.',
