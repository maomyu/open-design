...
export const pl: Dict = {
  ...
  'chat.amrCard.switchBody': 'Przełącz się na oficjalną usługę modeli AMR od WorkBuild — bez konfigurowania klucza API. Po zalogowaniu, autoryzacji i doładowaniu zadanie zostanie automatycznie ponowione.',
  ...
  'creator.eyebrow': "Utwórz",
  'creator.pluginTitle': "Utwórz plugin",
  'creator.skillTitle': "Utwórz umiejętność",
  'creator.pluginLede': "Opisz proces własnymi słowami — co ma osiągnąć, jakie są przybliżone kroki i gdzie chcesz potwierdzać przed kontynuacją. AI przygotuje szkic całego pluginu (metodologia, brief startowy, kroki workflow) do Twojej weryfikacji; nic nie zostanie zapisane bez Twojej zgody.",
  'creator.skillLede': "Opisz, co umiejętność ma robić i kiedy ma być używana. AI przygotuje kompletny SKILL.md — opis gotowy do wyzwalania, metodologię i kilka testowych promptów — do Twojej weryfikacji; nic nie zostanie zapisane bez Twojej zgody.",
  'creator.pluginPlaceholder': "np. Cotygodniowa taśma krótkich wideo dla mojego konta parentingowego: wybór popularnych tematów (potwierdzam), napisanie scenariusza (potwierdzam), potem wygenerowanie wideo i podsumowanie.",
  'creator.skillPlaceholder': "np. Pisanie 3-sekundowych hooków otwierających do krótkich wideo. Używaj zawsze, gdy wspominam o hookach, otwarciach lub retencji. Zwracaj 5 opcji posortowanych według siły.",
  'creator.targetPlugin': "Plugin",
  'creator.targetSkill': "Umiejętność",
  'creator.draftButton': "Szkicuj z AI",
  'creator.drafting': "Szkicowanie…",
  'creator.redraft': "Szkicuj ponownie",
  'creator.draftFailed': "Szkicowanie nie powiodło się. Sprawdź ustawienia modelu i spróbuj ponownie.",
  'creator.save': "Zapisz i opublikuj",
  'creator.saving': "Zapisywanie…",
  'creator.saveFailed': "Zapisywanie nie powiodło się.",
  'creator.skillSaved': "Umiejętność zapisana w Twojej bibliotece.",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "Tytuł",
  'creator.descriptionLabel': "Opis",
  'creator.stagesHint': "Prompty krok po kroku z punktami ludzkiego potwierdzenia. Dopracuj je w pełnym edytorze po zapisaniu.",
  'creator.triggersLabel': "Wyzwalacze (rozdzielone przecinkami)",
  'creator.bodyLabel': "Treść SKILL.md",
  'creator.evalsLabel': "Prompty testowe",
  'creator.evalsHint': "Zapisywane jako evals/evals.json — później używane do testowania i ulepszania umiejętności.",
  ...
  'settings.agentInstall.pathHint':
    'Jeśli zainstalowano CLI przez npm lub Homebrew, ale nadal widnieje jako niezainstalowana, upewnij się, że katalog bin narzędzia jest w PATH dziedziczonym przez daemon WorkBuild (na macOS PATH w Terminalu i aplikacjach GUI może się różnić). Zobacz QUICKSTART.md (sekcja "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Otwórz Zainstaluj lub Dokumentacja dla wybranego agenta.',
  'settings.agentInstall.stepAuth':
    'Uwierzytelnij się w CLI dostawcy (zaloguj się lub dodaj dane API), zanim wrócisz do WorkBuild.',
  ...
  'settings.mcpServerHint': 'Udostępnij WorkBuild jako serwer MCP dla swojego agenta kodu.',
  ...
  'entry.githubStarAria': 'Daj WorkBuild gwiazdkę na GitHubie',
  ...
  'preview.errorBody': 'Nie udało się pobrać kodu HTML przykładu. Upewnij się, że WorkBuild jest uruchomiony, i spróbuj ponownie.',
  ...
  'pet.tabBuiltInHint': 'Towarzysze dołączeni do WorkBuild — wybierz jednego i adoptuj.',
  ...
  'pet.codexBundledTitle': 'Dostarczany z WorkBuild — bez pobierania.',
  ...
  'updater.availableBody': 'WorkBuild {version} jest dostępny. Zostanie pobrany przed otwarciem instalatora.',
  ...
  'updater.installerOpenBody': 'Instalator jest otwarty. WorkBuild zamyka się, aby można było dokończyć aktualizację.',
  ...
  'updater.quitButton': 'Zamknij WorkBuild',
  'updater.quitFailedBody': 'Instalator jest otwarty, ale nie można zamknąć WorkBuild. Zamknij WorkBuild przed zastąpieniem aplikacji.',
  'updater.quitFailedTitle': 'Nie można zamknąć',
  'updater.quitting': 'Zamykanie...',
  'updater.ready': 'Aktualizacja gotowa',
  'updater.readyGeneric': 'Nowa wersja jest gotowa. WorkBuild zamknie się i otworzy instalator.',
  'updater.readyVersion': 'WorkBuild {version} jest gotowy. WorkBuild zamknie się i otworzy instalator.',
