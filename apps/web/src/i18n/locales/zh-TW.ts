...
export const zhTW: Dict = {
  ...
  'chat.amrCard.switchBody': "可切換到 social-auto 官方 AMR 模型服務，無需設定 API Key。完成登入、授權與儲值後，將自動重試目前任務。",
  ...
  'creator.eyebrow': "建立",
  'creator.pluginTitle': "建立外掛",
  'creator.skillTitle': "建立技能",
  'creator.pluginLede': "用自己的話描述這個業務流程——要完成什麼、大致分幾步、哪裡需要你確認後再繼續。AI 會草擬完整外掛（方法論、開場指示、工作流程步驟）供你審閱；確認儲存前不會寫入。",
  'creator.skillLede': "描述這個技能要做什麼、什麼時候用。AI 會草擬完整的 SKILL.md——可觸發的描述、方法論、以及幾個測試 prompt——供你審閱；確認儲存前不會寫入。",
  'creator.pluginPlaceholder': "例：替我的親子帳號做一條短影音週更流水線：先選熱門題材（我確認）、再寫腳本（我確認），然後產生影片並做回顧。",
  'creator.skillPlaceholder': "例：替短影音寫開頭 3 秒鉤子。只要我提到鉤子、開場、留存率就用它。輸出 5 個備選，依衝擊力排序。",
  'creator.targetPlugin': "外掛",
  'creator.targetSkill': "技能",
  'creator.draftButton': "AI 草擬",
  'creator.drafting': "草擬中…",
  'creator.redraft': "重新草擬",
  'creator.draftFailed': "草擬失敗，請檢查模型設定後再試。",
  'creator.save': "儲存並發布",
  'creator.saving': "儲存中…",
  'creator.saveFailed': "儲存失敗。",
  'creator.skillSaved': "技能已儲存到你的技能庫。",
  'creator.nameLabel': "ID",
  'creator.titleLabel': "顯示名稱",
  'creator.descriptionLabel': "描述",
  'creator.stagesHint': "帶人工確認點的分步提示詞，儲存後可在完整編輯器裡微調。",
  'creator.triggersLabel': "觸發詞（逗號分隔）",
  'creator.bodyLabel': "SKILL.md 內文",
  'creator.evalsLabel': "測試 prompt",
  'creator.evalsHint': "會存為 evals/evals.json，之後用於測試和改進這個技能。",
  ...
  'homeHero.title': '你想建構什麼？',
  'homeHero.subtitlePrefix': '開源全流程 AI 建構智能體 · 從一句話到上線。',
  ...
  'settings.onboardingCreateBody':
    '描述你想做的網站、應用、Deck、圖片或影片，social-auto 會建立專案，並保留可繼續編輯的產出。',
  ...
  'settings.agentInstall.oneClick': '一鍵安裝',
  'settings.agentInstall.running': '安裝中…',
  'settings.agentInstall.failedRetry': '安裝失敗,點此重試',
  'settings.agentInstall.autoKimi': '首次使用未偵測到可用的本地 CLI,正在自動安裝預設的 Kimi CLI…',
  'settings.agentInstall.docs': '文件',
  'settings.agentInstall.pathHint':
    '如果你透過 npm 或 Homebrew 安裝了 CLI，但仍顯示為未安裝，請確認該工具的 bin 目錄已加入 social-auto daemon 繼承的 PATH（在 macOS 上，Terminal 與 GUI 應用的 PATH 可能不同）。請參閱 QUICKSTART.md（「Local agent CLI and PATH」章節）。',
  'settings.agentInstall.stepOpenLinks': '在目標代理卡片上開啟「安裝」或「文件」連結。',
  'settings.agentInstall.stepAuth':
    '返回 social-auto 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。',
  ...
  'settings.mcpServerHint': '將 social-auto 作為 MCP 伺服器暴露給你的編碼代理。',
  ...
  'settings.privacy': '隱私',
  'settings.privacyHint': '與 social-auto 團隊共享哪些資料',
  'settings.privacyConsentKicker': '協助我們改進 social-auto',
  'settings.privacyConsentLead': 'social-auto 可以將使用資料分享給我們的團隊以協助改進。包含:',
  ...
  'settings.mcpHint':
    '讓其他專案中的程式碼代理（Claude Code、Cursor、VS Code、Antigravity、Zed、Windsurf）讀取您的 social-auto 專案。您可以直接將設計匯入應用程式，無需先匯出 zip。',
  'settings.mcpDaemonError':
    '無法連線到本地守護程序以解析安裝路徑（{error}）。請確認 social-auto 正在執行，然後重新開啟此面板。',
  ...
  'settings.mcpCapabilityDefault':
    '預設使用您在 social-auto 中開啟的專案與檔案，因此您可以說「在我的應用程式中建置這個」，無需重新說明是哪個設計。',
  'settings.mcpRunningNote':
    'social-auto 必須正在執行，MCP 工具呼叫才能成功。如果您在開啟 social-auto 之前就已啟動 coding agent，請重新啟動 agent，使其能夠連線到正在執行的守護行程。',
  ...
  'entry.githubStarAria': '在 GitHub 為 social-auto 點亮 Star',
  ...
  'integrations.lede': '連接外部系統，把 MCP 工具帶入智能體迴圈，並在其他 IDE、腳本與自動化流程中使用 social-auto。',
  ...
  'mcpClient.daemonError': '無法連線到本機 daemon。請確認 social-auto 正在執行，然後重新開啟此面板。',
  'mcpClient.saveFailed': '儲存失敗。請確認 daemon 正在執行後再試一次。',
  'tasks.comingSoon': '即將推出',
  'automations.hero.eyebrow': '定時智能體工作階段',
  'automations.hero.title': '自動化',
  'automations.hero.lede': '為專案工作、Orbit 摘要與即時產物安排週期性對話。',
  'automations.summaryAria': '自動化概覽',
  'automations.metric.active': '已啟用',
  'automations.metric.paused': '已暫停',
  'automations.metric.templates': '範本',
  'automations.new': '新增自動化',
  'automations.savedAria': '你的自動化',
  'automations.savedTitle': '你的自動化',
  'automations.loading': '載入中',
  'automations.emptyTitle': '還沒有自動化',
  'automations.emptyBody': '從範本建立一個，或從空白排程開始。',
  'automations.newProjectEachRun': '每次執行建立新專案',
  'automations.lastRun': '上次執行 {time}',
  'automations.openResult': '開啟結果',
  'automations.run': '執行',
  'automations.runTitle': '立即執行並開啟對話',
  'automations.history': '歷史',
  'automations.hideHistory': '隱藏歷史',
  'automations.edit': '編輯',
  'automations.pause': '暫停',
  'automations.resume': '恢復',
  'automations.deleteAria': '刪除自動化',
  'automations.deleteTitle': '刪除此自動化',
  'automations.deleteConfirm': '刪除此自動化？過往執行及其專案會保留。',
  'automations.manualOnly': '僅手動',
  'automations.scheduled': '已排程',
  'automations.nextRun': '下次 {time}',
  'automations.inProgress': '進行中',
  ...
  'automations.proposalsSub': '在自動化產出變更記憶、技能或設計系統之前先審核。',
  'automations.proposalsPending': '{count} 項待處理',
  'automations.apply': '套用',
  'automations.reject': '拒絕',
  'automations.rejectReason': '已在自動化中忽略',
  'automations.target.memory': '記憶',
  'automations.target.designSystem': '設計系統',
  'automations.target.skill': '技能',
  'automations.target.template': '自動化範本',
  'automations.action.create': '建立',
  'automations.action.update': '更新',
  'automations.action.merge': '合併',
  'automations.action.move': '移動',
  'automations.action.delete': '刪除',
  'automations.action.promote': '提升',
  'automations.templatesAria': '自動化範本',
  'automations.templatesTitle': '範本',
  'automations.templatesSub': 'Orbit 與即時產物都是同一套自動化流程中的範本。',
  ...
  'automations.filter.liveArtifact': '即時產物',
  'automations.filter.memory': '記憶',
  'automations.filter.designSystem': '設計系統',
  'automations.filter.skills': '技能',
  'automations.filter.connectors': '連接器',
  'automations.filter.compression': '壓縮',
  'automations.filter.release': '發佈',
  'automations.filter.quality': '品質',
  'automations.templatesEmptyTitle': '此分類目前沒有範本。',
  'automations.templatesEmptyBody': '換個篩選，或從空白自動化開始。',
  'automations.useTemplate': '使用範本',
  'automations.kind.orbit': 'Orbit',
  'automations.kind.liveArtifact': '即時產物',
  'automations.kind.automation': '自動化',
  'automations.history.loading': '正在載入執行歷史…',
  'automations.history.empty': '還沒有執行紀錄。',
  'automations.history.title': '執行歷史',
  'automations.history.latest': '最近 10 筆',
  'automations.history.aria': '自動化執行歷史',
  'automations.openConversation': '開啟對話',
  'automations.crystallize': '萃取',
  'automations.crystallizing': '萃取中',
  'automations.crystallizeTitle': '從此次執行草擬技能與記憶提案',
  ...
  'code.agentMode.code': '程式碼',
  'code.agentMode.plan': '規劃',
  'code.agentMode.ask': '詢問',
  'code.agentMode.codeHint': '程式碼：讀寫檔案並執行命令（完全存取）。',
  'code.agentMode.planHint': '規劃：分析並給出方案，不執行任何操作。',
  'code.agentMode.askHint': '詢問：唯讀回答問題，不改動你的專案。',
  'newproj.tabCode': '通用',
  ...
  'preview.errorBody': '範例 HTML 載入失敗。請確認 social-auto 正在執行後重試。',
  'preview.retry': '重試',
  ...
  'pet.title': '寵物',
  'pet.tabBuiltIn': '內建',
  'pet.tabBuiltInHint': 'social-auto 內建的精選寵物 — 一鍵領養。',
  ...
  'pet.codexBundled': '內建',
  'pet.codexBundledTitle': 'social-auto 內建寵物，無需下載。',
  ...
  'settings.memoryStarterProjectDesc': 'social-auto v0.5 — 聊天驅動的設計編輯器',
  ...
  'updater.availableBody': 'social-auto {version} 可用。下載完成後即可開啟安裝器。',
  ...
  'updater.done': '完成',
  'updater.failed': '更新失敗',
  'updater.installerOpenBody': '安裝器已開啟。social-auto 正在結束，以便你完成更新。',
  'updater.installerOpened': '安裝器已開啟',
  'updater.later': '稍後',
  'updater.openFailedFallback': '無法開啟安裝器。',
  'updater.openInstaller': '安裝更新',
  'updater.opening': '正在開啟安裝器…',
  'updater.quitButton': '結束 social-auto',
  'updater.quitFailedBody': '安裝器已開啟，但 social-auto 無法結束。替換應用程式前請先結束 social-auto。',
  'updater.quitFailedTitle': '無法結束',
  'updater.quitting': '正在結束…',
  'updater.ready': '更新已就緒',
  'updater.readyGeneric': '新版本已就緒。social-auto 會關閉並開啟安裝器。',
  'updater.readyVersion': 'social-auto {version} 已就緒。social-auto 會關閉並開啟安裝器。',
  ...
  'pluginCard.contributeAria': '將 {title} 貢獻至 social-auto',
  'pluginCard.contributeTitle': '透過 pull request 將外掛貢獻至 social-auto',
