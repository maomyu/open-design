...
export function buildDesignManifestContent(opts: {
  ...
  const title = opts.title || 'WorkBuild artifact';
...
- Keep generated product UI free of WorkBuild chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or WorkBuild chrome in the production UI.
