...
export function buildDesignManifestContent(opts: {
  ...
  const title = opts.title || 'social-auto artifact';
...
- Keep generated product UI free of social-auto chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or social-auto chrome in the production UI.
