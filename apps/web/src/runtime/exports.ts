...
export function buildDesignManifestContent(opts: {
  ...
  const title = opts.title || '爆创 artifact';
...
- Keep generated product UI free of 爆创 chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or 爆创 chrome in the production UI.
