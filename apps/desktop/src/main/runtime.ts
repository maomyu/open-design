...
import { flushEmbeddedBrowserCookieVault, hardenWebviewEmbeddedBrowser, registerBrowserSessionFetchBridge, registerContentWebviewTabBridge, registerEmbeddedBrowserBridge, registerEmbeddedBrowserCookieBridge, registerWebviewFileInputBridge, restoreEmbeddedBrowserCookies } from "./embedded-browser.js";
...
export async function createDesktopRuntime(options: DesktopRuntimeOptions): Promise<DesktopRuntime> {
  ...
  registerBrowserSessionFetchBridge();
  registerContentWebviewTabBridge();
