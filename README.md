...
> [!NOTE]
> **Multimedia** — this repository is a commercial derivative of [open-design](https://github.com/nexu-io/open-design) (Apache-2.0), modified and rebranded. The upstream license is preserved in [LICENSE](LICENSE); bundled templates `design-templates/guizang-ppt` and `design-templates/html-ppt` retain their original MIT licenses.
